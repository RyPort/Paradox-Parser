...
type CMsgCustomGameInstallStatus struct {
	state                    protoimpl.MessageState    `protogen:"open.v1"`
	Status                   *ECustomGameInstallStatus `protobuf:"varint,1,opt,name=status,enum=deadlock.ECustomGameInstallStatus,def=0" json:"status,omitempty"`
...
type CMsgExtractGemsResponse struct {
	...
	Response      *CMsgExtractGemsResponse_EExtractGems `protobuf:"varint,2,opt,name=response,enum=deadlock.CMsgExtractGemsResponse_EExtractGems,def=0" json:"response,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgAddSocketResponse struct {
	...
	Response           *CMsgAddSocketResponse_EAddSocket `protobuf:"varint,3,opt,name=response,enum=deadlock.CMsgAddSocketResponse_EAddSocket,def=0" json:"response,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type CMsgAddItemToSocketResponse struct {
	...
	ItemItemId         *uint64                              `protobuf:"varint,1,opt,name=item_item_id,json=itemItemId" json:"item_item_id,omitempty"`
	UpdatedSocketIndex []uint32                             `protobuf:"varint,2,rep,name=updated_socket_index,json=updatedSocketIndex" json:"updated_socket_index,omitempty"`
	Response           *CMsgAddItemToSocketResponse_EAddGem `protobuf:"varint,3,opt,name=response,enum=deadlock.CMsgAddItemToSocketResponse_EAddGem,def=0" json:"response,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type CMsgResetStrangeGemCountResponse struct {
	state         protoimpl.MessageState                      `protogen:"open.v1"`
	Response      *CMsgResetStrangeGemCountResponse_EResetGem `protobuf:"varint,1,opt,name=response,enum=deadlock.CMsgResetStrangeGemCountResponse_EResetGem,def=0" json:"response,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgApplyRemoteConVars_ConVar struct {
	...
	Platform      *EGCPlatform           `protobuf:"varint,5,opt,name=platform,enum=deadlock.EGCPlatform,def=0" json:"platform,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_base_gcmessages_proto_rawDesc = "" +
	"\n" +
	"\x15base_gcmessages.proto\x12\bdeadlock\x1a\x13steammessages.proto\x1a\x16gcsdk_gcmessages.proto\x1a,steammessages_steamlearn.steamworkssdk.proto\"\x86\x02\n" +
	...
	"\n" +
	"line_items\x18\x04 \x03(\v2'.deadlock.CGCStorePurchaseInit_LineItemR\tlineItems\"P\n" +
	...
	"\tping_data\x18\x05 \x01(\v2\x1c.deadlock.CMsgClientPingDataR\bpingData\"U\n" +
	...
	"\tping_data\x18\b \x01(\v2\x1c.deadlock.CMsgClientPingDataR\bpingData\"\xcf\x01\n" +
	...
	"\x06status\x18\x01 \x01(\x0e2\".deadlock.ECustomGameInstallStatus:\"k_ECustomGameInstallStatus_UnknownR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12=\n" +
	"\x1blatest_timestamp_from_steam\x18\x03 \x01(\aR\x18latestTimestampFromSteam\"y\n" +
	"\x13CMsgServerAvailable\x12b\n" +
	"\x1acustom_game_install_status\x18\x01 \x01(\v2%.deadlock.CMsgCustomGameInstallStatusR\x17customGameInstallStatus\"3\n" +
	...
	"\tattribute\x18\f \x03(\v2\x1e.deadlock.CSOEconItemAttributeR\tattribute\x12:\n" +
	"\rinterior_item\x18\r \x01(\v2\x15.deadlock.CSOEconItemR\finteriorItem\x12\x17\n" +
	"\x05style\x18\x0f \x01(\r:\x010R\x05style\x12\x1f\n" +
	"\voriginal_id\x18\x10 \x01(\x04R\n" +
	"originalId\x12D\n" +
	"\x0eequipped_state\x18\x12 \x03(\v2\x1d.deadlock.CSOEconItemEquippedR\requippedState\",\n" +
	...
	"\x0eitem_positions\x18\x01 \x03(\v2+.deadlock.CMsgSetItemPositions.ItemPositionR\ritemPositions\x1aC\n" +
	...
	"\bresponse\x18\x02 \x01(\x0e2..deadlock.CMsgExtractGemsResponse.EExtractGems:\x17k_ExtractGems_SucceededR\bresponse\"\xd5\x01\n" +
	...
	"\bresponse\x18\x03 \x01(\x0e2*.deadlock.CMsgAddSocketResponse.EAddSocket:\x15k_AddSocket_SucceededR\bresponse\"\xa4\x01\n" +
	"\n" +
	"EAddSocket\x12\x19\n" +
	...
	"itemItemId\x12G\n" +
	"\x0egems_to_socket\x18\x02 \x03(\v2!.deadlock.CMsgAddItemToSocketDataR\fgemsToSocket\"\x92\x04\n" +
	"\x1bCMsgAddItemToSocketResponse\x12 \n" +
	"\fitem_item_id\x18\x01 \x01(\x04R\n" +
	"itemItemId\x120\n" +
	"\x14updated_socket_index\x18\x02 \x03(\rR\x12updatedSocketIndex\x12]\n" +
	"\bresponse\x18\x03 \x01(\x0e2-.deadlock.CMsgAddItemToSocketResponse.EAddGem:\x12k_AddGem_SucceededR\bresponse\"\xbf\x02\n" +
	"\aEAddGem\x12\x16\n" +
	...
	"\bresponse\x18\x01 \x01(\x0e24.deadlock.CMsgResetStrangeGemCountResponse.EResetGem:\x14k_ResetGem_SucceededR\bresponse\"\xc4\x01\n" +
	"\tEResetGem\x12\x18\n" +
	...
	"\x10welcome_messages\x18\x01 \x03(\v2\x18.deadlock.CExtraMsgBlockR\x0fwelcomeMessages\"\x9a\x02\n" +
	"\x16CMsgApplyRemoteConVars\x12B\n" +
	"\bcon_vars\x18\x01 \x03(\v2'.deadlock.CMsgApplyRemoteConVars.ConVarR\aconVars\x1a\xbb\x01\n" +
	"\x06ConVar\x12\x12\n" +
	...
	"versionMax\x12E\n" +
	"\bplatform\x18\x05 \x01(\x0e2\x15.deadlock.EGCPlatform:\x12k_eGCPlatform_NoneR\bplatform\"V\n" +
	" CMsgGCToClientApplyRemoteConVars\x122\n" +
	"\x03msg\x18\x01 \x01(\v2 .deadlock.CMsgApplyRemoteConVarsR\x03msg\"V\n" +
	" CMsgGCToServerApplyRemoteConVars\x122\n" +
	"\x03msg\x18\x01 \x01(\v2 .deadlock.CMsgApplyRemoteConVarsR\x03msg\"\xa3\x02\n" +
	...
	"\vdiagnostics\x18\x03 \x03(\v20.deadlock.CMsgClientToGCIntegrityStatus.keyvalueR\vdiagnostics\x1ao\n" +
	"\bkeyvalue\x12\x0e\n" +
	...
	"\ametrics\x18\x01 \x03(\v25.deadlock.CMsgClientToGCAggregateMetrics.SingleMetricR\ametrics\x1aR\n" +
	...
	"\raccess_tokens\x18\x01 \x01(\v2$.deadlock.CMsgSteamLearnAccessTokensR\faccessTokens\"<\n" +
	...
	")k_ECustomGameInstallStatus_FailedCanceled\x10kB4Z2github.com/RyPort/paradox-parser/deadlock;deadlock"
...
var file_base_gcmessages_proto_goTypes = []any{
	(EGCBaseMsg)(0),                                     // 0: deadlock.EGCBaseMsg
	(ECustomGameInstallStatus)(0),                       // 1: deadlock.ECustomGameInstallStatus
	(CMsgExtractGemsResponse_EExtractGems)(0),           // 2: deadlock.CMsgExtractGemsResponse.EExtractGems
	(CMsgAddSocketResponse_EAddSocket)(0),               // 3: deadlock.CMsgAddSocketResponse.EAddSocket
	(CMsgAddItemToSocketResponse_EAddGem)(0),            // 4: deadlock.CMsgAddItemToSocketResponse.EAddGem
	(CMsgResetStrangeGemCountResponse_EResetGem)(0),     // 5: deadlock.CMsgResetStrangeGemCountResponse.EResetGem
	(*CGCStorePurchaseInit_LineItem)(nil),               // 6: deadlock.CGCStorePurchaseInit_LineItem
	(*CMsgGCStorePurchaseInit)(nil),                     // 7: deadlock.CMsgGCStorePurchaseInit
	(*CMsgGCStorePurchaseInitResponse)(nil),             // 8: deadlock.CMsgGCStorePurchaseInitResponse
	(*CMsgClientPingData)(nil),                          // 9: deadlock.CMsgClientPingData
	(*CMsgInviteToParty)(nil),                           // 10: deadlock.CMsgInviteToParty
	(*CMsgInviteToLobby)(nil),                           // 11: deadlock.CMsgInviteToLobby
	(*CMsgInvitationCreated)(nil),                       // 12: deadlock.CMsgInvitationCreated
	(*CMsgPartyInviteResponse)(nil),                     // 13: deadlock.CMsgPartyInviteResponse
	(*CMsgLobbyInviteResponse)(nil),                     // 14: deadlock.CMsgLobbyInviteResponse
	(*CMsgKickFromParty)(nil),                           // 15: deadlock.CMsgKickFromParty
	(*CMsgLeaveParty)(nil),                              // 16: deadlock.CMsgLeaveParty
	(*CMsgCustomGameInstallStatus)(nil),                 // 17: deadlock.CMsgCustomGameInstallStatus
	(*CMsgServerAvailable)(nil),                         // 18: deadlock.CMsgServerAvailable
	(*CMsgLANServerAvailable)(nil),                      // 19: deadlock.CMsgLANServerAvailable
	(*CSOEconGameAccountClient)(nil),                    // 20: deadlock.CSOEconGameAccountClient
	(*CMsgApplyStrangePart)(nil),                        // 21: deadlock.CMsgApplyStrangePart
	(*CMsgApplyPennantUpgrade)(nil),                     // 22: deadlock.CMsgApplyPennantUpgrade
	(*CMsgApplyEggEssence)(nil),                         // 23: deadlock.CMsgApplyEggEssence
	(*CSOEconItemAttribute)(nil),                        // 24: deadlock.CSOEconItemAttribute
	(*CSOEconItemEquipped)(nil),                         // 25: deadlock.CSOEconItemEquipped
	(*CSOEconItem)(nil),                                 // 26: deadlock.CSOEconItem
	(*CMsgSortItems)(nil),                               // 27: deadlock.CMsgSortItems
	(*CMsgItemAcknowledged)(nil),                        // 28: deadlock.CMsgItemAcknowledged
	(*CMsgSetItemPositions)(nil),                        // 29: deadlock.CMsgSetItemPositions
	(*CMsgGCStorePurchaseCancel)(nil),                   // 30: deadlock.CMsgGCStorePurchaseCancel
	(*CMsgGCStorePurchaseCancelResponse)(nil),           // 31: deadlock.CMsgGCStorePurchaseCancelResponse
	(*CMsgGCStorePurchaseFinalize)(nil),                 // 32: deadlock.CMsgGCStorePurchaseFinalize
	(*CMsgGCStorePurchaseFinalizeResponse)(nil),         // 33: deadlock.CMsgGCStorePurchaseFinalizeResponse
	(*CMsgGCToGCBannedWordListUpdated)(nil),             // 34: deadlock.CMsgGCToGCBannedWordListUpdated
	(*CMsgGCToGCDirtySDOCache)(nil),                     // 35: deadlock.CMsgGCToGCDirtySDOCache
	(*CMsgSDONoMemcached)(nil),                          // 36: deadlock.CMsgSDONoMemcached
	(*CMsgGCToGCUpdateSQLKeyValue)(nil),                 // 37: deadlock.CMsgGCToGCUpdateSQLKeyValue
	(*CMsgGCServerVersionUpdated)(nil),                  // 38: deadlock.CMsgGCServerVersionUpdated
	(*CMsgGCClientVersionUpdated)(nil),                  // 39: deadlock.CMsgGCClientVersionUpdated
	(*CMsgGCToGCWebAPIAccountChanged)(nil),              // 40: deadlock.CMsgGCToGCWebAPIAccountChanged
	(*CMsgExtractGems)(nil),                             // 41: deadlock.CMsgExtractGems
	(*CMsgExtractGemsResponse)(nil),                     // 42: deadlock.CMsgExtractGemsResponse
	(*CMsgAddSocket)(nil),                               // 43: deadlock.CMsgAddSocket
	(*CMsgAddSocketResponse)(nil),                       // 44: deadlock.CMsgAddSocketResponse
	(*CMsgAddItemToSocketData)(nil),                     // 45: deadlock.CMsgAddItemToSocketData
	(*CMsgAddItemToSocket)(nil),                         // 46: deadlock.CMsgAddItemToSocket
	(*CMsgAddItemToSocketResponse)(nil),                 // 47: deadlock.CMsgAddItemToSocketResponse
	(*CMsgResetStrangeGemCount)(nil),                    // 48: deadlock.CMsgResetStrangeGemCount
	(*CMsgResetStrangeGemCountResponse)(nil),            // 49: deadlock.CMsgResetStrangeGemCountResponse
	(*CMsgGCToClientPollFileRequest)(nil),               // 50: deadlock.CMsgGCToClientPollFileRequest
	(*CMsgGCToClientPollFileResponse)(nil),              // 51: deadlock.CMsgGCToClientPollFileResponse
	(*CMsgGCToGCPerformManualOp)(nil),                   // 52: deadlock.CMsgGCToGCPerformManualOp
	(*CMsgGCToGCPerformManualOpCompleted)(nil),          // 53: deadlock.CMsgGCToGCPerformManualOpCompleted
	(*CMsgGCToGCReloadServerRegionSettings)(nil),        // 54: deadlock.CMsgGCToGCReloadServerRegionSettings
	(*CMsgGCAdditionalWelcomeMsgList)(nil),              // 55: deadlock.CMsgGCAdditionalWelcomeMsgList
	(*CMsgApplyRemoteConVars)(nil),                      // 56: deadlock.CMsgApplyRemoteConVars
	(*CMsgGCToClientApplyRemoteConVars)(nil),            // 57: deadlock.CMsgGCToClientApplyRemoteConVars
	(*CMsgGCToServerApplyRemoteConVars)(nil),            // 58: deadlock.CMsgGCToServerApplyRemoteConVars
	(*CMsgClientToGCIntegrityStatus)(nil),               // 59: deadlock.CMsgClientToGCIntegrityStatus
	(*CMsgClientToGCAggregateMetrics)(nil),              // 60: deadlock.CMsgClientToGCAggregateMetrics
	(*CMsgGCToClientAggregateMetricsBackoff)(nil),       // 61: deadlock.CMsgGCToClientAggregateMetricsBackoff
	(*CMsgGCToServerSteamLearnAccessTokensChanged)(nil), // 62: deadlock.CMsgGCToServerSteamLearnAccessTokensChanged
	(*CMsgGCToServerSteamLearnUseHTTP)(nil),             // 63: deadlock.CMsgGCToServerSteamLearnUseHTTP
	(*CMsgSetItemPositions_ItemPosition)(nil),           // 64: deadlock.CMsgSetItemPositions.ItemPosition
	(*CMsgApplyRemoteConVars_ConVar)(nil),               // 65: deadlock.CMsgApplyRemoteConVars.ConVar
	(*CMsgClientToGCIntegrityStatusKeyvalue)(nil),       // 66: deadlock.CMsgClientToGCIntegrityStatus.keyvalue
	(*CMsgClientToGCAggregateMetrics_SingleMetric)(nil), // 67: deadlock.CMsgClientToGCAggregateMetrics.SingleMetric
	(*CExtraMsgBlock)(nil),                              // 68: deadlock.CExtraMsgBlock
	(*CMsgSteamLearnAccessTokens)(nil),                  // 69: deadlock.CMsgSteamLearnAccessTokens
	(EGCPlatform)(0),                                    // 70: deadlock.EGCPlatform
}
var file_base_gcmessages_proto_depIdxs = []int32{
	6,  // 0: deadlock.CMsgGCStorePurchaseInit.line_items:type_name -> deadlock.CGCStorePurchaseInit_LineItem
	9,  // 1: deadlock.CMsgInviteToParty.ping_data:type_name -> deadlock.CMsgClientPingData
	9,  // 2: deadlock.CMsgPartyInviteResponse.ping_data:type_name -> deadlock.CMsgClientPingData
	1,  // 3: deadlock.CMsgCustomGameInstallStatus.status:type_name -> deadlock.ECustomGameInstallStatus
	17, // 4: deadlock.CMsgServerAvailable.custom_game_install_status:type_name -> deadlock.CMsgCustomGameInstallStatus
	24, // 5: deadlock.CSOEconItem.attribute:type_name -> deadlock.CSOEconItemAttribute
	26, // 6: deadlock.CSOEconItem.interior_item:type_name -> deadlock.CSOEconItem
	25, // 7: deadlock.CSOEconItem.equipped_state:type_name -> deadlock.CSOEconItemEquipped
	64, // 8: deadlock.CMsgSetItemPositions.item_positions:type_name -> deadlock.CMsgSetItemPositions.ItemPosition
	2,  // 9: deadlock.CMsgExtractGemsResponse.response:type_name -> deadlock.CMsgExtractGemsResponse.EExtractGems
	3,  // 10: deadlock.CMsgAddSocketResponse.response:type_name -> deadlock.CMsgAddSocketResponse.EAddSocket
	45, // 11: deadlock.CMsgAddItemToSocket.gems_to_socket:type_name -> deadlock.CMsgAddItemToSocketData
	4,  // 12: deadlock.CMsgAddItemToSocketResponse.response:type_name -> deadlock.CMsgAddItemToSocketResponse.EAddGem
	5,  // 13: deadlock.CMsgResetStrangeGemCountResponse.response:type_name -> deadlock.CMsgResetStrangeGemCountResponse.EResetGem
	68, // 14: deadlock.CMsgGCAdditionalWelcomeMsgList.welcome_messages:type_name -> deadlock.CExtraMsgBlock
	65, // 15: deadlock.CMsgApplyRemoteConVars.con_vars:type_name -> deadlock.CMsgApplyRemoteConVars.ConVar
	56, // 16: deadlock.CMsgGCToClientApplyRemoteConVars.msg:type_name -> deadlock.CMsgApplyRemoteConVars
	56, // 17: deadlock.CMsgGCToServerApplyRemoteConVars.msg:type_name -> deadlock.CMsgApplyRemoteConVars
	66, // 18: deadlock.CMsgClientToGCIntegrityStatus.diagnostics:type_name -> deadlock.CMsgClientToGCIntegrityStatus.keyvalue
	67, // 19: deadlock.CMsgClientToGCAggregateMetrics.metrics:type_name -> deadlock.CMsgClientToGCAggregateMetrics.SingleMetric
	69, // 20: deadlock.CMsgGCToServerSteamLearnAccessTokensChanged.access_tokens:type_name -> deadlock.CMsgSteamLearnAccessTokens
	70, // 21: deadlock.CMsgApplyRemoteConVars.ConVar.platform:type_name -> deadlock.EGCPlatform
