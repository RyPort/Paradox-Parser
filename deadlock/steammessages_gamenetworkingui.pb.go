...
const file_steammessages_gamenetworkingui_proto_rawDesc = "" +
	"\n" +
	"$steammessages_gamenetworkingui.proto\x12\bdeadlock\x1a%steamnetworkingsockets_messages.proto\x1a steamdatagram_messages_sdr.proto\"\x1f\n" +
	"\x1dCGameNetworkingUI_GlobalState\"\xe8\v\n" +
	...
	"\x0eaddress_remote\x18\x17 \x01(\tR\raddressRemote\x12M\n" +
	"\vp2p_routing\x18\x18 \x01(\v2,.deadlock.CMsgSteamDatagramP2PRoutingSummaryR\n" +
	"p2pRouting\x12#\n" +
	"\rping_interior\x18\x19 \x01(\rR\fpingInterior\x12*\n" +
	"\x11ping_remote_front\x18\x1a \x01(\rR\x0fpingRemoteFront\x12=\n" +
	"\x1bping_default_internet_route\x18\x1b \x01(\rR\x18pingDefaultInternetRoute\x12X\n" +
	"\x11e2e_quality_local\x18\x1e \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\x0fe2eQualityLocal\x12Z\n" +
	"\x12e2e_quality_remote\x18\x1f \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\x10e2eQualityRemote\x12P\n" +
	"%e2e_quality_remote_instantaneous_time\x18  \x01(\x04R!e2eQualityRemoteInstantaneousTime\x12F\n" +
	" e2e_quality_remote_lifetime_time\x18! \x01(\x04R\x1ce2eQualityRemoteLifetimeTime\x12\\\n" +
	"\x13front_quality_local\x18( \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\x11frontQualityLocal\x12^\n" +
	"\x14front_quality_remote\x18) \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\x12frontQualityRemote\x12T\n" +
	"'front_quality_remote_instantaneous_time\x18* \x01(\x04R#frontQualityRemoteInstantaneousTime\x12J\n" +
	"\"front_quality_remote_lifetime_time\x18+ \x01(\x04R\x1efrontQualityRemoteLifetimeTime\"s\n" +
	"\x19CGameNetworkingUI_Message\x12V\n" +
	"\x10connection_state\x18\x01 \x03(\v2+.deadlock.CGameNetworkingUI_ConnectionStateR\x0fconnectionState\"\xdc\x02\n" +
	...
	"\rip_was_shared\x18\a \x01(\bR\vipWasShared\"\xa7\x02\n" +
	...
	"\x12active_connections\x18\x14 \x01(\rR\x11activeConnections\x12H\n" +
	"\bmain_cxn\x18\x1e \x01(\v2-.deadlock.CGameNetworkingUI_ConnectionSummaryR\amainCxnB9H\x01Z2github.com/RyPort/paradox-parser/deadlock;deadlock\x80\x01\x01"
...
var file_steammessages_gamenetworkingui_proto_goTypes = []any{
	(*CGameNetworkingUI_GlobalState)(nil),       // 0: deadlock.CGameNetworkingUI_GlobalState
	(*CGameNetworkingUI_ConnectionState)(nil),   // 1: deadlock.CGameNetworkingUI_ConnectionState
	(*CGameNetworkingUI_Message)(nil),           // 2: deadlock.CGameNetworkingUI_Message
	(*CGameNetworkingUI_ConnectionSummary)(nil), // 3: deadlock.CGameNetworkingUI_ConnectionSummary
	(*CGameNetworkingUI_AppSummary)(nil),        // 4: deadlock.CGameNetworkingUI_AppSummary
	(*CMsgSteamDatagramP2PRoutingSummary)(nil),  // 5: deadlock.CMsgSteamDatagramP2PRoutingSummary
	(*CMsgSteamDatagramConnectionQuality)(nil),  // 6: deadlock.CMsgSteamDatagramConnectionQuality
}
var file_steammessages_gamenetworkingui_proto_depIdxs = []int32{
	5, // 0: deadlock.CGameNetworkingUI_ConnectionState.p2p_routing:type_name -> deadlock.CMsgSteamDatagramP2PRoutingSummary
	6, // 1: deadlock.CGameNetworkingUI_ConnectionState.e2e_quality_local:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	6, // 2: deadlock.CGameNetworkingUI_ConnectionState.e2e_quality_remote:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	6, // 3: deadlock.CGameNetworkingUI_ConnectionState.front_quality_local:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	6, // 4: deadlock.CGameNetworkingUI_ConnectionState.front_quality_remote:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	1, // 5: deadlock.CGameNetworkingUI_Message.connection_state:type_name -> deadlock.CGameNetworkingUI_ConnectionState
	3, // 6: deadlock.CGameNetworkingUI_AppSummary.main_cxn:type_name -> deadlock.CGameNetworkingUI_ConnectionSummary
