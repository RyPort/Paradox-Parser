...
type CMsgSteamDatagramSessionCryptInfo struct {
	...
	KeyType         *CMsgSteamDatagramSessionCryptInfo_EKeyType `protobuf:"varint,1,opt,name=key_type,json=keyType,enum=deadlock.CMsgSteamDatagramSessionCryptInfo_EKeyType,def=0" json:"key_type,omitempty"`
	...
	Ciphers         []ESteamNetworkingSocketsCipher             `protobuf:"varint,5,rep,name=ciphers,enum=deadlock.ESteamNetworkingSocketsCipher" json:"ciphers,omitempty"`
...
const file_steamnetworkingsockets_messages_proto_rawDesc = "" +
	"\n" +
	"%steamnetworkingsockets_messages.proto\x12\bdeadlock\x1a+steamnetworkingsockets_messages_certs.proto\"\xc5\x02\n" +
	"!CMsgSteamDatagramSessionCryptInfo\x12X\n" +
	"\bkey_type\x18\x01 \x01(\x0e24.deadlock.CMsgSteamDatagramSessionCryptInfo.EKeyType:\aINVALIDR\akeyType\x12\x19\n" +
	"\bkey_data\x18\x02 \x01(\fR\akeyData\x12\x14\n" +
	"\x05nonce\x18\x03 \x01(\x06R\x05nonce\x12)\n" +
	"\x10protocol_version\x18\x04 \x01(\rR\x0fprotocolVersion\x12A\n" +
	"\aciphers\x18\x05 \x03(\x0e2'.deadlock.ESteamNetworkingSocketsCipherR\aciphers\"'\n" +
	"\bEKeyType\x12\v\n" +
	...
	"\x13jitter_histogram_20\x18B \x01(\rR\x11jitterHistogram20\"\xc7\x01\n" +
	"\"CMsgSteamDatagramConnectionQuality\x12W\n" +
	"\rinstantaneous\x18\x01 \x01(\v21.deadlock.CMsgSteamDatagramLinkInstantaneousStatsR\rinstantaneous\x12H\n" +
	"\blifetime\x18\x02 \x01(\v2,.deadlock.CMsgSteamDatagramLinkLifetimeStatsR\blifetime\"0\n" +
	"\x10CMsgICECandidate\x12\x1c\n" +
	"\tcandidate\x18\x03 \x01(\tR\tcandidate\"\xad\x01\n" +
	"\x11CMsgICERendezvous\x124\n" +
	"\x04auth\x18\x02 \x01(\v2 .deadlock.CMsgICERendezvous.AuthR\x04auth\x12?\n" +
	"\radd_candidate\x18\x01 \x01(\v2\x1a.deadlock.CMsgICECandidateR\faddCandidate\x1a!\n" +
	"\x04Auth\x12\x19\n" +
	"\bpwd_frag\x18\x01 \x01(\tR\apwdFrag\"\xee\f\n" +
	...
	"iceEnabled\x120\n" +
	"\x14hosted_server_ticket\x18\x0e \x01(\fR\x12hostedServerTicket\x12b\n" +
	"\x0fconnect_request\x18\x04 \x01(\v29.deadlock.CMsgSteamNetworkingP2PRendezvous.ConnectRequestR\x0econnectRequest\x12S\n" +
	"\n" +
	"connect_ok\x18\x05 \x01(\v24.deadlock.CMsgSteamNetworkingP2PRendezvous.ConnectOKR\tconnectOk\x12h\n" +
	"\x11connection_closed\x18\x06 \x01(\v2;.deadlock.CMsgSteamNetworkingP2PRendezvous.ConnectionClosedR\x10connectionClosed\x12(\n" +
	"\x10ack_reliable_msg\x18\v \x01(\rR\x0eackReliableMsg\x12,\n" +
	"\x12first_reliable_msg\x18\f \x01(\rR\x10firstReliableMsg\x12g\n" +
	"\x11reliable_messages\x18\r \x03(\v2:.deadlock.CMsgSteamNetworkingP2PRendezvous.ReliableMessageR\x10reliableMessages\x12p\n" +
	"\x14application_messages\x18\x0f \x03(\v2=.deadlock.CMsgSteamNetworkingP2PRendezvous.ApplicationMessageR\x13applicationMessages\x1a\x90\x02\n" +
	...
	"+k_ESteamNetworkingSocketsCipher_AES_256_GCM\x10\x02B9H\x01Z2github.com/RyPort/paradox-parser/deadlock;deadlock\x80\x01\x00"
...
var file_steamnetworkingsockets_messages_proto_goTypes = []any{
	(ESteamNetworkingSocketsCipher)(0),                          // 0: deadlock.ESteamNetworkingSocketsCipher
	(CMsgSteamDatagramSessionCryptInfo_EKeyType)(0),             // 1: deadlock.CMsgSteamDatagramSessionCryptInfo.EKeyType
	(*CMsgSteamDatagramSessionCryptInfo)(nil),                   // 2: deadlock.CMsgSteamDatagramSessionCryptInfo
	(*CMsgSteamDatagramSessionCryptInfoSigned)(nil),             // 3: deadlock.CMsgSteamDatagramSessionCryptInfoSigned
	(*CMsgSteamDatagramDiagnostic)(nil),                         // 4: deadlock.CMsgSteamDatagramDiagnostic
	(*CMsgSteamDatagramLinkInstantaneousStats)(nil),             // 5: deadlock.CMsgSteamDatagramLinkInstantaneousStats
	(*CMsgSteamDatagramLinkLifetimeStats)(nil),                  // 6: deadlock.CMsgSteamDatagramLinkLifetimeStats
	(*CMsgSteamDatagramConnectionQuality)(nil),                  // 7: deadlock.CMsgSteamDatagramConnectionQuality
	(*CMsgICECandidate)(nil),                                    // 8: deadlock.CMsgICECandidate
	(*CMsgICERendezvous)(nil),                                   // 9: deadlock.CMsgICERendezvous
	(*CMsgSteamNetworkingP2PRendezvous)(nil),                    // 10: deadlock.CMsgSteamNetworkingP2PRendezvous
	(*CMsgSteamNetworkingICESessionSummary)(nil),                // 11: deadlock.CMsgSteamNetworkingICESessionSummary
	(*CMsgICERendezvous_Auth)(nil),                              // 12: deadlock.CMsgICERendezvous.Auth
	(*CMsgSteamNetworkingP2PRendezvous_ConnectRequest)(nil),     // 13: deadlock.CMsgSteamNetworkingP2PRendezvous.ConnectRequest
	(*CMsgSteamNetworkingP2PRendezvous_ConnectOK)(nil),          // 14: deadlock.CMsgSteamNetworkingP2PRendezvous.ConnectOK
	(*CMsgSteamNetworkingP2PRendezvous_ConnectionClosed)(nil),   // 15: deadlock.CMsgSteamNetworkingP2PRendezvous.ConnectionClosed
	(*CMsgSteamNetworkingP2PRendezvous_ReliableMessage)(nil),    // 16: deadlock.CMsgSteamNetworkingP2PRendezvous.ReliableMessage
	(*CMsgSteamNetworkingP2PRendezvous_ApplicationMessage)(nil), // 17: deadlock.CMsgSteamNetworkingP2PRendezvous.ApplicationMessage
	(*CMsgSteamDatagramCertificateSigned)(nil),                  // 18: deadlock.CMsgSteamDatagramCertificateSigned
}
var file_steamnetworkingsockets_messages_proto_depIdxs = []int32{
	1,  // 0: deadlock.CMsgSteamDatagramSessionCryptInfo.key_type:type_name -> deadlock.CMsgSteamDatagramSessionCryptInfo.EKeyType
	0,  // 1: deadlock.CMsgSteamDatagramSessionCryptInfo.ciphers:type_name -> deadlock.ESteamNetworkingSocketsCipher
	5,  // 2: deadlock.CMsgSteamDatagramConnectionQuality.instantaneous:type_name -> deadlock.CMsgSteamDatagramLinkInstantaneousStats
	6,  // 3: deadlock.CMsgSteamDatagramConnectionQuality.lifetime:type_name -> deadlock.CMsgSteamDatagramLinkLifetimeStats
	12, // 4: deadlock.CMsgICERendezvous.auth:type_name -> deadlock.CMsgICERendezvous.Auth
	8,  // 5: deadlock.CMsgICERendezvous.add_candidate:type_name -> deadlock.CMsgICECandidate
	13, // 6: deadlock.CMsgSteamNetworkingP2PRendezvous.connect_request:type_name -> deadlock.CMsgSteamNetworkingP2PRendezvous.ConnectRequest
	14, // 7: deadlock.CMsgSteamNetworkingP2PRendezvous.connect_ok:type_name -> deadlock.CMsgSteamNetworkingP2PRendezvous.ConnectOK
	15, // 8: deadlock.CMsgSteamNetworkingP2PRendezvous.connection_closed:type_name -> deadlock.CMsgSteamNetworkingP2PRendezvous.ConnectionClosed
	16, // 9: deadlock.CMsgSteamNetworkingP2PRendezvous.reliable_messages:type_name -> deadlock.CMsgSteamNetworkingP2PRendezvous.ReliableMessage
	17, // 10: deadlock.CMsgSteamNetworkingP2PRendezvous.application_messages:type_name -> deadlock.CMsgSteamNetworkingP2PRendezvous.ApplicationMessage
	3,  // 11: deadlock.CMsgSteamNetworkingP2PRendezvous.ConnectRequest.crypt:type_name -> deadlock.CMsgSteamDatagramSessionCryptInfoSigned
	18, // 12: deadlock.CMsgSteamNetworkingP2PRendezvous.ConnectRequest.cert:type_name -> deadlock.CMsgSteamDatagramCertificateSigned
	3,  // 13: deadlock.CMsgSteamNetworkingP2PRendezvous.ConnectOK.crypt:type_name -> deadlock.CMsgSteamDatagramSessionCryptInfoSigned
	18, // 14: deadlock.CMsgSteamNetworkingP2PRendezvous.ConnectOK.cert:type_name -> deadlock.CMsgSteamDatagramCertificateSigned
	9,  // 15: deadlock.CMsgSteamNetworkingP2PRendezvous.ReliableMessage.ice:type_name -> deadlock.CMsgICERendezvous
