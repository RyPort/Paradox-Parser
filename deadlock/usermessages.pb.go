...
type CUserMessageCreditsMsg struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Rolltype      *ERollType             `protobuf:"varint,1,opt,name=rolltype,enum=deadlock.ERollType,def=-1" json:"rolltype,omitempty"`
...
type CUserMsg_ParticleManager struct {
	state                            protoimpl.MessageState                                     `protogen:"open.v1"`
	Type                             *PARTICLE_MESSAGE                                          `protobuf:"varint,1,req,name=type,enum=deadlock.PARTICLE_MESSAGE,def=0" json:"type,omitempty"`
...
const file_usermessages_proto_rawDesc = "" +
	"\n" +
	"\x12usermessages.proto\x12\bdeadlock\x1a\x16networkbasetypes.proto\"@\n" +
	...
	"\x14CUserMessageShakeDir\x121\n" +
	"\x05shake\x18\x01 \x01(\v2\x1b.deadlock.CUserMessageShakeR\x05shake\x122\n" +
	"\tdirection\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\tdirection\"\x8a\x01\n" +
	"\x16CUserMessageWaterShake\x12\x18\n" +
	"\acommand\x18\x01 \x01(\rR\acommand\x12\x1c\n" +
	"\tamplitude\x18\x02 \x01(\x02R\tamplitude\x12\x1c\n" +
	"\tfrequency\x18\x03 \x01(\x02R\tfrequency\x12\x1a\n" +
	"\bduration\x18\x04 \x01(\x02R\bduration\"\xae\x01\n" +
	"\x16CUserMessageScreenTilt\x12\x18\n" +
	"\acommand\x18\x01 \x01(\rR\acommand\x12\x1e\n" +
	"\vease_in_out\x18\x02 \x01(\bR\teaseInOut\x12*\n" +
	"\x05angle\x18\x03 \x01(\v2\x14.deadlock.CMsgVectorR\x05angle\x12\x1a\n" +
	...
	"\brolltype\x18\x01 \x01(\x0e2\x13.deadlock.eRollType:\tROLL_NONER\brolltype\x12\x1f\n" +
	"\vlogo_length\x18\x02 \x01(\x02R\n" +
	"logoLength\"O\n" +
	"\x18CEntityMessagePlayJingle\x123\n" +
	"\n" +
	"entity_msg\x18\x01 \x01(\v2\x14.deadlock.CEntityMsgR\tentityMsg\"u\n" +
	"\x1bCEntityMessageScreenOverlay\x12!\n" +
	"\fstart_effect\x18\x01 \x01(\bR\vstartEffect\x123\n" +
	"\n" +
	"entity_msg\x18\x02 \x01(\v2\x14.deadlock.CEntityMsgR\tentityMsg\"y\n" +
	"\x1dCEntityMessageRemoveAllDecals\x12#\n" +
	"\rremove_decals\x18\x01 \x01(\bR\fremoveDecals\x123\n" +
	"\n" +
	"entity_msg\x18\x02 \x01(\v2\x14.deadlock.CEntityMsgR\tentityMsg\"\x83\x01\n" +
	"\x1cCEntityMessagePropagateForce\x12.\n" +
	"\aimpulse\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\aimpulse\x123\n" +
	"\n" +
	"entity_msg\x18\x02 \x01(\v2\x14.deadlock.CEntityMsgR\tentityMsg\"\x96\x02\n" +
	...
	"\bduration\x18\a \x01(\x02R\bduration\x123\n" +
	"\n" +
	"entity_msg\x18\b \x01(\v2\x14.deadlock.CEntityMsgR\tentityMsg\"\x95\x01\n" +
	"\x16CEntityMessageFixAngle\x12\x1a\n" +
	"\brelative\x18\x01 \x01(\bR\brelative\x12*\n" +
	"\x05angle\x18\x02 \x01(\v2\x14.deadlock.CMsgQAngleR\x05angle\x123\n" +
	"\n" +
	"entity_msg\x18\x03 \x01(\v2\x14.deadlock.CEntityMsgR\tentityMsg\"\xc6\x02\n" +
	"\x1cCUserMessageCameraTransition\x12\x1f\n" +
	"\vcamera_type\x18\x01 \x01(\rR\n" +
	"cameraType\x12\x1a\n" +
	"\bduration\x18\x02 \x01(\x02R\bduration\x12j\n" +
	"\x12params_data_driven\x18\x03 \x01(\v2<.deadlock.CUserMessageCameraTransition.Transition_DataDrivenR\x10paramsDataDriven\x1a}\n" +
	"\x15Transition_DataDriven\x12\x1a\n" +
	"\bfilename\x18\x01 \x01(\tR\bfilename\x12,\n" +
	"\x10attach_ent_index\x18\x02 \x01(\x05:\x02-1R\x0eattachEntIndex\x12\x1a\n" +
	"\bduration\x18\x03 \x01(\x02R\bduration\"\xd8S\n" +
	"\x18CUserMsg_ParticleManager\x12R\n" +
	"\x04type\x18\x01 \x02(\x0e2\x1a.deadlock.PARTICLE_MESSAGE:\"GAME_PARTICLE_MANAGER_EVENT_CREATER\x04type\x12\x14\n" +
	"\x05index\x18\x02 \x02(\rR\x05index\x12m\n" +
	"\x16release_particle_index\x18\x03 \x01(\v27.deadlock.CUserMsg_ParticleManager.ReleaseParticleIndexR\x14releaseParticleIndex\x12Z\n" +
	"\x0fcreate_particle\x18\x04 \x01(\v21.deadlock.CUserMsg_ParticleManager.CreateParticleR\x0ecreateParticle\x12]\n" +
	"\x10destroy_particle\x18\x05 \x01(\v22.deadlock.CUserMsg_ParticleManager.DestroyParticleR\x0fdestroyParticle\x12y\n" +
	"\x1adestroy_particle_involving\x18\x06 \x01(\v2;.deadlock.CUserMsg_ParticleManager.DestroyParticleInvolvingR\x18destroyParticleInvolving\x12c\n" +
	"\x0fupdate_particle\x18\a \x01(\v2:.deadlock.CUserMsg_ParticleManager.UpdateParticle_OBSOLETER\x0eupdateParticle\x12m\n" +
	"\x13update_particle_fwd\x18\b \x01(\v2=.deadlock.CUserMsg_ParticleManager.UpdateParticleFwd_OBSOLETER\x11updateParticleFwd\x12v\n" +
	"\x16update_particle_orient\x18\t \x01(\v2@.deadlock.CUserMsg_ParticleManager.UpdateParticleOrient_OBSOLETER\x14updateParticleOrient\x12s\n" +
	"\x18update_particle_fallback\x18\n" +
	" \x01(\v29.deadlock.CUserMsg_ParticleManager.UpdateParticleFallbackR\x16updateParticleFallback\x12m\n" +
	"\x16update_particle_offset\x18\v \x01(\v27.deadlock.CUserMsg_ParticleManager.UpdateParticleOffsetR\x14updateParticleOffset\x12d\n" +
	"\x13update_particle_ent\x18\f \x01(\v24.deadlock.CUserMsg_ParticleManager.UpdateParticleEntR\x11updateParticleEnt\x12z\n" +
	"\x1bupdate_particle_should_draw\x18\x0e \x01(\v2;.deadlock.CUserMsg_ParticleManager.UpdateParticleShouldDrawR\x18updateParticleShouldDraw\x12w\n" +
	"\x1aupdate_particle_set_frozen\x18\x0f \x01(\v2:.deadlock.CUserMsg_ParticleManager.UpdateParticleSetFrozenR\x17updateParticleSetFrozen\x12\x86\x01\n" +
	"\x1fchange_control_point_attachment\x18\x10 \x01(\v2?.deadlock.CUserMsg_ParticleManager.ChangeControlPointAttachmentR\x1cchangeControlPointAttachment\x12m\n" +
	"\x16update_entity_position\x18\x11 \x01(\v27.deadlock.CUserMsg_ParticleManager.UpdateEntityPositionR\x14updateEntityPosition\x12z\n" +
	"\x1bset_particle_fow_properties\x18\x12 \x01(\v2;.deadlock.CUserMsg_ParticleManager.SetParticleFoWPropertiesR\x18setParticleFowProperties\x12^\n" +
	"\x11set_particle_text\x18\x13 \x01(\v22.deadlock.CUserMsg_ParticleManager.SetParticleTextR\x0fsetParticleText\x12~\n" +
	"\x1dset_particle_should_check_fow\x18\x14 \x01(\v2<.deadlock.CUserMsg_ParticleManager.SetParticleShouldCheckFoWR\x19setParticleShouldCheckFow\x12n\n" +
	"\x17set_control_point_model\x18\x15 \x01(\v27.deadlock.CUserMsg_ParticleManager.SetControlPointModelR\x14setControlPointModel\x12w\n" +
	"\x1aset_control_point_snapshot\x18\x16 \x01(\v2:.deadlock.CUserMsg_ParticleManager.SetControlPointSnapshotR\x17setControlPointSnapshot\x12j\n" +
	"\x15set_texture_attribute\x18\x17 \x01(\v26.deadlock.CUserMsg_ParticleManager.SetTextureAttributeR\x13setTextureAttribute\x12~\n" +
	"\x1dset_scene_object_generic_flag\x18\x18 \x01(\v2<.deadlock.CUserMsg_ParticleManager.SetSceneObjectGenericFlagR\x19setSceneObjectGenericFlag\x12\x82\x01\n" +
	"\x1fset_scene_object_tint_and_desat\x18\x19 \x01(\v2=.deadlock.CUserMsg_ParticleManager.SetSceneObjectTintAndDesatR\x1asetSceneObjectTintAndDesat\x12m\n" +
	"\x16destroy_particle_named\x18\x1a \x01(\v27.deadlock.CUserMsg_ParticleManager.DestroyParticleNamedR\x14destroyParticleNamed\x12h\n" +
	"\x15particle_skip_to_time\x18\x1b \x01(\v25.deadlock.CUserMsg_ParticleManager.ParticleSkipToTimeR\x12particleSkipToTime\x12d\n" +
	"\x13particle_can_freeze\x18\x1c \x01(\v24.deadlock.CUserMsg_ParticleManager.ParticleCanFreezeR\x11particleCanFreeze\x12v\n" +
	"\x17set_named_value_context\x18\x1d \x01(\v2?.deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContextR\x14setNamedValueContext\x12v\n" +
	"\x19update_particle_transform\x18\x1e \x01(\v2:.deadlock.CUserMsg_ParticleManager.UpdateParticleTransformR\x17updateParticleTransform\x12\x92\x01\n" +
	"#particle_freeze_transition_override\x18\x1f \x01(\v2C.deadlock.CUserMsg_ParticleManager.ParticleFreezeTransitionOverrideR particleFreezeTransitionOverride\x12v\n" +
	"\x19freeze_particle_involving\x18  \x01(\v2:.deadlock.CUserMsg_ParticleManager.FreezeParticleInvolvingR\x17freezeParticleInvolving\x12\x83\x01\n" +
	"\x1eadd_modellist_override_element\x18! \x01(\v2>.deadlock.CUserMsg_ParticleManager.AddModellistOverrideElementR\x1baddModellistOverrideElement\x12s\n" +
	"\x18clear_modellist_override\x18\" \x01(\v29.deadlock.CUserMsg_ParticleManager.ClearModellistOverrideR\x16clearModellistOverride\x12a\n" +
	"\x12create_physics_sim\x18# \x01(\v23.deadlock.CUserMsg_ParticleManager.CreatePhysicsSimR\x10createPhysicsSim\x12d\n" +
	"\x13destroy_physics_sim\x18$ \x01(\v24.deadlock.CUserMsg_ParticleManager.DestroyPhysicsSimR\x11destroyPhysicsSim\x12H\n" +
	"\tset_vdata\x18% \x01(\v2+.deadlock.CUserMsg_ParticleManager.SetVDataR\bsetVdata\x12j\n" +
	"\x15set_material_override\x18& \x01(\v26.deadlock.CUserMsg_ParticleManager.SetMaterialOverrideR\x13setMaterialOverride\x12B\n" +
	"\aadd_fan\x18' \x01(\v2).deadlock.CUserMsg_ParticleManager.AddFanR\x06addFan\x12K\n" +
	"\n" +
	"update_fan\x18( \x01(\v2,.deadlock.CUserMsg_ParticleManager.UpdateFanR\tupdateFan\x12z\n" +
	"\x1bset_particle_cluster_growth\x18) \x01(\v2;.deadlock.CUserMsg_ParticleManager.SetParticleClusterGrowthR\x18setParticleClusterGrowth\x1a\x16\n" +
	"\x14ReleaseParticleIndex\x1a\xf5\x03\n" +
	...
	" \x01(\v2\x14.deadlock.CMsgVectorR\x13aggregationPosition\x1aB\n" +
	...
	"\bposition\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\bposition\x1aq\n" +
	"\x1aUpdateParticleFwd_OBSOLETE\x12#\n" +
	"\rcontrol_point\x18\x01 \x01(\x05R\fcontrolPoint\x12.\n" +
	"\aforward\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\aforward\x1a\x85\x02\n" +
	"\x1dUpdateParticleOrient_OBSOLETE\x12#\n" +
	"\rcontrol_point\x18\x01 \x01(\x05R\fcontrolPoint\x12.\n" +
	"\aforward\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\aforward\x12?\n" +
	"\x10deprecated_right\x18\x03 \x01(\v2\x14.deadlock.CMsgVectorR\x0fdeprecatedRight\x12$\n" +
	"\x02up\x18\x04 \x01(\v2\x14.deadlock.CMsgVectorR\x02up\x12(\n" +
	"\x04left\x18\x05 \x01(\v2\x14.deadlock.CMsgVectorR\x04left\x1a\xe3\x01\n" +
	"\x17UpdateParticleTransform\x12#\n" +
	"\rcontrol_point\x18\x01 \x01(\x05R\fcontrolPoint\x120\n" +
	"\bposition\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\bposition\x12:\n" +
	"\vorientation\x18\x03 \x01(\v2\x18.deadlock.CMsgQuaternionR\vorientation\x125\n" +
	"\x16interpolation_interval\x18\x04 \x01(\x02R\x15interpolationInterval\x1ao\n" +
	"\x16UpdateParticleFallback\x12#\n" +
	"\rcontrol_point\x18\x01 \x01(\x05R\fcontrolPoint\x120\n" +
	"\bposition\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\bposition\x1a\xaf\x01\n" +
	"\x14UpdateParticleOffset\x12#\n" +
	"\rcontrol_point\x18\x01 \x01(\x05R\fcontrolPoint\x129\n" +
	"\rorigin_offset\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\foriginOffset\x127\n" +
	"\fangle_offset\x18\x03 \x01(\v2\x14.deadlock.CMsgQAngleR\vangleOffset\x1a\x92\x03\n" +
	...
	"attachment\x12A\n" +
	"\x11fallback_position\x18\x05 \x01(\v2\x14.deadlock.CMsgVectorR\x10fallbackPosition\x12+\n" +
	"\x11include_wearables\x18\x06 \x01(\bR\x10includeWearables\x12=\n" +
	"\x0foffset_position\x18\a \x01(\v2\x14.deadlock.CMsgVectorR\x0eoffsetPosition\x129\n" +
	"\roffset_angles\x18\b \x01(\v2\x14.deadlock.CMsgQAngleR\foffsetAngles\x1ai\n" +
	...
	"\rentity_handle\x18\x03 \x01(\r:\b16777215R\fentityHandle\x1aw\n" +
	"\x14UpdateEntityPosition\x12-\n" +
	"\rentity_handle\x18\x01 \x01(\r:\b16777215R\fentityHandle\x120\n" +
	"\bposition\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\bposition\x1a\x93\x01\n" +
	...
	"\agroupid\x18\x01 \x01(\rR\agroupid\x1a\xcd\a\n" +
	"\x1cSetParticleNamedValueContext\x12t\n" +
	"\ffloat_values\x18\x01 \x03(\v2Q.deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.FloatContextValueR\vfloatValues\x12w\n" +
	"\rvector_values\x18\x02 \x03(\v2R.deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.VectorContextValueR\fvectorValues\x12\x80\x01\n" +
	"\x10transform_values\x18\x03 \x03(\v2U.deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.TransformContextValueR\x0ftransformValues\x12u\n" +
	"\x0eehandle_values\x18\x04 \x03(\v2N.deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.EHandleContextR\rehandleValues\x1aQ\n" +
	"\x11FloatContextValue\x12&\n" +
	"\x0fvalue_name_hash\x18\x01 \x01(\rR\rvalueNameHash\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x02R\x05value\x1ah\n" +
	"\x12VectorContextValue\x12&\n" +
	"\x0fvalue_name_hash\x18\x01 \x01(\rR\rvalueNameHash\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\x05value\x1a\xa5\x01\n" +
	"\x15TransformContextValue\x12&\n" +
	"\x0fvalue_name_hash\x18\x01 \x01(\rR\rvalueNameHash\x12,\n" +
	"\x06angles\x18\x02 \x01(\v2\x14.deadlock.CMsgQAngleR\x06angles\x126\n" +
	"\vtranslation\x18\x03 \x01(\v2\x14.deadlock.CMsgVectorR\vtranslation\x1a_\n" +
	...
	"\x10include_children\x18\x02 \x01(\bR\x0fincludeChildren\x1a\x92\x04\n" +
	"\x06AddFan\x12\x16\n" +
	"\x06active\x18\x01 \x01(\bR\x06active\x125\n" +
	"\vbounds_mins\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\n" +
	"boundsMins\x125\n" +
	"\vbounds_maxs\x18\x03 \x01(\v2\x14.deadlock.CMsgVectorR\n" +
	"boundsMaxs\x123\n" +
	"\n" +
	"fan_origin\x18\x04 \x01(\v2\x14.deadlock.CMsgVectorR\tfanOrigin\x12@\n" +
	"\x11fan_origin_offset\x18\x05 \x01(\v2\x14.deadlock.CMsgVectorR\x0ffanOriginOffset\x129\n" +
	"\rfan_direction\x18\x06 \x01(\v2\x14.deadlock.CMsgVectorR\ffanDirection\x12\x14\n" +
	...
	"\x0ecurve_max_dist\x18\f \x01(\x02R\fcurveMaxDist\x1a\xe9\x02\n" +
	"\tUpdateFan\x12\x16\n" +
	"\x06active\x18\x01 \x01(\bR\x06active\x123\n" +
	"\n" +
	"fan_origin\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\tfanOrigin\x12@\n" +
	"\x11fan_origin_offset\x18\x03 \x01(\v2\x14.deadlock.CMsgVectorR\x0ffanOriginOffset\x129\n" +
	"\rfan_direction\x18\x04 \x01(\v2\x14.deadlock.CMsgVectorR\ffanDirection\x12$\n" +
	"\x0efan_ramp_ratio\x18\a \x01(\x02R\ffanRampRatio\x125\n" +
	"\vbounds_mins\x18\x05 \x01(\v2\x14.deadlock.CMsgVectorR\n" +
	"boundsMins\x125\n" +
	"\vbounds_maxs\x18\x06 \x01(\v2\x14.deadlock.CMsgVectorR\n" +
	"boundsMaxs\x1ad\n" +
	"\x18SetParticleClusterGrowth\x12\x1a\n" +
	"\bduration\x18\x01 \x01(\x02R\bduration\x12,\n" +
	"\x06origin\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\x06origin*\x05\bd\x10\xca\x01\".\n" +
	...
	"\x05util5\x18\x06 \x01(\x05R\x05util5\"\x9a\x04\n" +
	...
	"\bplatform\x18\b \x01(\x05R\bplatform\x12T\n" +
	"\vitemdetails\x18\t \x03(\v22.deadlock.CUserMessage_UtilMsg_Response.ItemDetailR\vitemdetails\x12\x1c\n" +
	"\titemgroup\x18\n" +
	...
	"\x04name\x18\x04 \x01(\tR\x04name\"\xd3\x04\n" +
	...
	"clientTime\x12O\n" +
	"\vdiagnostics\x18\a \x03(\v2-.deadlock.CUserMessage_DllStatus.CVDiagnosticR\vdiagnostics\x12B\n" +
	"\amodules\x18\b \x03(\v2(.deadlock.CUserMessage_DllStatus.CModuleR\amodules\x1as\n" +
	...
	"\aoptions\x18\x03 \x01(\x05R\aoptions\"\xfc\x06\n" +
	...
	"\vinventories\x18\t \x03(\v29.deadlock.CUserMessage_Inventory_Response.InventoryDetailR\vinventories\x12]\n" +
	"\finventories2\x18\n" +
	" \x03(\v29.deadlock.CUserMessage_Inventory_Response.InventoryDetailR\finventories2\x12]\n" +
	"\finventories3\x18\x0e \x03(\v29.deadlock.CUserMessage_Inventory_Response.InventoryDetailR\finventories3\x12\x19\n" +
	...
	"\tbase_hash\x18\n" +
	" \x01(\x05R\bbaseHash\"\xb0\x03\n" +
	"\x1dCUserMessageRequestDiagnostic\x12T\n" +
	"\vdiagnostics\x18\x01 \x03(\v22.deadlock.CUserMessageRequestDiagnostic.DiagnosticR\vdiagnostics\x1a\xb8\x02\n" +
	"\n" +
	"Diagnostic\x12\x14\n" +
	...
	"\acontext\x18\r \x01(\x05R\acontext\"\x80\x05\n" +
	" CUserMessage_Diagnostic_Response\x12W\n" +
	"\vdiagnostics\x18\x01 \x03(\v25.deadlock.CUserMessage_Diagnostic_Response.DiagnosticR\vdiagnostics\x12#\n" +
	...
	"\adetail2\x18\x05 \x03(\fR\adetail2\"\xab\x05\n" +
	...
	"\x10response_concept\x18\x04 \x01(\tR\x0fresponseConcept\x12O\n" +
	"\bcriteria\x18\x05 \x03(\v23.deadlock.CUserMessage_NotifyResponseFound.CriteriaR\bcriteria\x120\n" +
	...
	"\n" +
	"ent_origin\x18\x04 \x01(\v2\x14.deadlock.CMsgVectorR\tentOrigin\x12\x1b\n" +
	...
	"\x1bVR_HAND_HAPTIC_PULSE_STRONG\x10\x02B4Z2github.com/RyPort/paradox-parser/deadlock;deadlock"
...
var file_usermessages_proto_goTypes = []any{
	(EBaseUserMessages)(0),                                                              // 0: deadlock.EBaseUserMessages
	(EBaseEntityMessages)(0),                                                            // 1: deadlock.EBaseEntityMessages
	(ERollType)(0),                                                                      // 2: deadlock.eRollType
	(PARTICLE_MESSAGE)(0),                                                               // 3: deadlock.PARTICLE_MESSAGE
	(EHapticPulseType)(0),                                                               // 4: deadlock.EHapticPulseType
	(*CUserMessageAchievementEvent)(nil),                                                // 5: deadlock.CUserMessageAchievementEvent
	(*CUserMessageCloseCaption)(nil),                                                    // 6: deadlock.CUserMessageCloseCaption
	(*CUserMessageCloseCaptionDirect)(nil),                                              // 7: deadlock.CUserMessageCloseCaptionDirect
	(*CUserMessageCloseCaptionPlaceholder)(nil),                                         // 8: deadlock.CUserMessageCloseCaptionPlaceholder
	(*CUserMessageCurrentTimescale)(nil),                                                // 9: deadlock.CUserMessageCurrentTimescale
	(*CUserMessageDesiredTimescale)(nil),                                                // 10: deadlock.CUserMessageDesiredTimescale
	(*CUserMessageFade)(nil),                                                            // 11: deadlock.CUserMessageFade
	(*CUserMessageShake)(nil),                                                           // 12: deadlock.CUserMessageShake
	(*CUserMessageShakeDir)(nil),                                                        // 13: deadlock.CUserMessageShakeDir
	(*CUserMessageWaterShake)(nil),                                                      // 14: deadlock.CUserMessageWaterShake
	(*CUserMessageScreenTilt)(nil),                                                      // 15: deadlock.CUserMessageScreenTilt
	(*CUserMessageSayText)(nil),                                                         // 16: deadlock.CUserMessageSayText
	(*CUserMessageSayText2)(nil),                                                        // 17: deadlock.CUserMessageSayText2
	(*CUserMessageHudMsg)(nil),                                                          // 18: deadlock.CUserMessageHudMsg
	(*CUserMessageHudText)(nil),                                                         // 19: deadlock.CUserMessageHudText
	(*CUserMessageTextMsg)(nil),                                                         // 20: deadlock.CUserMessageTextMsg
	(*CUserMessageGameTitle)(nil),                                                       // 21: deadlock.CUserMessageGameTitle
	(*CUserMessageResetHUD)(nil),                                                        // 22: deadlock.CUserMessageResetHUD
	(*CUserMessageSendAudio)(nil),                                                       // 23: deadlock.CUserMessageSendAudio
	(*CUserMessageAudioParameter)(nil),                                                  // 24: deadlock.CUserMessageAudioParameter
	(*CUserMessageVoiceMask)(nil),                                                       // 25: deadlock.CUserMessageVoiceMask
	(*CUserMessageRequestState)(nil),                                                    // 26: deadlock.CUserMessageRequestState
	(*CUserMessageRumble)(nil),                                                          // 27: deadlock.CUserMessageRumble
	(*CUserMessageSayTextChannel)(nil),                                                  // 28: deadlock.CUserMessageSayTextChannel
	(*CUserMessageColoredText)(nil),                                                     // 29: deadlock.CUserMessageColoredText
	(*CUserMessageItemPickup)(nil),                                                      // 30: deadlock.CUserMessageItemPickup
	(*CUserMessageAmmoDenied)(nil),                                                      // 31: deadlock.CUserMessageAmmoDenied
	(*CUserMessageShowMenu)(nil),                                                        // 32: deadlock.CUserMessageShowMenu
	(*CUserMessageCreditsMsg)(nil),                                                      // 33: deadlock.CUserMessageCreditsMsg
	(*CEntityMessagePlayJingle)(nil),                                                    // 34: deadlock.CEntityMessagePlayJingle
	(*CEntityMessageScreenOverlay)(nil),                                                 // 35: deadlock.CEntityMessageScreenOverlay
	(*CEntityMessageRemoveAllDecals)(nil),                                               // 36: deadlock.CEntityMessageRemoveAllDecals
	(*CEntityMessagePropagateForce)(nil),                                                // 37: deadlock.CEntityMessagePropagateForce
	(*CEntityMessageDoSpark)(nil),                                                       // 38: deadlock.CEntityMessageDoSpark
	(*CEntityMessageFixAngle)(nil),                                                      // 39: deadlock.CEntityMessageFixAngle
	(*CUserMessageCameraTransition)(nil),                                                // 40: deadlock.CUserMessageCameraTransition
	(*CUserMsg_ParticleManager)(nil),                                                    // 41: deadlock.CUserMsg_ParticleManager
	(*CUserMsg_HudError)(nil),                                                           // 42: deadlock.CUserMsg_HudError
	(*CUserMsg_CustomGameEvent)(nil),                                                    // 43: deadlock.CUserMsg_CustomGameEvent
	(*CUserMessageHapticsManagerPulse)(nil),                                             // 44: deadlock.CUserMessageHapticsManagerPulse
	(*CUserMessageHapticsManagerEffect)(nil),                                            // 45: deadlock.CUserMessageHapticsManagerEffect
	(*CUserMessageAnimStateGraphState)(nil),                                             // 46: deadlock.CUserMessageAnimStateGraphState
	(*CUserMessageUpdateCssClasses)(nil),                                                // 47: deadlock.CUserMessageUpdateCssClasses
	(*CUserMessageServerFrameTime)(nil),                                                 // 48: deadlock.CUserMessageServerFrameTime
	(*CUserMessageLagCompensationError)(nil),                                            // 49: deadlock.CUserMessageLagCompensationError
	(*CUserMessageRequestDllStatus)(nil),                                                // 50: deadlock.CUserMessageRequestDllStatus
	(*CUserMessageRequestUtilAction)(nil),                                               // 51: deadlock.CUserMessageRequestUtilAction
	(*CUserMessage_UtilMsg_Response)(nil),                                               // 52: deadlock.CUserMessage_UtilMsg_Response
	(*CUserMessage_DllStatus)(nil),                                                      // 53: deadlock.CUserMessage_DllStatus
	(*CUserMessageRequestInventory)(nil),                                                // 54: deadlock.CUserMessageRequestInventory
	(*CUserMessage_Inventory_Response)(nil),                                             // 55: deadlock.CUserMessage_Inventory_Response
	(*CUserMessageRequestDiagnostic)(nil),                                               // 56: deadlock.CUserMessageRequestDiagnostic
	(*CUserMessage_Diagnostic_Response)(nil),                                            // 57: deadlock.CUserMessage_Diagnostic_Response
	(*CUserMessage_ExtraUserData)(nil),                                                  // 58: deadlock.CUserMessage_ExtraUserData
	(*CUserMessage_NotifyResponseFound)(nil),                                            // 59: deadlock.CUserMessage_NotifyResponseFound
	(*CUserMessage_PlayResponseConditional)(nil),                                        // 60: deadlock.CUserMessage_PlayResponseConditional
	(*CUserMessageCameraTransition_Transition_DataDriven)(nil),                          // 61: deadlock.CUserMessageCameraTransition.Transition_DataDriven
	(*CUserMsg_ParticleManager_ReleaseParticleIndex)(nil),                               // 62: deadlock.CUserMsg_ParticleManager.ReleaseParticleIndex
	(*CUserMsg_ParticleManager_CreateParticle)(nil),                                     // 63: deadlock.CUserMsg_ParticleManager.CreateParticle
	(*CUserMsg_ParticleManager_DestroyParticle)(nil),                                    // 64: deadlock.CUserMsg_ParticleManager.DestroyParticle
	(*CUserMsg_ParticleManager_DestroyParticleInvolving)(nil),                           // 65: deadlock.CUserMsg_ParticleManager.DestroyParticleInvolving
	(*CUserMsg_ParticleManager_DestroyParticleNamed)(nil),                               // 66: deadlock.CUserMsg_ParticleManager.DestroyParticleNamed
	(*CUserMsg_ParticleManager_UpdateParticle_OBSOLETE)(nil),                            // 67: deadlock.CUserMsg_ParticleManager.UpdateParticle_OBSOLETE
	(*CUserMsg_ParticleManager_UpdateParticleFwd_OBSOLETE)(nil),                         // 68: deadlock.CUserMsg_ParticleManager.UpdateParticleFwd_OBSOLETE
	(*CUserMsg_ParticleManager_UpdateParticleOrient_OBSOLETE)(nil),                      // 69: deadlock.CUserMsg_ParticleManager.UpdateParticleOrient_OBSOLETE
	(*CUserMsg_ParticleManager_UpdateParticleTransform)(nil),                            // 70: deadlock.CUserMsg_ParticleManager.UpdateParticleTransform
	(*CUserMsg_ParticleManager_UpdateParticleFallback)(nil),                             // 71: deadlock.CUserMsg_ParticleManager.UpdateParticleFallback
	(*CUserMsg_ParticleManager_UpdateParticleOffset)(nil),                               // 72: deadlock.CUserMsg_ParticleManager.UpdateParticleOffset
	(*CUserMsg_ParticleManager_UpdateParticleEnt)(nil),                                  // 73: deadlock.CUserMsg_ParticleManager.UpdateParticleEnt
	(*CUserMsg_ParticleManager_UpdateParticleSetFrozen)(nil),                            // 74: deadlock.CUserMsg_ParticleManager.UpdateParticleSetFrozen
	(*CUserMsg_ParticleManager_UpdateParticleShouldDraw)(nil),                           // 75: deadlock.CUserMsg_ParticleManager.UpdateParticleShouldDraw
	(*CUserMsg_ParticleManager_ChangeControlPointAttachment)(nil),                       // 76: deadlock.CUserMsg_ParticleManager.ChangeControlPointAttachment
	(*CUserMsg_ParticleManager_UpdateEntityPosition)(nil),                               // 77: deadlock.CUserMsg_ParticleManager.UpdateEntityPosition
	(*CUserMsg_ParticleManager_SetParticleFoWProperties)(nil),                           // 78: deadlock.CUserMsg_ParticleManager.SetParticleFoWProperties
	(*CUserMsg_ParticleManager_SetParticleShouldCheckFoW)(nil),                          // 79: deadlock.CUserMsg_ParticleManager.SetParticleShouldCheckFoW
	(*CUserMsg_ParticleManager_SetControlPointModel)(nil),                               // 80: deadlock.CUserMsg_ParticleManager.SetControlPointModel
	(*CUserMsg_ParticleManager_SetControlPointSnapshot)(nil),                            // 81: deadlock.CUserMsg_ParticleManager.SetControlPointSnapshot
	(*CUserMsg_ParticleManager_SetParticleText)(nil),                                    // 82: deadlock.CUserMsg_ParticleManager.SetParticleText
	(*CUserMsg_ParticleManager_SetTextureAttribute)(nil),                                // 83: deadlock.CUserMsg_ParticleManager.SetTextureAttribute
	(*CUserMsg_ParticleManager_SetSceneObjectGenericFlag)(nil),                          // 84: deadlock.CUserMsg_ParticleManager.SetSceneObjectGenericFlag
	(*CUserMsg_ParticleManager_SetSceneObjectTintAndDesat)(nil),                         // 85: deadlock.CUserMsg_ParticleManager.SetSceneObjectTintAndDesat
	(*CUserMsg_ParticleManager_ParticleSkipToTime)(nil),                                 // 86: deadlock.CUserMsg_ParticleManager.ParticleSkipToTime
	(*CUserMsg_ParticleManager_ParticleCanFreeze)(nil),                                  // 87: deadlock.CUserMsg_ParticleManager.ParticleCanFreeze
	(*CUserMsg_ParticleManager_ParticleFreezeTransitionOverride)(nil),                   // 88: deadlock.CUserMsg_ParticleManager.ParticleFreezeTransitionOverride
	(*CUserMsg_ParticleManager_FreezeParticleInvolving)(nil),                            // 89: deadlock.CUserMsg_ParticleManager.FreezeParticleInvolving
	(*CUserMsg_ParticleManager_AddModellistOverrideElement)(nil),                        // 90: deadlock.CUserMsg_ParticleManager.AddModellistOverrideElement
	(*CUserMsg_ParticleManager_ClearModellistOverride)(nil),                             // 91: deadlock.CUserMsg_ParticleManager.ClearModellistOverride
	(*CUserMsg_ParticleManager_SetParticleNamedValueContext)(nil),                       // 92: deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext
	(*CUserMsg_ParticleManager_CreatePhysicsSim)(nil),                                   // 93: deadlock.CUserMsg_ParticleManager.CreatePhysicsSim
	(*CUserMsg_ParticleManager_DestroyPhysicsSim)(nil),                                  // 94: deadlock.CUserMsg_ParticleManager.DestroyPhysicsSim
	(*CUserMsg_ParticleManager_SetVData)(nil),                                           // 95: deadlock.CUserMsg_ParticleManager.SetVData
	(*CUserMsg_ParticleManager_SetMaterialOverride)(nil),                                // 96: deadlock.CUserMsg_ParticleManager.SetMaterialOverride
	(*CUserMsg_ParticleManager_AddFan)(nil),                                             // 97: deadlock.CUserMsg_ParticleManager.AddFan
	(*CUserMsg_ParticleManager_UpdateFan)(nil),                                          // 98: deadlock.CUserMsg_ParticleManager.UpdateFan
	(*CUserMsg_ParticleManager_SetParticleClusterGrowth)(nil),                           // 99: deadlock.CUserMsg_ParticleManager.SetParticleClusterGrowth
	(*CUserMsg_ParticleManager_SetParticleNamedValueContext_FloatContextValue)(nil),     // 100: deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.FloatContextValue
	(*CUserMsg_ParticleManager_SetParticleNamedValueContext_VectorContextValue)(nil),    // 101: deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.VectorContextValue
	(*CUserMsg_ParticleManager_SetParticleNamedValueContext_TransformContextValue)(nil), // 102: deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.TransformContextValue
	(*CUserMsg_ParticleManager_SetParticleNamedValueContext_EHandleContext)(nil),        // 103: deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.EHandleContext
	(*CUserMessage_UtilMsg_Response_ItemDetail)(nil),                                    // 104: deadlock.CUserMessage_UtilMsg_Response.ItemDetail
	(*CUserMessage_DllStatus_CVDiagnostic)(nil),                                         // 105: deadlock.CUserMessage_DllStatus.CVDiagnostic
	(*CUserMessage_DllStatus_CModule)(nil),                                              // 106: deadlock.CUserMessage_DllStatus.CModule
	(*CUserMessage_Inventory_Response_InventoryDetail)(nil),                             // 107: deadlock.CUserMessage_Inventory_Response.InventoryDetail
	(*CUserMessageRequestDiagnostic_Diagnostic)(nil),                                    // 108: deadlock.CUserMessageRequestDiagnostic.Diagnostic
	(*CUserMessage_Diagnostic_Response_Diagnostic)(nil),                                 // 109: deadlock.CUserMessage_Diagnostic_Response.Diagnostic
	(*CUserMessage_NotifyResponseFound_Criteria)(nil),                                   // 110: deadlock.CUserMessage_NotifyResponseFound.Criteria
	(*CMsgVector)(nil),                                                                  // 111: deadlock.CMsgVector
	(*CEntityMsg)(nil),                                                                  // 112: deadlock.CEntityMsg
	(*CMsgQAngle)(nil),                                                                  // 113: deadlock.CMsgQAngle
	(*CMsgQuaternion)(nil),                                                              // 114: deadlock.CMsgQuaternion
}
var file_usermessages_proto_depIdxs = []int32{
	12,  // 0: deadlock.CUserMessageShakeDir.shake:type_name -> deadlock.CUserMessageShake
	111, // 1: deadlock.CUserMessageShakeDir.direction:type_name -> deadlock.CMsgVector
	111, // 2: deadlock.CUserMessageScreenTilt.angle:type_name -> deadlock.CMsgVector
	2,   // 3: deadlock.CUserMessageCreditsMsg.rolltype:type_name -> deadlock.eRollType
	112, // 4: deadlock.CEntityMessagePlayJingle.entity_msg:type_name -> deadlock.CEntityMsg
	112, // 5: deadlock.CEntityMessageScreenOverlay.entity_msg:type_name -> deadlock.CEntityMsg
	112, // 6: deadlock.CEntityMessageRemoveAllDecals.entity_msg:type_name -> deadlock.CEntityMsg
	111, // 7: deadlock.CEntityMessagePropagateForce.impulse:type_name -> deadlock.CMsgVector
	112, // 8: deadlock.CEntityMessagePropagateForce.entity_msg:type_name -> deadlock.CEntityMsg
	111, // 9: deadlock.CEntityMessageDoSpark.origin:type_name -> deadlock.CMsgVector
	112, // 10: deadlock.CEntityMessageDoSpark.entity_msg:type_name -> deadlock.CEntityMsg
	113, // 11: deadlock.CEntityMessageFixAngle.angle:type_name -> deadlock.CMsgQAngle
	112, // 12: deadlock.CEntityMessageFixAngle.entity_msg:type_name -> deadlock.CEntityMsg
	61,  // 13: deadlock.CUserMessageCameraTransition.params_data_driven:type_name -> deadlock.CUserMessageCameraTransition.Transition_DataDriven
	3,   // 14: deadlock.CUserMsg_ParticleManager.type:type_name -> deadlock.PARTICLE_MESSAGE
	62,  // 15: deadlock.CUserMsg_ParticleManager.release_particle_index:type_name -> deadlock.CUserMsg_ParticleManager.ReleaseParticleIndex
	63,  // 16: deadlock.CUserMsg_ParticleManager.create_particle:type_name -> deadlock.CUserMsg_ParticleManager.CreateParticle
	64,  // 17: deadlock.CUserMsg_ParticleManager.destroy_particle:type_name -> deadlock.CUserMsg_ParticleManager.DestroyParticle
	65,  // 18: deadlock.CUserMsg_ParticleManager.destroy_particle_involving:type_name -> deadlock.CUserMsg_ParticleManager.DestroyParticleInvolving
	67,  // 19: deadlock.CUserMsg_ParticleManager.update_particle:type_name -> deadlock.CUserMsg_ParticleManager.UpdateParticle_OBSOLETE
	68,  // 20: deadlock.CUserMsg_ParticleManager.update_particle_fwd:type_name -> deadlock.CUserMsg_ParticleManager.UpdateParticleFwd_OBSOLETE
	69,  // 21: deadlock.CUserMsg_ParticleManager.update_particle_orient:type_name -> deadlock.CUserMsg_ParticleManager.UpdateParticleOrient_OBSOLETE
	71,  // 22: deadlock.CUserMsg_ParticleManager.update_particle_fallback:type_name -> deadlock.CUserMsg_ParticleManager.UpdateParticleFallback
	72,  // 23: deadlock.CUserMsg_ParticleManager.update_particle_offset:type_name -> deadlock.CUserMsg_ParticleManager.UpdateParticleOffset
	73,  // 24: deadlock.CUserMsg_ParticleManager.update_particle_ent:type_name -> deadlock.CUserMsg_ParticleManager.UpdateParticleEnt
	75,  // 25: deadlock.CUserMsg_ParticleManager.update_particle_should_draw:type_name -> deadlock.CUserMsg_ParticleManager.UpdateParticleShouldDraw
	74,  // 26: deadlock.CUserMsg_ParticleManager.update_particle_set_frozen:type_name -> deadlock.CUserMsg_ParticleManager.UpdateParticleSetFrozen
	76,  // 27: deadlock.CUserMsg_ParticleManager.change_control_point_attachment:type_name -> deadlock.CUserMsg_ParticleManager.ChangeControlPointAttachment
	77,  // 28: deadlock.CUserMsg_ParticleManager.update_entity_position:type_name -> deadlock.CUserMsg_ParticleManager.UpdateEntityPosition
	78,  // 29: deadlock.CUserMsg_ParticleManager.set_particle_fow_properties:type_name -> deadlock.CUserMsg_ParticleManager.SetParticleFoWProperties
	82,  // 30: deadlock.CUserMsg_ParticleManager.set_particle_text:type_name -> deadlock.CUserMsg_ParticleManager.SetParticleText
	79,  // 31: deadlock.CUserMsg_ParticleManager.set_particle_should_check_fow:type_name -> deadlock.CUserMsg_ParticleManager.SetParticleShouldCheckFoW
	80,  // 32: deadlock.CUserMsg_ParticleManager.set_control_point_model:type_name -> deadlock.CUserMsg_ParticleManager.SetControlPointModel
	81,  // 33: deadlock.CUserMsg_ParticleManager.set_control_point_snapshot:type_name -> deadlock.CUserMsg_ParticleManager.SetControlPointSnapshot
	83,  // 34: deadlock.CUserMsg_ParticleManager.set_texture_attribute:type_name -> deadlock.CUserMsg_ParticleManager.SetTextureAttribute
	84,  // 35: deadlock.CUserMsg_ParticleManager.set_scene_object_generic_flag:type_name -> deadlock.CUserMsg_ParticleManager.SetSceneObjectGenericFlag
	85,  // 36: deadlock.CUserMsg_ParticleManager.set_scene_object_tint_and_desat:type_name -> deadlock.CUserMsg_ParticleManager.SetSceneObjectTintAndDesat
	66,  // 37: deadlock.CUserMsg_ParticleManager.destroy_particle_named:type_name -> deadlock.CUserMsg_ParticleManager.DestroyParticleNamed
	86,  // 38: deadlock.CUserMsg_ParticleManager.particle_skip_to_time:type_name -> deadlock.CUserMsg_ParticleManager.ParticleSkipToTime
	87,  // 39: deadlock.CUserMsg_ParticleManager.particle_can_freeze:type_name -> deadlock.CUserMsg_ParticleManager.ParticleCanFreeze
	92,  // 40: deadlock.CUserMsg_ParticleManager.set_named_value_context:type_name -> deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext
	70,  // 41: deadlock.CUserMsg_ParticleManager.update_particle_transform:type_name -> deadlock.CUserMsg_ParticleManager.UpdateParticleTransform
	88,  // 42: deadlock.CUserMsg_ParticleManager.particle_freeze_transition_override:type_name -> deadlock.CUserMsg_ParticleManager.ParticleFreezeTransitionOverride
	89,  // 43: deadlock.CUserMsg_ParticleManager.freeze_particle_involving:type_name -> deadlock.CUserMsg_ParticleManager.FreezeParticleInvolving
	90,  // 44: deadlock.CUserMsg_ParticleManager.add_modellist_override_element:type_name -> deadlock.CUserMsg_ParticleManager.AddModellistOverrideElement
	91,  // 45: deadlock.CUserMsg_ParticleManager.clear_modellist_override:type_name -> deadlock.CUserMsg_ParticleManager.ClearModellistOverride
	93,  // 46: deadlock.CUserMsg_ParticleManager.create_physics_sim:type_name -> deadlock.CUserMsg_ParticleManager.CreatePhysicsSim
	94,  // 47: deadlock.CUserMsg_ParticleManager.destroy_physics_sim:type_name -> deadlock.CUserMsg_ParticleManager.DestroyPhysicsSim
	95,  // 48: deadlock.CUserMsg_ParticleManager.set_vdata:type_name -> deadlock.CUserMsg_ParticleManager.SetVData
	96,  // 49: deadlock.CUserMsg_ParticleManager.set_material_override:type_name -> deadlock.CUserMsg_ParticleManager.SetMaterialOverride
	97,  // 50: deadlock.CUserMsg_ParticleManager.add_fan:type_name -> deadlock.CUserMsg_ParticleManager.AddFan
	98,  // 51: deadlock.CUserMsg_ParticleManager.update_fan:type_name -> deadlock.CUserMsg_ParticleManager.UpdateFan
	99,  // 52: deadlock.CUserMsg_ParticleManager.set_particle_cluster_growth:type_name -> deadlock.CUserMsg_ParticleManager.SetParticleClusterGrowth
	104, // 53: deadlock.CUserMessage_UtilMsg_Response.itemdetails:type_name -> deadlock.CUserMessage_UtilMsg_Response.ItemDetail
	105, // 54: deadlock.CUserMessage_DllStatus.diagnostics:type_name -> deadlock.CUserMessage_DllStatus.CVDiagnostic
	106, // 55: deadlock.CUserMessage_DllStatus.modules:type_name -> deadlock.CUserMessage_DllStatus.CModule
	107, // 56: deadlock.CUserMessage_Inventory_Response.inventories:type_name -> deadlock.CUserMessage_Inventory_Response.InventoryDetail
	107, // 57: deadlock.CUserMessage_Inventory_Response.inventories2:type_name -> deadlock.CUserMessage_Inventory_Response.InventoryDetail
	107, // 58: deadlock.CUserMessage_Inventory_Response.inventories3:type_name -> deadlock.CUserMessage_Inventory_Response.InventoryDetail
	108, // 59: deadlock.CUserMessageRequestDiagnostic.diagnostics:type_name -> deadlock.CUserMessageRequestDiagnostic.Diagnostic
	109, // 60: deadlock.CUserMessage_Diagnostic_Response.diagnostics:type_name -> deadlock.CUserMessage_Diagnostic_Response.Diagnostic
	110, // 61: deadlock.CUserMessage_NotifyResponseFound.criteria:type_name -> deadlock.CUserMessage_NotifyResponseFound.Criteria
	111, // 62: deadlock.CUserMessage_PlayResponseConditional.ent_origin:type_name -> deadlock.CMsgVector
	111, // 63: deadlock.CUserMsg_ParticleManager.CreateParticle.aggregation_position:type_name -> deadlock.CMsgVector
	111, // 64: deadlock.CUserMsg_ParticleManager.UpdateParticle_OBSOLETE.position:type_name -> deadlock.CMsgVector
	111, // 65: deadlock.CUserMsg_ParticleManager.UpdateParticleFwd_OBSOLETE.forward:type_name -> deadlock.CMsgVector
	111, // 66: deadlock.CUserMsg_ParticleManager.UpdateParticleOrient_OBSOLETE.forward:type_name -> deadlock.CMsgVector
	111, // 67: deadlock.CUserMsg_ParticleManager.UpdateParticleOrient_OBSOLETE.deprecated_right:type_name -> deadlock.CMsgVector
	111, // 68: deadlock.CUserMsg_ParticleManager.UpdateParticleOrient_OBSOLETE.up:type_name -> deadlock.CMsgVector
	111, // 69: deadlock.CUserMsg_ParticleManager.UpdateParticleOrient_OBSOLETE.left:type_name -> deadlock.CMsgVector
	111, // 70: deadlock.CUserMsg_ParticleManager.UpdateParticleTransform.position:type_name -> deadlock.CMsgVector
	114, // 71: deadlock.CUserMsg_ParticleManager.UpdateParticleTransform.orientation:type_name -> deadlock.CMsgQuaternion
	111, // 72: deadlock.CUserMsg_ParticleManager.UpdateParticleFallback.position:type_name -> deadlock.CMsgVector
	111, // 73: deadlock.CUserMsg_ParticleManager.UpdateParticleOffset.origin_offset:type_name -> deadlock.CMsgVector
	113, // 74: deadlock.CUserMsg_ParticleManager.UpdateParticleOffset.angle_offset:type_name -> deadlock.CMsgQAngle
	111, // 75: deadlock.CUserMsg_ParticleManager.UpdateParticleEnt.fallback_position:type_name -> deadlock.CMsgVector
	111, // 76: deadlock.CUserMsg_ParticleManager.UpdateParticleEnt.offset_position:type_name -> deadlock.CMsgVector
	113, // 77: deadlock.CUserMsg_ParticleManager.UpdateParticleEnt.offset_angles:type_name -> deadlock.CMsgQAngle
	111, // 78: deadlock.CUserMsg_ParticleManager.UpdateEntityPosition.position:type_name -> deadlock.CMsgVector
	100, // 79: deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.float_values:type_name -> deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.FloatContextValue
	101, // 80: deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.vector_values:type_name -> deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.VectorContextValue
	102, // 81: deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.transform_values:type_name -> deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.TransformContextValue
	103, // 82: deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.ehandle_values:type_name -> deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.EHandleContext
	111, // 83: deadlock.CUserMsg_ParticleManager.AddFan.bounds_mins:type_name -> deadlock.CMsgVector
	111, // 84: deadlock.CUserMsg_ParticleManager.AddFan.bounds_maxs:type_name -> deadlock.CMsgVector
	111, // 85: deadlock.CUserMsg_ParticleManager.AddFan.fan_origin:type_name -> deadlock.CMsgVector
	111, // 86: deadlock.CUserMsg_ParticleManager.AddFan.fan_origin_offset:type_name -> deadlock.CMsgVector
	111, // 87: deadlock.CUserMsg_ParticleManager.AddFan.fan_direction:type_name -> deadlock.CMsgVector
	111, // 88: deadlock.CUserMsg_ParticleManager.UpdateFan.fan_origin:type_name -> deadlock.CMsgVector
	111, // 89: deadlock.CUserMsg_ParticleManager.UpdateFan.fan_origin_offset:type_name -> deadlock.CMsgVector
	111, // 90: deadlock.CUserMsg_ParticleManager.UpdateFan.fan_direction:type_name -> deadlock.CMsgVector
	111, // 91: deadlock.CUserMsg_ParticleManager.UpdateFan.bounds_mins:type_name -> deadlock.CMsgVector
	111, // 92: deadlock.CUserMsg_ParticleManager.UpdateFan.bounds_maxs:type_name -> deadlock.CMsgVector
	111, // 93: deadlock.CUserMsg_ParticleManager.SetParticleClusterGrowth.origin:type_name -> deadlock.CMsgVector
	111, // 94: deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.VectorContextValue.value:type_name -> deadlock.CMsgVector
	113, // 95: deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.TransformContextValue.angles:type_name -> deadlock.CMsgQAngle
	111, // 96: deadlock.CUserMsg_ParticleManager.SetParticleNamedValueContext.TransformContextValue.translation:type_name -> deadlock.CMsgVector
