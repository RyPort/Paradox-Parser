...
const file_demo_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"demo.proto\x12\bdeadlock\"\xe0\x04\n" +
	...
	"\x11server_start_tick\x18\x0f \x01(\x05R\x0fserverStartTick\"\x90\a\n" +
	"\tCGameInfo\x125\n" +
	"\x04dota\x18\x04 \x01(\v2!.deadlock.CGameInfo.CDotaGameInfoR\x04dota\x12/\n" +
	"\x02cs\x18\x05 \x01(\v2\x1f.deadlock.CGameInfo.CCSGameInfoR\x02cs\x1a\xdf\x05\n" +
	...
	"gameWinner\x12N\n" +
	"\vplayer_info\x18\x04 \x03(\v2-.deadlock.CGameInfo.CDotaGameInfo.CPlayerInfoR\n" +
	"playerInfo\x12\x1a\n" +
	"\bleagueid\x18\x05 \x01(\rR\bleagueid\x12Q\n" +
	"\n" +
	"picks_bans\x18\x06 \x03(\v22.deadlock.CGameInfo.CDotaGameInfo.CHeroSelectEventR\tpicksBans\x12&\n" +
	...
	"\vCCSGameInfo\x12*\n" +
	"\x11round_start_ticks\x18\x01 \x03(\x05R\x0froundStartTicks\"\xb6\x01\n" +
	"\rCDemoFileInfo\x12#\n" +
	"\rplayback_time\x18\x01 \x01(\x02R\fplaybackTime\x12%\n" +
	"\x0eplayback_ticks\x18\x02 \x01(\x05R\rplaybackTicks\x12'\n" +
	"\x0fplayback_frames\x18\x03 \x01(\x05R\x0eplaybackFrames\x120\n" +
	"\tgame_info\x18\x04 \x01(\v2\x13.deadlock.CGameInfoR\bgameInfo\"!\n" +
	"\vCDemoPacket\x12\x12\n" +
	"\x04data\x18\x03 \x01(\fR\x04data\"\x80\x01\n" +
	"\x0fCDemoFullPacket\x12>\n" +
	"\fstring_table\x18\x01 \x01(\v2\x1b.deadlock.CDemoStringTablesR\vstringTable\x12-\n" +
	"\x06packet\x18\x02 \x01(\v2\x15.deadlock.CDemoPacketR\x06packet\"v\n" +
	...
	"\aclasses\x18\x01 \x03(\v2 .deadlock.CDemoClassInfo.class_tR\aclasses\x1af\n" +
	"\aclass_t\x12\x19\n" +
	...
	"\rdata_checksum\x18\x05 \x01(\x03R\fdataChecksum\"\xd8\x02\n" +
	"\x11CDemoStringTables\x12;\n" +
	"\x06tables\x18\x01 \x03(\v2#.deadlock.CDemoStringTables.table_tR\x06tables\x1a/\n" +
	"\aitems_t\x12\x10\n" +
	"\x03str\x18\x01 \x01(\tR\x03str\x12\x12\n" +
	"\x04data\x18\x02 \x01(\fR\x04data\x1a\xd4\x01\n" +
	"\atable_t\x12\x1d\n" +
	"\n" +
	"table_name\x18\x01 \x01(\tR\ttableName\x129\n" +
	"\x05items\x18\x02 \x03(\v2#.deadlock.CDemoStringTables.items_tR\x05items\x12N\n" +
	"\x10items_clientside\x18\x03 \x03(\v2#.deadlock.CDemoStringTables.items_tR\x0fitemsClientside\x12\x1f\n" +
	...
	"\x04msgs\x18\x03 \x03(\fR\x04msgs\"\x8e\x02\n" +
	"\rCDemoRecovery\x12b\n" +
	"\x13initial_spawn_group\x18\x01 \x01(\v22.deadlock.CDemoRecovery.DemoInitialSpawnGroupEntryR\x11initialSpawnGroup\x12.\n" +
	...
	"\x10DEM_IsCompressed\x10@B4Z2github.com/RyPort/paradox-parser/deadlock;deadlock"
...
var file_demo_proto_goTypes = []any{
	(EDemoCommands)(0),                               // 0: deadlock.EDemoCommands
	(*CDemoFileHeader)(nil),                          // 1: deadlock.CDemoFileHeader
	(*CGameInfo)(nil),                                // 2: deadlock.CGameInfo
	(*CDemoFileInfo)(nil),                            // 3: deadlock.CDemoFileInfo
	(*CDemoPacket)(nil),                              // 4: deadlock.CDemoPacket
	(*CDemoFullPacket)(nil),                          // 5: deadlock.CDemoFullPacket
	(*CDemoSaveGame)(nil),                            // 6: deadlock.CDemoSaveGame
	(*CDemoSyncTick)(nil),                            // 7: deadlock.CDemoSyncTick
	(*CDemoConsoleCmd)(nil),                          // 8: deadlock.CDemoConsoleCmd
	(*CDemoSendTables)(nil),                          // 9: deadlock.CDemoSendTables
	(*CDemoClassInfo)(nil),                           // 10: deadlock.CDemoClassInfo
	(*CDemoCustomData)(nil),                          // 11: deadlock.CDemoCustomData
	(*CDemoCustomDataCallbacks)(nil),                 // 12: deadlock.CDemoCustomDataCallbacks
	(*CDemoAnimationHeader)(nil),                     // 13: deadlock.CDemoAnimationHeader
	(*CDemoAnimationData)(nil),                       // 14: deadlock.CDemoAnimationData
	(*CDemoStringTables)(nil),                        // 15: deadlock.CDemoStringTables
	(*CDemoStop)(nil),                                // 16: deadlock.CDemoStop
	(*CDemoUserCmd)(nil),                             // 17: deadlock.CDemoUserCmd
	(*CDemoSpawnGroups)(nil),                         // 18: deadlock.CDemoSpawnGroups
	(*CDemoRecovery)(nil),                            // 19: deadlock.CDemoRecovery
	(*CGameInfo_CDotaGameInfo)(nil),                  // 20: deadlock.CGameInfo.CDotaGameInfo
	(*CGameInfo_CCSGameInfo)(nil),                    // 21: deadlock.CGameInfo.CCSGameInfo
	(*CGameInfo_CDotaGameInfo_CPlayerInfo)(nil),      // 22: deadlock.CGameInfo.CDotaGameInfo.CPlayerInfo
	(*CGameInfo_CDotaGameInfo_CHeroSelectEvent)(nil), // 23: deadlock.CGameInfo.CDotaGameInfo.CHeroSelectEvent
	(*CDemoClassInfoClassT)(nil),                     // 24: deadlock.CDemoClassInfo.class_t
	(*CDemoStringTablesItemsT)(nil),                  // 25: deadlock.CDemoStringTables.items_t
	(*CDemoStringTablesTableT)(nil),                  // 26: deadlock.CDemoStringTables.table_t
	(*CDemoRecovery_DemoInitialSpawnGroupEntry)(nil), // 27: deadlock.CDemoRecovery.DemoInitialSpawnGroupEntry
}
var file_demo_proto_depIdxs = []int32{
	20, // 0: deadlock.CGameInfo.dota:type_name -> deadlock.CGameInfo.CDotaGameInfo
	21, // 1: deadlock.CGameInfo.cs:type_name -> deadlock.CGameInfo.CCSGameInfo
	2,  // 2: deadlock.CDemoFileInfo.game_info:type_name -> deadlock.CGameInfo
	15, // 3: deadlock.CDemoFullPacket.string_table:type_name -> deadlock.CDemoStringTables
	4,  // 4: deadlock.CDemoFullPacket.packet:type_name -> deadlock.CDemoPacket
	24, // 5: deadlock.CDemoClassInfo.classes:type_name -> deadlock.CDemoClassInfo.class_t
	26, // 6: deadlock.CDemoStringTables.tables:type_name -> deadlock.CDemoStringTables.table_t
	27, // 7: deadlock.CDemoRecovery.initial_spawn_group:type_name -> deadlock.CDemoRecovery.DemoInitialSpawnGroupEntry
	22, // 8: deadlock.CGameInfo.CDotaGameInfo.player_info:type_name -> deadlock.CGameInfo.CDotaGameInfo.CPlayerInfo
	23, // 9: deadlock.CGameInfo.CDotaGameInfo.picks_bans:type_name -> deadlock.CGameInfo.CDotaGameInfo.CHeroSelectEvent
	25, // 10: deadlock.CDemoStringTables.table_t.items:type_name -> deadlock.CDemoStringTables.items_t
	25, // 11: deadlock.CDemoStringTables.table_t.items_clientside:type_name -> deadlock.CDemoStringTables.items_t
