...
const file_econ_shared_enums_proto_rawDesc = "" +
	"\n" +
	"\x17econ_shared_enums.proto\x12\bdeadlock\"U\n" +
	...
	"+k_EGCMsgUseItemResponse_ItemUsed_Compendium\x10\rB4Z2github.com/RyPort/paradox-parser/deadlock;deadlock"
...
var file_econ_shared_enums_proto_goTypes = []any{
	(EGCEconBaseMsg)(0),        // 0: deadlock.EGCEconBaseMsg
	(EGCMsgResponse)(0),        // 1: deadlock.EGCMsgResponse
	(EGCMsgUseItemResponse)(0), // 2: deadlock.EGCMsgUseItemResponse
	(*CMsgGenericResult)(nil),  // 3: deadlock.CMsgGenericResult
}
