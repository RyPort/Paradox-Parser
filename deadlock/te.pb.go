...
const file_te_proto_rawDesc = "" +
	"\n" +
	"\bte.proto\x12\bdeadlock\x1a\x16networkbasetypes.proto\"e\n" +
	"\x13CMsgTEArmorRicochet\x12&\n" +
	"\x03pos\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\x03pos\x12&\n" +
	"\x03dir\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\x03dir\"\xd2\x02\n" +
	...
	"\x05flags\x18\f \x01(\rR\x05flags\"\xd6\x01\n" +
	"\x12CMsgTEBeamEntPoint\x12,\n" +
	"\x04base\x18\x01 \x01(\v2\x18.deadlock.CMsgTEBaseBeamR\x04base\x12 \n" +
	"\vstartentity\x18\x02 \x01(\rR\vstartentity\x12\x1c\n" +
	"\tendentity\x18\x03 \x01(\rR\tendentity\x12*\n" +
	"\x05start\x18\x04 \x01(\v2\x14.deadlock.CMsgVectorR\x05start\x12&\n" +
	"\x03end\x18\x05 \x01(\v2\x14.deadlock.CMsgVectorR\x03end\"~\n" +
	"\x0eCMsgTEBeamEnts\x12,\n" +
	"\x04base\x18\x01 \x01(\v2\x18.deadlock.CMsgTEBaseBeamR\x04base\x12 \n" +
	"\vstartentity\x18\x02 \x01(\rR\vstartentity\x12\x1c\n" +
	"\tendentity\x18\x03 \x01(\rR\tendentity\"\x94\x01\n" +
	"\x10CMsgTEBeamPoints\x12,\n" +
	"\x04base\x18\x01 \x01(\v2\x18.deadlock.CMsgTEBaseBeamR\x04base\x12*\n" +
	"\x05start\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\x05start\x12&\n" +
	"\x03end\x18\x03 \x01(\v2\x14.deadlock.CMsgVectorR\x03end\"~\n" +
	"\x0eCMsgTEBeamRing\x12,\n" +
	"\x04base\x18\x01 \x01(\v2\x18.deadlock.CMsgTEBaseBeamR\x04base\x12 \n" +
	"\vstartentity\x18\x02 \x01(\rR\vstartentity\x12\x1c\n" +
	"\tendentity\x18\x03 \x01(\rR\tendentity\"\xa7\x01\n" +
	"\rCMsgTEBubbles\x12(\n" +
	"\x04mins\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\x04mins\x12(\n" +
	"\x04maxs\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\x04maxs\x12\x16\n" +
	"\x06height\x18\x03 \x01(\x02R\x06height\x12\x14\n" +
	"\x05count\x18\x04 \x01(\rR\x05count\x12\x14\n" +
	"\x05speed\x18\x05 \x01(\x02R\x05speed\"\xab\x01\n" +
	"\x11CMsgTEBubbleTrail\x12(\n" +
	"\x04mins\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\x04mins\x12(\n" +
	"\x04maxs\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\x04maxs\x12\x16\n" +
	"\x06waterz\x18\x03 \x01(\x02R\x06waterz\x12\x14\n" +
	"\x05count\x18\x04 \x01(\rR\x05count\x12\x14\n" +
	"\x05speed\x18\x05 \x01(\x02R\x05speed\"\xb1\x01\n" +
	"\vCMsgTEDecal\x12,\n" +
	"\x06origin\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\x06origin\x12*\n" +
	"\x05start\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\x05start\x12\x1a\n" +
	"\x06entity\x18\x03 \x01(\x05:\x02-1R\x06entity\x12\x16\n" +
	"\x06hitbox\x18\x04 \x01(\rR\x06hitbox\x12\x14\n" +
	"\x05index\x18\x05 \x01(\rR\x05index\"\x96\x05\n" +
	"\x0eCMsgEffectData\x12,\n" +
	"\x06origin\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\x06origin\x12*\n" +
	"\x05start\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\x05start\x12,\n" +
	"\x06normal\x18\x03 \x01(\v2\x14.deadlock.CMsgVectorR\x06normal\x12,\n" +
	"\x06angles\x18\x04 \x01(\v2\x14.deadlock.CMsgQAngleR\x06angles\x12 \n" +
	...
	"effectname\x12&\n" +
	"\x0eattachmentname\x18\x13 \x01(\rR\x0eattachmentname\"P\n" +
	"\x14CMsgTEEffectDispatch\x128\n" +
	"\n" +
	"effectdata\x18\x01 \x01(\v2\x18.deadlock.CMsgEffectDataR\n" +
	"effectdata\"\x82\x01\n" +
	"\x12CMsgTEEnergySplash\x12&\n" +
	"\x03pos\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\x03pos\x12&\n" +
	"\x03dir\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\x03dir\x12\x1c\n" +
	...
	"\acurrent\x18\x03 \x01(\x05R\acurrent\"\xfc\x02\n" +
	"\x14CMsgTEShatterSurface\x12,\n" +
	"\x06origin\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\x06origin\x12,\n" +
	"\x06angles\x18\x02 \x01(\v2\x14.deadlock.CMsgQAngleR\x06angles\x12*\n" +
	"\x05force\x18\x03 \x01(\v2\x14.deadlock.CMsgVectorR\x05force\x120\n" +
	"\bforcepos\x18\x04 \x01(\v2\x14.deadlock.CMsgVectorR\bforcepos\x12\x14\n" +
	...
	"frontcolor\x12\x1c\n" +
	"\tbackcolor\x18\n" +
	" \x01(\aR\tbackcolor\"\x8a\x01\n" +
	"\x10CMsgTEGlowSprite\x12,\n" +
	"\x06origin\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\x06origin\x12\x14\n" +
	...
	"\fCMsgTEImpact\x12,\n" +
	"\x06origin\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\x06origin\x12,\n" +
	"\x06normal\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\x06normal\x12\x12\n" +
	"\x04type\x18\x03 \x01(\rR\x04type\"\x99\x01\n" +
	"\x11CMsgTEMuzzleFlash\x12,\n" +
	"\x06origin\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\x06origin\x12,\n" +
	"\x06angles\x18\x02 \x01(\v2\x14.deadlock.CMsgQAngleR\x06angles\x12\x14\n" +
	"\x05scale\x18\x03 \x01(\x02R\x05scale\x12\x12\n" +
	"\x04type\x18\x04 \x01(\rR\x04type\"\xa3\x01\n" +
	"\x11CMsgTEBloodStream\x12,\n" +
	"\x06origin\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\x06origin\x122\n" +
	"\tdirection\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\tdirection\x12\x14\n" +
	"\x05color\x18\x03 \x01(\aR\x05color\x12\x16\n" +
	"\x06amount\x18\x04 \x01(\rR\x06amount\"\xb7\x03\n" +
	"\x0fCMsgTEExplosion\x12,\n" +
	"\x06origin\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\x06origin\x12\x14\n" +
	"\x05flags\x18\x03 \x01(\rR\x05flags\x12,\n" +
	"\x06normal\x18\x04 \x01(\v2\x14.deadlock.CMsgVectorR\x06normal\x12\x16\n" +
	...
	"\rcreate_debris\x18\f \x01(\bR\fcreateDebris\x129\n" +
	"\rdebris_origin\x18\r \x01(\v2\x14.deadlock.CMsgVectorR\fdebrisOrigin\x12-\n" +
	"\x12debris_surfaceprop\x18\x0e \x01(\aR\x11debrisSurfaceprop\"\x98\x01\n" +
	"\n" +
	"CMsgTEDust\x12,\n" +
	"\x06origin\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\x06origin\x12\x12\n" +
	"\x04size\x18\x02 \x01(\x02R\x04size\x12\x14\n" +
	"\x05speed\x18\x03 \x01(\x02R\x05speed\x122\n" +
	"\tdirection\x18\x04 \x01(\v2\x14.deadlock.CMsgVectorR\tdirection\"]\n" +
	"\x11CMsgTELargeFunnel\x12,\n" +
	"\x06origin\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\x06origin\x12\x1a\n" +
	"\breversed\x18\x02 \x01(\rR\breversed\"\xa6\x01\n" +
	"\fCMsgTESparks\x12,\n" +
	"\x06origin\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\x06origin\x12\x1c\n" +
	"\tmagnitude\x18\x02 \x01(\rR\tmagnitude\x12\x16\n" +
	"\x06length\x18\x03 \x01(\rR\x06length\x122\n" +
	"\tdirection\x18\x04 \x01(\v2\x14.deadlock.CMsgVectorR\tdirection\"\xe8\x03\n" +
	"\x11CMsgTEPhysicsProp\x12,\n" +
	"\x06origin\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\x06origin\x120\n" +
	"\bvelocity\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\bvelocity\x12,\n" +
	"\x06angles\x18\x03 \x01(\v2\x14.deadlock.CMsgQAngleR\x06angles\x12\x12\n" +
	...
	"\x06dmgpos\x18\v \x01(\v2\x14.deadlock.CMsgVectorR\x06dmgpos\x12,\n" +
	"\x06dmgdir\x18\f \x01(\v2\x14.deadlock.CMsgVectorR\x06dmgdir\x12\x18\n" +
	"\admgtype\x18\r \x01(\x05R\admgtype\"Q\n" +
	"\vCMsgTESmoke\x12,\n" +
	"\x06origin\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\x06origin\x12\x14\n" +
	"\x05scale\x18\x02 \x01(\x02R\x05scale\"\x84\x01\n" +
	"\x10CMsgTEWorldDecal\x12,\n" +
	"\x06origin\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\x06origin\x12,\n" +
	"\x06normal\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\x06normal\x12\x14\n" +
	...
	"\n" +
	"TE_SmokeId\x10\xaa\x03B4Z2github.com/RyPort/paradox-parser/deadlock;deadlock"
...
var file_te_proto_goTypes = []any{
	(ETEProtobufIds)(0),          // 0: deadlock.ETEProtobufIds
	(*CMsgTEArmorRicochet)(nil),  // 1: deadlock.CMsgTEArmorRicochet
	(*CMsgTEBaseBeam)(nil),       // 2: deadlock.CMsgTEBaseBeam
	(*CMsgTEBeamEntPoint)(nil),   // 3: deadlock.CMsgTEBeamEntPoint
	(*CMsgTEBeamEnts)(nil),       // 4: deadlock.CMsgTEBeamEnts
	(*CMsgTEBeamPoints)(nil),     // 5: deadlock.CMsgTEBeamPoints
	(*CMsgTEBeamRing)(nil),       // 6: deadlock.CMsgTEBeamRing
	(*CMsgTEBubbles)(nil),        // 7: deadlock.CMsgTEBubbles
	(*CMsgTEBubbleTrail)(nil),    // 8: deadlock.CMsgTEBubbleTrail
	(*CMsgTEDecal)(nil),          // 9: deadlock.CMsgTEDecal
	(*CMsgEffectData)(nil),       // 10: deadlock.CMsgEffectData
	(*CMsgTEEffectDispatch)(nil), // 11: deadlock.CMsgTEEffectDispatch
	(*CMsgTEEnergySplash)(nil),   // 12: deadlock.CMsgTEEnergySplash
	(*CMsgTEFizz)(nil),           // 13: deadlock.CMsgTEFizz
	(*CMsgTEShatterSurface)(nil), // 14: deadlock.CMsgTEShatterSurface
	(*CMsgTEGlowSprite)(nil),     // 15: deadlock.CMsgTEGlowSprite
	(*CMsgTEImpact)(nil),         // 16: deadlock.CMsgTEImpact
	(*CMsgTEMuzzleFlash)(nil),    // 17: deadlock.CMsgTEMuzzleFlash
	(*CMsgTEBloodStream)(nil),    // 18: deadlock.CMsgTEBloodStream
	(*CMsgTEExplosion)(nil),      // 19: deadlock.CMsgTEExplosion
	(*CMsgTEDust)(nil),           // 20: deadlock.CMsgTEDust
	(*CMsgTELargeFunnel)(nil),    // 21: deadlock.CMsgTELargeFunnel
	(*CMsgTESparks)(nil),         // 22: deadlock.CMsgTESparks
	(*CMsgTEPhysicsProp)(nil),    // 23: deadlock.CMsgTEPhysicsProp
	(*CMsgTESmoke)(nil),          // 24: deadlock.CMsgTESmoke
	(*CMsgTEWorldDecal)(nil),     // 25: deadlock.CMsgTEWorldDecal
	(*CMsgVector)(nil),           // 26: deadlock.CMsgVector
	(*CMsgQAngle)(nil),           // 27: deadlock.CMsgQAngle
}
var file_te_proto_depIdxs = []int32{
	26, // 0: deadlock.CMsgTEArmorRicochet.pos:type_name -> deadlock.CMsgVector
	26, // 1: deadlock.CMsgTEArmorRicochet.dir:type_name -> deadlock.CMsgVector
	2,  // 2: deadlock.CMsgTEBeamEntPoint.base:type_name -> deadlock.CMsgTEBaseBeam
	26, // 3: deadlock.CMsgTEBeamEntPoint.start:type_name -> deadlock.CMsgVector
	26, // 4: deadlock.CMsgTEBeamEntPoint.end:type_name -> deadlock.CMsgVector
	2,  // 5: deadlock.CMsgTEBeamEnts.base:type_name -> deadlock.CMsgTEBaseBeam
	2,  // 6: deadlock.CMsgTEBeamPoints.base:type_name -> deadlock.CMsgTEBaseBeam
	26, // 7: deadlock.CMsgTEBeamPoints.start:type_name -> deadlock.CMsgVector
	26, // 8: deadlock.CMsgTEBeamPoints.end:type_name -> deadlock.CMsgVector
	2,  // 9: deadlock.CMsgTEBeamRing.base:type_name -> deadlock.CMsgTEBaseBeam
	26, // 10: deadlock.CMsgTEBubbles.mins:type_name -> deadlock.CMsgVector
	26, // 11: deadlock.CMsgTEBubbles.maxs:type_name -> deadlock.CMsgVector
	26, // 12: deadlock.CMsgTEBubbleTrail.mins:type_name -> deadlock.CMsgVector
	26, // 13: deadlock.CMsgTEBubbleTrail.maxs:type_name -> deadlock.CMsgVector
	26, // 14: deadlock.CMsgTEDecal.origin:type_name -> deadlock.CMsgVector
	26, // 15: deadlock.CMsgTEDecal.start:type_name -> deadlock.CMsgVector
	26, // 16: deadlock.CMsgEffectData.origin:type_name -> deadlock.CMsgVector
	26, // 17: deadlock.CMsgEffectData.start:type_name -> deadlock.CMsgVector
	26, // 18: deadlock.CMsgEffectData.normal:type_name -> deadlock.CMsgVector
	27, // 19: deadlock.CMsgEffectData.angles:type_name -> deadlock.CMsgQAngle
	10, // 20: deadlock.CMsgTEEffectDispatch.effectdata:type_name -> deadlock.CMsgEffectData
	26, // 21: deadlock.CMsgTEEnergySplash.pos:type_name -> deadlock.CMsgVector
	26, // 22: deadlock.CMsgTEEnergySplash.dir:type_name -> deadlock.CMsgVector
	26, // 23: deadlock.CMsgTEShatterSurface.origin:type_name -> deadlock.CMsgVector
	27, // 24: deadlock.CMsgTEShatterSurface.angles:type_name -> deadlock.CMsgQAngle
	26, // 25: deadlock.CMsgTEShatterSurface.force:type_name -> deadlock.CMsgVector
	26, // 26: deadlock.CMsgTEShatterSurface.forcepos:type_name -> deadlock.CMsgVector
	26, // 27: deadlock.CMsgTEGlowSprite.origin:type_name -> deadlock.CMsgVector
	26, // 28: deadlock.CMsgTEImpact.origin:type_name -> deadlock.CMsgVector
	26, // 29: deadlock.CMsgTEImpact.normal:type_name -> deadlock.CMsgVector
	26, // 30: deadlock.CMsgTEMuzzleFlash.origin:type_name -> deadlock.CMsgVector
	27, // 31: deadlock.CMsgTEMuzzleFlash.angles:type_name -> deadlock.CMsgQAngle
	26, // 32: deadlock.CMsgTEBloodStream.origin:type_name -> deadlock.CMsgVector
	26, // 33: deadlock.CMsgTEBloodStream.direction:type_name -> deadlock.CMsgVector
	26, // 34: deadlock.CMsgTEExplosion.origin:type_name -> deadlock.CMsgVector
	26, // 35: deadlock.CMsgTEExplosion.normal:type_name -> deadlock.CMsgVector
	26, // 36: deadlock.CMsgTEExplosion.debris_origin:type_name -> deadlock.CMsgVector
	26, // 37: deadlock.CMsgTEDust.origin:type_name -> deadlock.CMsgVector
	26, // 38: deadlock.CMsgTEDust.direction:type_name -> deadlock.CMsgVector
	26, // 39: deadlock.CMsgTELargeFunnel.origin:type_name -> deadlock.CMsgVector
	26, // 40: deadlock.CMsgTESparks.origin:type_name -> deadlock.CMsgVector
	26, // 41: deadlock.CMsgTESparks.direction:type_name -> deadlock.CMsgVector
	26, // 42: deadlock.CMsgTEPhysicsProp.origin:type_name -> deadlock.CMsgVector
	26, // 43: deadlock.CMsgTEPhysicsProp.velocity:type_name -> deadlock.CMsgVector
	27, // 44: deadlock.CMsgTEPhysicsProp.angles:type_name -> deadlock.CMsgQAngle
	26, // 45: deadlock.CMsgTEPhysicsProp.dmgpos:type_name -> deadlock.CMsgVector
	26, // 46: deadlock.CMsgTEPhysicsProp.dmgdir:type_name -> deadlock.CMsgVector
	26, // 47: deadlock.CMsgTESmoke.origin:type_name -> deadlock.CMsgVector
	26, // 48: deadlock.CMsgTEWorldDecal.origin:type_name -> deadlock.CMsgVector
	26, // 49: deadlock.CMsgTEWorldDecal.normal:type_name -> deadlock.CMsgVector
