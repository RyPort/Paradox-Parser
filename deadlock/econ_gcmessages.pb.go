...
type CMsgClientToGCWrapAndDeliverGiftResponse struct {
	state              protoimpl.MessageState       `protogen:"open.v1"`
	Response           *EGCMsgResponse              `protobuf:"varint,1,opt,name=response,enum=deadlock.EGCMsgResponse,def=0" json:"response,omitempty"`
	...
	TradeRestriction   *EGCMsgInitiateTradeResponse `protobuf:"varint,7,opt,name=trade_restriction,json=tradeRestriction,enum=deadlock.EGCMsgInitiateTradeResponse,def=0" json:"trade_restriction,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type CMsgClientToGCGetGiftPermissionsResponse struct {
	...
	SenderPermission                  *EGCMsgInitiateTradeResponse                                 `protobuf:"varint,6,opt,name=sender_permission,json=senderPermission,enum=deadlock.EGCMsgInitiateTradeResponse,def=0" json:"sender_permission,omitempty"`
...
type CMsgClientToGCUnpackBundleResponse struct {
	...
	Response               *CMsgClientToGCUnpackBundleResponse_EUnpackBundle `protobuf:"varint,2,opt,name=response,enum=deadlock.CMsgClientToGCUnpackBundleResponse_EUnpackBundle,def=0" json:"response,omitempty"`
...
type CMsgClientToGCPackBundleResponse struct {
	state         protoimpl.MessageState                        `protogen:"open.v1"`
	ItemId        *uint64                                       `protobuf:"varint,1,opt,name=item_id,json=itemId" json:"item_id,omitempty"`
	Response      *CMsgClientToGCPackBundleResponse_EPackBundle `protobuf:"varint,2,opt,name=response,enum=deadlock.CMsgClientToGCPackBundleResponse_EPackBundle,def=0" json:"response,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgClientToGCSetItemStyleResponse struct {
	state         protoimpl.MessageState                        `protogen:"open.v1"`
	Response      *CMsgClientToGCSetItemStyleResponse_ESetStyle `protobuf:"varint,1,opt,name=response,enum=deadlock.CMsgClientToGCSetItemStyleResponse_ESetStyle,def=0" json:"response,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgClientToGCUnlockItemStyleResponse struct {
	state         protoimpl.MessageState                              `protogen:"open.v1"`
	Response      *CMsgClientToGCUnlockItemStyleResponse_EUnlockStyle `protobuf:"varint,1,opt,name=response,enum=deadlock.CMsgClientToGCUnlockItemStyleResponse_EUnlockStyle,def=0" json:"response,omitempty"`
	ItemId        *uint64                                             `protobuf:"varint,2,opt,name=item_id,json=itemId" json:"item_id,omitempty"`
...
type CMsgClientToGCUnlockCrateResponse struct {
	state         protoimpl.MessageState                    `protogen:"open.v1"`
	Result        *EGCMsgResponse                           `protobuf:"varint,1,opt,name=result,enum=deadlock.EGCMsgResponse,def=0" json:"result,omitempty"`
...
type CMsgClientToGCRemoveItemAttributeResponse struct {
	state         protoimpl.MessageState                                          `protogen:"open.v1"`
	Response      *CMsgClientToGCRemoveItemAttributeResponse_ERemoveItemAttribute `protobuf:"varint,1,opt,name=response,enum=deadlock.CMsgClientToGCRemoveItemAttributeResponse_ERemoveItemAttribute,def=0" json:"response,omitempty"`
	ItemId        *uint64                                                         `protobuf:"varint,2,opt,name=item_id,json=itemId" json:"item_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgClientToGCNameItemResponse struct {
	state         protoimpl.MessageState                    `protogen:"open.v1"`
	Response      *CMsgClientToGCNameItemResponse_ENameItem `protobuf:"varint,1,opt,name=response,enum=deadlock.CMsgClientToGCNameItemResponse_ENameItem,def=0" json:"response,omitempty"`
	ItemId        *uint64                                   `protobuf:"varint,2,opt,name=item_id,json=itemId" json:"item_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgClientToGCCreateStaticRecipeResponse struct {
	state             protoimpl.MessageState                                       `protogen:"open.v1"`
	Response          *CMsgClientToGCCreateStaticRecipeResponse_EResponse          `protobuf:"varint,1,opt,name=response,enum=deadlock.CMsgClientToGCCreateStaticRecipeResponse_EResponse,def=0" json:"response,omitempty"`
...
type CMsgClientToGCGetLimitedItemPurchaseQuantityResponse struct {
	state             protoimpl.MessageState                                          `protogen:"open.v1"`
	Result            *CMsgClientToGCGetLimitedItemPurchaseQuantityResponse_EResponse `protobuf:"varint,1,opt,name=result,enum=deadlock.CMsgClientToGCGetLimitedItemPurchaseQuantityResponse_EResponse,def=0" json:"result,omitempty"`
...
type CMsgClientToGCGetInFlightItemChargesResponse struct {
	state           protoimpl.MessageState                                  `protogen:"open.v1"`
	Result          *CMsgClientToGCGetInFlightItemChargesResponse_EResponse `protobuf:"varint,1,opt,name=result,enum=deadlock.CMsgClientToGCGetInFlightItemChargesResponse_EResponse,def=0" json:"result,omitempty"`
...
type CMsgClientToGCPurchaseChargeCostItemsResponse struct {
	state         protoimpl.MessageState                                   `protogen:"open.v1"`
	Result        *CMsgClientToGCPurchaseChargeCostItemsResponse_EResponse `protobuf:"varint,1,opt,name=result,enum=deadlock.CMsgClientToGCPurchaseChargeCostItemsResponse_EResponse,def=0" json:"result,omitempty"`
	ItemIds       []uint64                                                 `protobuf:"varint,2,rep,name=item_ids,json=itemIds" json:"item_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgClientToGCGetGiftPermissionsResponse_FriendPermission struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	AccountId     *uint32                      `protobuf:"varint,1,opt,name=account_id,json=accountId" json:"account_id,omitempty"`
	Permission    *EGCMsgInitiateTradeResponse `protobuf:"varint,2,opt,name=permission,enum=deadlock.EGCMsgInitiateTradeResponse,def=0" json:"permission,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgClientToGCCreateStaticRecipeResponse_InputError struct {
	...
	Error         *CMsgClientToGCCreateStaticRecipeResponse_EResponse `protobuf:"varint,2,opt,name=error,enum=deadlock.CMsgClientToGCCreateStaticRecipeResponse_EResponse,def=0" json:"error,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_econ_gcmessages_proto_rawDesc = "" +
	"\n" +
	"\x15econ_gcmessages.proto\x12\bdeadlock\x1a\x13steammessages.proto\x1a\x17econ_shared_enums.proto\x1a\x16gcsdk_gcmessages.proto\x1a\x15base_gcmessages.proto\"b\n" +
	...
	"\x19strange_count_adjustments\x18\x02 \x03(\v2F.deadlock.CMsgEconPlayerStrangeCountAdjustment.CStrangeCountAdjustmentR\x17strangeCountAdjustments\x12\x1d\n" +
	"\n" +
	...
	"\n" +
	"sale_price\x18\x01 \x03(\v23.deadlock.CMsgGCRequestStoreSalesDataResponse.PriceR\tsalePrice\x12\x18\n" +
	...
	"\baccounts\x18\x01 \x03(\v28.deadlock.CMsgLookupMultipleAccountNamesResponse.AccountR\baccounts\x1aA\n" +
	"\aAccount\x12\x1c\n" +
	...
	"\n" +
	"peek_items\x18\x04 \x03(\v2\x15.deadlock.CSOEconItemR\tpeekItems\"(\n" +
	"\aEResult\x12\x0f\n" +
	...
	"\x05items\x18\x02 \x03(\v20.deadlock.CMsgGCToGCGrantAccountRolledItems.ItemR\x05items\x12!\n" +
	...
	"\x12dynamic_attributes\x18\x05 \x03(\v2A.deadlock.CMsgGCToGCGrantAccountRolledItems.Item.DynamicAttributeR\x11dynamicAttributes\x12\x7f\n" +
	"\x18additional_audit_entries\x18\x06 \x03(\v2E.deadlock.CMsgGCToGCGrantAccountRolledItems.Item.AdditionalAuditEntryR\x16additionalAuditEntries\x12'\n" +
	...
	"\fuse_item_msg\x18\x02 \x01(\v2\x15.deadlock.CMsgUseItemR\n" +
	"useItemMsg\"1\n" +
	...
	"\fwrapped_item\x18\x03 \x01(\v2\x15.deadlock.CSOEconItemR\vwrappedItem\x12!\n" +
	...
	"\bresponse\x18\x01 \x01(\x0e2\x18.deadlock.EGCMsgResponse:\x12k_EGCMsgResponseOKR\bresponse\x12.\n" +
	...
	"\x11trade_restriction\x18\a \x01(\x0e2%.deadlock.EGCMsgInitiateTradeResponse:&k_EGCMsgInitiateTradeResponse_AcceptedR\x10tradeRestriction\"3\n" +
	...
	"\x11sender_permission\x18\x06 \x01(\x0e2%.deadlock.EGCMsgInitiateTradeResponse:&k_EGCMsgInitiateTradeResponse_AcceptedR\x10senderPermission\x12<\n" +
	...
	"\x12friend_permissions\x18\t \x03(\v2C.deadlock.CMsgClientToGCGetGiftPermissionsResponse.FriendPermissionR\x11friendPermissions\x1a\xa0\x01\n" +
	"\x10FriendPermission\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12m\n" +
	"\n" +
	"permission\x18\x02 \x01(\x0e2%.deadlock.EGCMsgInitiateTradeResponse:&k_EGCMsgInitiateTradeResponse_AcceptedR\n" +
	"permission\"5\n" +
	...
	"\bresponse\x18\x02 \x01(\x0e2:.deadlock.CMsgClientToGCUnpackBundleResponse.EUnpackBundle:\x18k_UnpackBundle_SucceededR\bresponse\x129\n" +
	...
	"\bresponse\x18\x02 \x01(\x0e26.deadlock.CMsgClientToGCPackBundleResponse.EPackBundle:\x16k_PackBundle_SucceededR\bresponse\"\xe3\x04\n" +
	...
	"\x06equips\x18\x01 \x03(\v2%.deadlock.CMsgAdjustItemEquippedStateR\x06equips\"Q\n" +
	...
	"\bresponse\x18\x01 \x01(\x0e26.deadlock.CMsgClientToGCSetItemStyleResponse.ESetStyle:\x14k_SetStyle_SucceededR\bresponse\"a\n" +
	"\tESetStyle\x12\x18\n" +
	...
	"\bresponse\x18\x01 \x01(\x0e2<.deadlock.CMsgClientToGCUnlockItemStyleResponse.EUnlockStyle:\x17k_UnlockStyle_SucceededR\bresponse\x12\x17\n" +
	...
	"\x06result\x18\x01 \x01(\x0e2\x18.deadlock.EGCMsgResponse:\x12k_EGCMsgResponseOKR\x06result\x12U\n" +
	"\rgranted_items\x18\x02 \x03(\v20.deadlock.CMsgClientToGCUnlockCrateResponse.ItemR\fgrantedItems\x1a<\n" +
	"\x04Item\x12\x17\n" +
	"\aitem_id\x18\x01 \x01(\x04R\x06itemId\x12\x1b\n" +
	...
	"\bresponse\x18\x01 \x01(\x0e2H.deadlock.CMsgClientToGCRemoveItemAttributeResponse.ERemoveItemAttribute:\x1fk_RemoveItemAttribute_SucceededR\bresponse\x12\x17\n" +
	...
	"\bresponse\x18\x01 \x01(\x0e22.deadlock.CMsgClientToGCNameItemResponse.ENameItem:\x14k_NameItem_SucceededR\bresponse\x12\x17\n" +
	...
	"\x06socket\x18\x01 \x01(\v2\x1a.deadlock.CProtoItemSocketR\x06socket\"e\n" +
	"\x17CProtoItemSocket_Effect\x122\n" +
	"\x06socket\x18\x01 \x01(\v2\x1a.deadlock.CProtoItemSocketR\x06socket\x12\x16\n" +
	"\x06effect\x18\x02 \x01(\rR\x06effect\"\x88\x01\n" +
	"\x16CProtoItemSocket_Color\x122\n" +
	"\x06socket\x18\x01 \x01(\v2\x1a.deadlock.CProtoItemSocketR\x06socket\x12\x10\n" +
	...
	"\x06socket\x18\x01 \x01(\v2\x1a.deadlock.CProtoItemSocketR\x06socket\x12!\n" +
	...
	"\x06socket\x18\x01 \x01(\v2\x1a.deadlock.CProtoItemSocketR\x06socket\x12\x1c\n" +
	...
	"\x06socket\x18\x01 \x01(\v2\x1a.deadlock.CProtoItemSocketR\x06socket\")\n" +
	...
	"\x0fcountry_revenue\x18\x01 \x03(\v2D.deadlock.CWorkshop_GetItemDailyRevenue_Response.CountryDailyRevenueR\x0ecountryRevenue\x1a\x83\x01\n" +
	...
	"\x0fcountry_revenue\x18\x01 \x03(\v2G.deadlock.CWorkshop_GetPackageDailyRevenue_Response.CountryDailyRevenueR\x0ecountryRevenue\x1a\x83\x01\n" +
	"\x13CountryDailyRevenue\x12!\n" +
	"\fcountry_code\x18\x01 \x01(\tR\vcountryCode\x12\x12\n" +
	"\x04date\x18\x02 \x01(\rR\x04date\x12\x1f\n" +
	"\vrevenue_usd\x18\x03 \x01(\x03R\n" +
	...
	"\x05items\x18\x01 \x03(\v2/.deadlock.CMsgClientToGCCreateStaticRecipe.ItemR\x05items\x12(\n" +
	...
	"\bresponse\x18\x01 \x01(\x0e2<.deadlock.CMsgClientToGCCreateStaticRecipeResponse.EResponse:\x11eResponse_SuccessR\bresponse\x12`\n" +
	"\foutput_items\x18\x02 \x03(\v2=.deadlock.CMsgClientToGCCreateStaticRecipeResponse.OutputItemR\voutputItems\x12`\n" +
	"\finput_errors\x18\x03 \x03(\v2=.deadlock.CMsgClientToGCCreateStaticRecipeResponse.InputErrorR\vinputErrors\x12r\n" +
	"\x12additional_outputs\x18\x04 \x03(\v2C.deadlock.CMsgClientToGCCreateStaticRecipeResponse.AdditionalOutputR\x11additionalOutputs\x1a[\n" +
	"\n" +
	"OutputItem\x12\x1b\n" +
	...
	"\x05error\x18\x02 \x01(\x0e2<.deadlock.CMsgClientToGCCreateStaticRecipeResponse.EResponse:\x11eResponse_SuccessR\x05error\x1aA\n" +
	...
	"\x05items\x18\t \x03(\v2*.deadlock.CMsgProcessTransactionOrder.ItemR\x05items\x1a\x86\x03\n" +
	"\x04Item\x12$\n" +
	...
	"\x05order\x18\x01 \x01(\v2%.deadlock.CMsgProcessTransactionOrderR\x05order\x12\x1f\n" +
	...
	"\x05order\x18\x01 \x01(\v2%.deadlock.CMsgProcessTransactionOrderR\x05order\"D\n" +
	...
	"\x04msgs\x18\x03 \x03(\v2,.deadlock.CMsgGCToGCConsoleOutput.OutputLineR\x04msgs\x122\n" +
	...
	"\fCMsgItemAges\x12^\n" +
	"\x16max_item_id_timestamps\x18\x01 \x03(\v2).deadlock.CMsgItemAges.MaxItemIDTimestampR\x13maxItemIdTimestamps\x1aR\n" +
	...
	"\n" +
	"currencies\x18\x02 \x03(\v24.deadlock.CMsgGCToClientCurrencyPricePoints.CurrencyR\n" +
	"currencies\x1aV\n" +
	"\bCurrency\x12\x1f\n" +
	...
	"\x04keys\x18\x01 \x03(\v20.deadlock.CMsgGCToGCFlushSteamInventoryCache.KeyR\x04keys\x1a=\n" +
	"\x03Key\x12\x18\n" +
	...
	"\x06result\x18\x01 \x01(\x0e2H.deadlock.CMsgClientToGCGetLimitedItemPurchaseQuantityResponse.EResponse:\x10k_eInternalErrorR\x06result\x12-\n" +
	...
	"\x06result\x18\x01 \x01(\x0e2@.deadlock.CMsgClientToGCGetInFlightItemChargesResponse.EResponse:\x10k_eInternalErrorR\x06result\x12*\n" +
	...
	"\x05items\x18\x01 \x03(\v24.deadlock.CMsgClientToGCPurchaseChargeCostItems.ItemR\x05items\x12\x1a\n" +
	...
	"\x06result\x18\x01 \x01(\x0e2A.deadlock.CMsgClientToGCPurchaseChargeCostItemsResponse.EResponse:\x10k_eInternalErrorR\x06result\x12\x19\n" +
	...
	"\x11in_flight_charges\x18\x02 \x03(\v2:.deadlock.CMsgGCToClientInFlightChargesUpdated.ItemChargesR\x0finFlightCharges\x1aT\n" +
	...
	"\anew_msg\x18\x02 \x01(\v2\x18.deadlock.CExtraMsgBlockR\x06newMsg\x12\x1c\n" +
	...
	"3k_EGCMsgInitiateTradeResponse_WalledFundsNotTrusted\x10\x18B4Z2github.com/RyPort/paradox-parser/deadlock;deadlock"
...
var file_econ_gcmessages_proto_goTypes = []any{
	(EGCItemMsg)(0),                                                       // 0: deadlock.EGCItemMsg
	(EGCMsgInitiateTradeResponse)(0),                                      // 1: deadlock.EGCMsgInitiateTradeResponse
	(CMsgRequestCrateItemsResponse_EResult)(0),                            // 2: deadlock.CMsgRequestCrateItemsResponse.EResult
	(CMsgRequestCrateEscalationLevelResponse_EResult)(0),                  // 3: deadlock.CMsgRequestCrateEscalationLevelResponse.EResult
	(CMsgRedeemCodeResponse_EResultCode)(0),                               // 4: deadlock.CMsgRedeemCodeResponse.EResultCode
	(CMsgClientToGCUnpackBundleResponse_EUnpackBundle)(0),                 // 5: deadlock.CMsgClientToGCUnpackBundleResponse.EUnpackBundle
	(CMsgClientToGCPackBundleResponse_EPackBundle)(0),                     // 6: deadlock.CMsgClientToGCPackBundleResponse.EPackBundle
	(CMsgClientToGCSetItemStyleResponse_ESetStyle)(0),                     // 7: deadlock.CMsgClientToGCSetItemStyleResponse.ESetStyle
	(CMsgClientToGCUnlockItemStyleResponse_EUnlockStyle)(0),               // 8: deadlock.CMsgClientToGCUnlockItemStyleResponse.EUnlockStyle
	(CMsgClientToGCRemoveItemAttributeResponse_ERemoveItemAttribute)(0),   // 9: deadlock.CMsgClientToGCRemoveItemAttributeResponse.ERemoveItemAttribute
	(CMsgClientToGCNameItemResponse_ENameItem)(0),                         // 10: deadlock.CMsgClientToGCNameItemResponse.ENameItem
	(CMsgClientToGCCreateStaticRecipeResponse_EResponse)(0),               // 11: deadlock.CMsgClientToGCCreateStaticRecipeResponse.EResponse
	(CMsgClientToGCGetLimitedItemPurchaseQuantityResponse_EResponse)(0),   // 12: deadlock.CMsgClientToGCGetLimitedItemPurchaseQuantityResponse.EResponse
	(CMsgClientToGCGetInFlightItemChargesResponse_EResponse)(0),           // 13: deadlock.CMsgClientToGCGetInFlightItemChargesResponse.EResponse
	(CMsgClientToGCPurchaseChargeCostItemsResponse_EResponse)(0),          // 14: deadlock.CMsgClientToGCPurchaseChargeCostItemsResponse.EResponse
	(*CMsgApplyAutograph)(nil),                                            // 15: deadlock.CMsgApplyAutograph
	(*CMsgAdjustItemEquippedState)(nil),                                   // 16: deadlock.CMsgAdjustItemEquippedState
	(*CMsgEconPlayerStrangeCountAdjustment)(nil),                          // 17: deadlock.CMsgEconPlayerStrangeCountAdjustment
	(*CMsgCraftingResponse)(nil),                                          // 18: deadlock.CMsgCraftingResponse
	(*CMsgGCRequestStoreSalesData)(nil),                                   // 19: deadlock.CMsgGCRequestStoreSalesData
	(*CMsgGCRequestStoreSalesDataResponse)(nil),                           // 20: deadlock.CMsgGCRequestStoreSalesDataResponse
	(*CMsgGCRequestStoreSalesDataUpToDateResponse)(nil),                   // 21: deadlock.CMsgGCRequestStoreSalesDataUpToDateResponse
	(*CMsgGCToGCPingRequest)(nil),                                         // 22: deadlock.CMsgGCToGCPingRequest
	(*CMsgGCToGCPingResponse)(nil),                                        // 23: deadlock.CMsgGCToGCPingResponse
	(*CMsgGCToGCGetUserSessionServer)(nil),                                // 24: deadlock.CMsgGCToGCGetUserSessionServer
	(*CMsgGCToGCGetUserSessionServerResponse)(nil),                        // 25: deadlock.CMsgGCToGCGetUserSessionServerResponse
	(*CMsgGCToGCGetUserServerMembers)(nil),                                // 26: deadlock.CMsgGCToGCGetUserServerMembers
	(*CMsgGCToGCGetUserServerMembersResponse)(nil),                        // 27: deadlock.CMsgGCToGCGetUserServerMembersResponse
	(*CMsgLookupMultipleAccountNames)(nil),                                // 28: deadlock.CMsgLookupMultipleAccountNames
	(*CMsgLookupMultipleAccountNamesResponse)(nil),                        // 29: deadlock.CMsgLookupMultipleAccountNamesResponse
	(*CMsgRequestCrateItems)(nil),                                         // 30: deadlock.CMsgRequestCrateItems
	(*CMsgRequestCrateItemsResponse)(nil),                                 // 31: deadlock.CMsgRequestCrateItemsResponse
	(*CMsgRequestCrateEscalationLevel)(nil),                               // 32: deadlock.CMsgRequestCrateEscalationLevel
	(*CMsgRequestCrateEscalationLevelResponse)(nil),                       // 33: deadlock.CMsgRequestCrateEscalationLevelResponse
	(*CMsgGCToGCCanUseDropRateBonus)(nil),                                 // 34: deadlock.CMsgGCToGCCanUseDropRateBonus
	(*CMsgSQLAddDropRateBonus)(nil),                                       // 35: deadlock.CMsgSQLAddDropRateBonus
	(*CMsgSQLUpgradeBattleBooster)(nil),                                   // 36: deadlock.CMsgSQLUpgradeBattleBooster
	(*CMsgGCToGCRefreshSOCache)(nil),                                      // 37: deadlock.CMsgGCToGCRefreshSOCache
	(*CMsgGCToGCAddSubscriptionTime)(nil),                                 // 38: deadlock.CMsgGCToGCAddSubscriptionTime
	(*CMsgGCToGCGrantAccountRolledItems)(nil),                             // 39: deadlock.CMsgGCToGCGrantAccountRolledItems
	(*CMsgGCToGCBetaDeleteItems)(nil),                                     // 40: deadlock.CMsgGCToGCBetaDeleteItems
	(*CMsgGCToGCGrantSelfMadeItemToAccount)(nil),                          // 41: deadlock.CMsgGCToGCGrantSelfMadeItemToAccount
	(*CMsgGCToGCUnlockCrate)(nil),                                         // 42: deadlock.CMsgGCToGCUnlockCrate
	(*CMsgUseItem)(nil),                                                   // 43: deadlock.CMsgUseItem
	(*CMsgServerUseItem)(nil),                                             // 44: deadlock.CMsgServerUseItem
	(*CMsgUseMultipleItems)(nil),                                          // 45: deadlock.CMsgUseMultipleItems
	(*CGCStoreRechargeRedirect_LineItem)(nil),                             // 46: deadlock.CGCStoreRechargeRedirect_LineItem
	(*CMsgGCEconSQLWorkItemEmbeddedRollbackData)(nil),                     // 47: deadlock.CMsgGCEconSQLWorkItemEmbeddedRollbackData
	(*CMsgCraftStatue)(nil),                                               // 48: deadlock.CMsgCraftStatue
	(*CMsgRedeemCode)(nil),                                                // 49: deadlock.CMsgRedeemCode
	(*CMsgRedeemCodeResponse)(nil),                                        // 50: deadlock.CMsgRedeemCodeResponse
	(*CMsgDevNewItemRequest)(nil),                                         // 51: deadlock.CMsgDevNewItemRequest
	(*CMsgDevNewItemRequestResponse)(nil),                                 // 52: deadlock.CMsgDevNewItemRequestResponse
	(*CMsgDevUnlockAllItemStyles)(nil),                                    // 53: deadlock.CMsgDevUnlockAllItemStyles
	(*CMsgDevUnlockAllItemStylesResponse)(nil),                            // 54: deadlock.CMsgDevUnlockAllItemStylesResponse
	(*CMsgGCGetAccountSubscriptionItem)(nil),                              // 55: deadlock.CMsgGCGetAccountSubscriptionItem
	(*CMsgGCGetAccountSubscriptionItemResponse)(nil),                      // 56: deadlock.CMsgGCGetAccountSubscriptionItemResponse
	(*CMsgGCAddGiftItem)(nil),                                             // 57: deadlock.CMsgGCAddGiftItem
	(*CMsgClientToGCWrapAndDeliverGift)(nil),                              // 58: deadlock.CMsgClientToGCWrapAndDeliverGift
	(*CMsgSQLGCToGCRevokeUntrustedGift)(nil),                              // 59: deadlock.CMsgSQLGCToGCRevokeUntrustedGift
	(*CMsgClientToGCWrapAndDeliverGiftResponse)(nil),                      // 60: deadlock.CMsgClientToGCWrapAndDeliverGiftResponse
	(*CMsgClientToGCUnwrapGift)(nil),                                      // 61: deadlock.CMsgClientToGCUnwrapGift
	(*CMsgClientToGCGetGiftPermissions)(nil),                              // 62: deadlock.CMsgClientToGCGetGiftPermissions
	(*CMsgClientToGCGetGiftPermissionsResponse)(nil),                      // 63: deadlock.CMsgClientToGCGetGiftPermissionsResponse
	(*CMsgClientToGCUnpackBundle)(nil),                                    // 64: deadlock.CMsgClientToGCUnpackBundle
	(*CMsgClientToGCUnpackBundleResponse)(nil),                            // 65: deadlock.CMsgClientToGCUnpackBundleResponse
	(*CMsgClientToGCPackBundle)(nil),                                      // 66: deadlock.CMsgClientToGCPackBundle
	(*CMsgClientToGCPackBundleResponse)(nil),                              // 67: deadlock.CMsgClientToGCPackBundleResponse
	(*CMsgGCToClientStoreTransactionCompleted)(nil),                       // 68: deadlock.CMsgGCToClientStoreTransactionCompleted
	(*CMsgClientToGCEquipItems)(nil),                                      // 69: deadlock.CMsgClientToGCEquipItems
	(*CMsgClientToGCEquipItemsResponse)(nil),                              // 70: deadlock.CMsgClientToGCEquipItemsResponse
	(*CMsgClientToGCSetItemStyle)(nil),                                    // 71: deadlock.CMsgClientToGCSetItemStyle
	(*CMsgClientToGCSetItemStyleResponse)(nil),                            // 72: deadlock.CMsgClientToGCSetItemStyleResponse
	(*CMsgClientToGCUnlockItemStyle)(nil),                                 // 73: deadlock.CMsgClientToGCUnlockItemStyle
	(*CMsgClientToGCUnlockItemStyleResponse)(nil),                         // 74: deadlock.CMsgClientToGCUnlockItemStyleResponse
	(*CMsgClientToGCSetItemInventoryCategory)(nil),                        // 75: deadlock.CMsgClientToGCSetItemInventoryCategory
	(*CMsgClientToGCUnlockCrate)(nil),                                     // 76: deadlock.CMsgClientToGCUnlockCrate
	(*CMsgClientToGCUnlockCrateResponse)(nil),                             // 77: deadlock.CMsgClientToGCUnlockCrateResponse
	(*CMsgClientToGCRemoveItemAttribute)(nil),                             // 78: deadlock.CMsgClientToGCRemoveItemAttribute
	(*CMsgClientToGCRemoveItemAttributeResponse)(nil),                     // 79: deadlock.CMsgClientToGCRemoveItemAttributeResponse
	(*CMsgClientToGCNameItem)(nil),                                        // 80: deadlock.CMsgClientToGCNameItem
	(*CMsgClientToGCNameItemResponse)(nil),                                // 81: deadlock.CMsgClientToGCNameItemResponse
	(*CMsgGCSetItemPosition)(nil),                                         // 82: deadlock.CMsgGCSetItemPosition
	(*CAttribute_ItemDynamicRecipeComponent)(nil),                         // 83: deadlock.CAttribute_ItemDynamicRecipeComponent
	(*CProtoItemSocket)(nil),                                              // 84: deadlock.CProtoItemSocket
	(*CProtoItemSocket_Empty)(nil),                                        // 85: deadlock.CProtoItemSocket_Empty
	(*CProtoItemSocket_Effect)(nil),                                       // 86: deadlock.CProtoItemSocket_Effect
	(*CProtoItemSocket_Color)(nil),                                        // 87: deadlock.CProtoItemSocket_Color
	(*CProtoItemSocket_Strange)(nil),                                      // 88: deadlock.CProtoItemSocket_Strange
	(*CProtoItemSocket_Strange_DESERIALIZE_FROM_STRING_ONLY)(nil),         // 89: deadlock.CProtoItemSocket_Strange_DESERIALIZE_FROM_STRING_ONLY
	(*CProtoItemSocket_Spectator)(nil),                                    // 90: deadlock.CProtoItemSocket_Spectator
	(*CProtoItemSocket_AssetModifier)(nil),                                // 91: deadlock.CProtoItemSocket_AssetModifier
	(*CProtoItemSocket_AssetModifier_DESERIALIZE_FROM_STRING_ONLY)(nil),   // 92: deadlock.CProtoItemSocket_AssetModifier_DESERIALIZE_FROM_STRING_ONLY
	(*CProtoItemSocket_Autograph)(nil),                                    // 93: deadlock.CProtoItemSocket_Autograph
	(*CProtoItemSocket_StaticVisuals)(nil),                                // 94: deadlock.CProtoItemSocket_StaticVisuals
	(*CAttribute_String)(nil),                                             // 95: deadlock.CAttribute_String
	(*CWorkshop_GetItemDailyRevenue_Request)(nil),                         // 96: deadlock.CWorkshop_GetItemDailyRevenue_Request
	(*CWorkshop_GetItemDailyRevenue_Response)(nil),                        // 97: deadlock.CWorkshop_GetItemDailyRevenue_Response
	(*CWorkshop_GetPackageDailyRevenue_Request)(nil),                      // 98: deadlock.CWorkshop_GetPackageDailyRevenue_Request
	(*CWorkshop_GetPackageDailyRevenue_Response)(nil),                     // 99: deadlock.CWorkshop_GetPackageDailyRevenue_Response
	(*CMsgSQLGCToGCGrantBackpackSlots)(nil),                               // 100: deadlock.CMsgSQLGCToGCGrantBackpackSlots
	(*CMsgClientToGCLookupAccountName)(nil),                               // 101: deadlock.CMsgClientToGCLookupAccountName
	(*CMsgClientToGCLookupAccountNameResponse)(nil),                       // 102: deadlock.CMsgClientToGCLookupAccountNameResponse
	(*CMsgClientToGCCreateStaticRecipe)(nil),                              // 103: deadlock.CMsgClientToGCCreateStaticRecipe
	(*CMsgClientToGCCreateStaticRecipeResponse)(nil),                      // 104: deadlock.CMsgClientToGCCreateStaticRecipeResponse
	(*CMsgProcessTransactionOrder)(nil),                                   // 105: deadlock.CMsgProcessTransactionOrder
	(*CMsgGCToGCStoreProcessCDKeyTransaction)(nil),                        // 106: deadlock.CMsgGCToGCStoreProcessCDKeyTransaction
	(*CMsgGCToGCStoreProcessCDKeyTransactionResponse)(nil),                // 107: deadlock.CMsgGCToGCStoreProcessCDKeyTransactionResponse
	(*CMsgGCToGCStoreProcessSettlement)(nil),                              // 108: deadlock.CMsgGCToGCStoreProcessSettlement
	(*CMsgGCToGCStoreProcessSettlementResponse)(nil),                      // 109: deadlock.CMsgGCToGCStoreProcessSettlementResponse
	(*CMsgGCToGCBroadcastConsoleCommand)(nil),                             // 110: deadlock.CMsgGCToGCBroadcastConsoleCommand
	(*CMsgGCToGCConsoleOutput)(nil),                                       // 111: deadlock.CMsgGCToGCConsoleOutput
	(*CMsgItemAges)(nil),                                                  // 112: deadlock.CMsgItemAges
	(*CMsgGCToGCInternalTestMsg)(nil),                                     // 113: deadlock.CMsgGCToGCInternalTestMsg
	(*CMsgGCToGCClientServerVersionsUpdated)(nil),                         // 114: deadlock.CMsgGCToGCClientServerVersionsUpdated
	(*CMsgGCToGCBroadcastMessageFromSub)(nil),                             // 115: deadlock.CMsgGCToGCBroadcastMessageFromSub
	(*CMsgGCToClientCurrencyPricePoints)(nil),                             // 116: deadlock.CMsgGCToClientCurrencyPricePoints
	(*CMsgBannedWordList)(nil),                                            // 117: deadlock.CMsgBannedWordList
	(*CMsgGCToGCFlushSteamInventoryCache)(nil),                            // 118: deadlock.CMsgGCToGCFlushSteamInventoryCache
	(*CMsgGCToGCUpdateSubscriptionItems)(nil),                             // 119: deadlock.CMsgGCToGCUpdateSubscriptionItems
	(*CMsgGCToGCSelfPing)(nil),                                            // 120: deadlock.CMsgGCToGCSelfPing
	(*CMsgGCToGCGetInfuxIntervalStats)(nil),                               // 121: deadlock.CMsgGCToGCGetInfuxIntervalStats
	(*CMsgGCToGCGetInfuxIntervalStatsResponse)(nil),                       // 122: deadlock.CMsgGCToGCGetInfuxIntervalStatsResponse
	(*CMsgGCToGCPurchaseSucceeded)(nil),                                   // 123: deadlock.CMsgGCToGCPurchaseSucceeded
	(*CMsgClientToGCGetLimitedItemPurchaseQuantity)(nil),                  // 124: deadlock.CMsgClientToGCGetLimitedItemPurchaseQuantity
	(*CMsgClientToGCGetLimitedItemPurchaseQuantityResponse)(nil),          // 125: deadlock.CMsgClientToGCGetLimitedItemPurchaseQuantityResponse
	(*CMsgClientToGCGetInFlightItemCharges)(nil),                          // 126: deadlock.CMsgClientToGCGetInFlightItemCharges
	(*CMsgClientToGCGetInFlightItemChargesResponse)(nil),                  // 127: deadlock.CMsgClientToGCGetInFlightItemChargesResponse
	(*CMsgClientToGCPurchaseChargeCostItems)(nil),                         // 128: deadlock.CMsgClientToGCPurchaseChargeCostItems
	(*CMsgClientToGCPurchaseChargeCostItemsResponse)(nil),                 // 129: deadlock.CMsgClientToGCPurchaseChargeCostItemsResponse
	(*CMsgGCToClientInFlightChargesUpdated)(nil),                          // 130: deadlock.CMsgGCToClientInFlightChargesUpdated
	(*CMsgClientToGCCancelUnfinalizedTransactions)(nil),                   // 131: deadlock.CMsgClientToGCCancelUnfinalizedTransactions
	(*CMsgClientToGCCancelUnfinalizedTransactionsResponse)(nil),           // 132: deadlock.CMsgClientToGCCancelUnfinalizedTransactionsResponse
	(*CMsgGCToGCUpdateWelcomeMsg)(nil),                                    // 133: deadlock.CMsgGCToGCUpdateWelcomeMsg
	(*CMsgEconPlayerStrangeCountAdjustment_CStrangeCountAdjustment)(nil),  // 134: deadlock.CMsgEconPlayerStrangeCountAdjustment.CStrangeCountAdjustment
	(*CMsgGCRequestStoreSalesDataResponse_Price)(nil),                     // 135: deadlock.CMsgGCRequestStoreSalesDataResponse.Price
	(*CMsgLookupMultipleAccountNamesResponse_Account)(nil),                // 136: deadlock.CMsgLookupMultipleAccountNamesResponse.Account
	(*CMsgGCToGCGrantAccountRolledItems_Item)(nil),                        // 137: deadlock.CMsgGCToGCGrantAccountRolledItems.Item
	(*CMsgGCToGCGrantAccountRolledItems_Item_DynamicAttribute)(nil),       // 138: deadlock.CMsgGCToGCGrantAccountRolledItems.Item.DynamicAttribute
	(*CMsgGCToGCGrantAccountRolledItems_Item_AdditionalAuditEntry)(nil),   // 139: deadlock.CMsgGCToGCGrantAccountRolledItems.Item.AdditionalAuditEntry
	(*CMsgClientToGCGetGiftPermissionsResponse_FriendPermission)(nil),     // 140: deadlock.CMsgClientToGCGetGiftPermissionsResponse.FriendPermission
	(*CMsgClientToGCUnlockCrateResponse_Item)(nil),                        // 141: deadlock.CMsgClientToGCUnlockCrateResponse.Item
	(*CWorkshop_GetItemDailyRevenue_Response_CountryDailyRevenue)(nil),    // 142: deadlock.CWorkshop_GetItemDailyRevenue_Response.CountryDailyRevenue
	(*CWorkshop_GetPackageDailyRevenue_Response_CountryDailyRevenue)(nil), // 143: deadlock.CWorkshop_GetPackageDailyRevenue_Response.CountryDailyRevenue
	(*CMsgClientToGCCreateStaticRecipe_Item)(nil),                         // 144: deadlock.CMsgClientToGCCreateStaticRecipe.Item
	(*CMsgClientToGCCreateStaticRecipeResponse_OutputItem)(nil),           // 145: deadlock.CMsgClientToGCCreateStaticRecipeResponse.OutputItem
	(*CMsgClientToGCCreateStaticRecipeResponse_InputError)(nil),           // 146: deadlock.CMsgClientToGCCreateStaticRecipeResponse.InputError
	(*CMsgClientToGCCreateStaticRecipeResponse_AdditionalOutput)(nil),     // 147: deadlock.CMsgClientToGCCreateStaticRecipeResponse.AdditionalOutput
	(*CMsgProcessTransactionOrder_Item)(nil),                              // 148: deadlock.CMsgProcessTransactionOrder.Item
	(*CMsgGCToGCConsoleOutput_OutputLine)(nil),                            // 149: deadlock.CMsgGCToGCConsoleOutput.OutputLine
	(*CMsgItemAges_MaxItemIDTimestamp)(nil),                               // 150: deadlock.CMsgItemAges.MaxItemIDTimestamp
	(*CMsgGCToClientCurrencyPricePoints_Currency)(nil),                    // 151: deadlock.CMsgGCToClientCurrencyPricePoints.Currency
	(*CMsgGCToGCFlushSteamInventoryCache_Key)(nil),                        // 152: deadlock.CMsgGCToGCFlushSteamInventoryCache.Key
	(*CMsgClientToGCPurchaseChargeCostItems_Item)(nil),                    // 153: deadlock.CMsgClientToGCPurchaseChargeCostItems.Item
	(*CMsgGCToClientInFlightChargesUpdated_ItemCharges)(nil),              // 154: deadlock.CMsgGCToClientInFlightChargesUpdated.ItemCharges
	(*CSOEconItem)(nil),                                                   // 155: deadlock.CSOEconItem
	(EGCMsgResponse)(0),                                                   // 156: deadlock.EGCMsgResponse
	(*CExtraMsgBlock)(nil),                                                // 157: deadlock.CExtraMsgBlock
}
var file_econ_gcmessages_proto_depIdxs = []int32{
	134, // 0: deadlock.CMsgEconPlayerStrangeCountAdjustment.strange_count_adjustments:type_name -> deadlock.CMsgEconPlayerStrangeCountAdjustment.CStrangeCountAdjustment
	135, // 1: deadlock.CMsgGCRequestStoreSalesDataResponse.sale_price:type_name -> deadlock.CMsgGCRequestStoreSalesDataResponse.Price
	136, // 2: deadlock.CMsgLookupMultipleAccountNamesResponse.accounts:type_name -> deadlock.CMsgLookupMultipleAccountNamesResponse.Account
	155, // 3: deadlock.CMsgRequestCrateItemsResponse.peek_items:type_name -> deadlock.CSOEconItem
	137, // 4: deadlock.CMsgGCToGCGrantAccountRolledItems.items:type_name -> deadlock.CMsgGCToGCGrantAccountRolledItems.Item
	43,  // 5: deadlock.CMsgServerUseItem.use_item_msg:type_name -> deadlock.CMsgUseItem
	155, // 6: deadlock.CMsgGCAddGiftItem.wrapped_item:type_name -> deadlock.CSOEconItem
	156, // 7: deadlock.CMsgClientToGCWrapAndDeliverGiftResponse.response:type_name -> deadlock.EGCMsgResponse
	1,   // 8: deadlock.CMsgClientToGCWrapAndDeliverGiftResponse.trade_restriction:type_name -> deadlock.EGCMsgInitiateTradeResponse
	1,   // 9: deadlock.CMsgClientToGCGetGiftPermissionsResponse.sender_permission:type_name -> deadlock.EGCMsgInitiateTradeResponse
	140, // 10: deadlock.CMsgClientToGCGetGiftPermissionsResponse.friend_permissions:type_name -> deadlock.CMsgClientToGCGetGiftPermissionsResponse.FriendPermission
	5,   // 11: deadlock.CMsgClientToGCUnpackBundleResponse.response:type_name -> deadlock.CMsgClientToGCUnpackBundleResponse.EUnpackBundle
	6,   // 12: deadlock.CMsgClientToGCPackBundleResponse.response:type_name -> deadlock.CMsgClientToGCPackBundleResponse.EPackBundle
	16,  // 13: deadlock.CMsgClientToGCEquipItems.equips:type_name -> deadlock.CMsgAdjustItemEquippedState
	7,   // 14: deadlock.CMsgClientToGCSetItemStyleResponse.response:type_name -> deadlock.CMsgClientToGCSetItemStyleResponse.ESetStyle
	8,   // 15: deadlock.CMsgClientToGCUnlockItemStyleResponse.response:type_name -> deadlock.CMsgClientToGCUnlockItemStyleResponse.EUnlockStyle
	156, // 16: deadlock.CMsgClientToGCUnlockCrateResponse.result:type_name -> deadlock.EGCMsgResponse
	141, // 17: deadlock.CMsgClientToGCUnlockCrateResponse.granted_items:type_name -> deadlock.CMsgClientToGCUnlockCrateResponse.Item
	9,   // 18: deadlock.CMsgClientToGCRemoveItemAttributeResponse.response:type_name -> deadlock.CMsgClientToGCRemoveItemAttributeResponse.ERemoveItemAttribute
	10,  // 19: deadlock.CMsgClientToGCNameItemResponse.response:type_name -> deadlock.CMsgClientToGCNameItemResponse.ENameItem
	84,  // 20: deadlock.CProtoItemSocket_Empty.socket:type_name -> deadlock.CProtoItemSocket
	84,  // 21: deadlock.CProtoItemSocket_Effect.socket:type_name -> deadlock.CProtoItemSocket
	84,  // 22: deadlock.CProtoItemSocket_Color.socket:type_name -> deadlock.CProtoItemSocket
	84,  // 23: deadlock.CProtoItemSocket_Strange.socket:type_name -> deadlock.CProtoItemSocket
	84,  // 24: deadlock.CProtoItemSocket_Strange_DESERIALIZE_FROM_STRING_ONLY.socket:type_name -> deadlock.CProtoItemSocket
	84,  // 25: deadlock.CProtoItemSocket_Spectator.socket:type_name -> deadlock.CProtoItemSocket
	84,  // 26: deadlock.CProtoItemSocket_AssetModifier.socket:type_name -> deadlock.CProtoItemSocket
	84,  // 27: deadlock.CProtoItemSocket_AssetModifier_DESERIALIZE_FROM_STRING_ONLY.socket:type_name -> deadlock.CProtoItemSocket
	84,  // 28: deadlock.CProtoItemSocket_Autograph.socket:type_name -> deadlock.CProtoItemSocket
	84,  // 29: deadlock.CProtoItemSocket_StaticVisuals.socket:type_name -> deadlock.CProtoItemSocket
	142, // 30: deadlock.CWorkshop_GetItemDailyRevenue_Response.country_revenue:type_name -> deadlock.CWorkshop_GetItemDailyRevenue_Response.CountryDailyRevenue
	143, // 31: deadlock.CWorkshop_GetPackageDailyRevenue_Response.country_revenue:type_name -> deadlock.CWorkshop_GetPackageDailyRevenue_Response.CountryDailyRevenue
	144, // 32: deadlock.CMsgClientToGCCreateStaticRecipe.items:type_name -> deadlock.CMsgClientToGCCreateStaticRecipe.Item
	11,  // 33: deadlock.CMsgClientToGCCreateStaticRecipeResponse.response:type_name -> deadlock.CMsgClientToGCCreateStaticRecipeResponse.EResponse
	145, // 34: deadlock.CMsgClientToGCCreateStaticRecipeResponse.output_items:type_name -> deadlock.CMsgClientToGCCreateStaticRecipeResponse.OutputItem
	146, // 35: deadlock.CMsgClientToGCCreateStaticRecipeResponse.input_errors:type_name -> deadlock.CMsgClientToGCCreateStaticRecipeResponse.InputError
	147, // 36: deadlock.CMsgClientToGCCreateStaticRecipeResponse.additional_outputs:type_name -> deadlock.CMsgClientToGCCreateStaticRecipeResponse.AdditionalOutput
	148, // 37: deadlock.CMsgProcessTransactionOrder.items:type_name -> deadlock.CMsgProcessTransactionOrder.Item
	105, // 38: deadlock.CMsgGCToGCStoreProcessCDKeyTransaction.order:type_name -> deadlock.CMsgProcessTransactionOrder
	105, // 39: deadlock.CMsgGCToGCStoreProcessSettlement.order:type_name -> deadlock.CMsgProcessTransactionOrder
	149, // 40: deadlock.CMsgGCToGCConsoleOutput.msgs:type_name -> deadlock.CMsgGCToGCConsoleOutput.OutputLine
	150, // 41: deadlock.CMsgItemAges.max_item_id_timestamps:type_name -> deadlock.CMsgItemAges.MaxItemIDTimestamp
	151, // 42: deadlock.CMsgGCToClientCurrencyPricePoints.currencies:type_name -> deadlock.CMsgGCToClientCurrencyPricePoints.Currency
	152, // 43: deadlock.CMsgGCToGCFlushSteamInventoryCache.keys:type_name -> deadlock.CMsgGCToGCFlushSteamInventoryCache.Key
	12,  // 44: deadlock.CMsgClientToGCGetLimitedItemPurchaseQuantityResponse.result:type_name -> deadlock.CMsgClientToGCGetLimitedItemPurchaseQuantityResponse.EResponse
	13,  // 45: deadlock.CMsgClientToGCGetInFlightItemChargesResponse.result:type_name -> deadlock.CMsgClientToGCGetInFlightItemChargesResponse.EResponse
	153, // 46: deadlock.CMsgClientToGCPurchaseChargeCostItems.items:type_name -> deadlock.CMsgClientToGCPurchaseChargeCostItems.Item
	14,  // 47: deadlock.CMsgClientToGCPurchaseChargeCostItemsResponse.result:type_name -> deadlock.CMsgClientToGCPurchaseChargeCostItemsResponse.EResponse
	154, // 48: deadlock.CMsgGCToClientInFlightChargesUpdated.in_flight_charges:type_name -> deadlock.CMsgGCToClientInFlightChargesUpdated.ItemCharges
	157, // 49: deadlock.CMsgGCToGCUpdateWelcomeMsg.new_msg:type_name -> deadlock.CExtraMsgBlock
	138, // 50: deadlock.CMsgGCToGCGrantAccountRolledItems.Item.dynamic_attributes:type_name -> deadlock.CMsgGCToGCGrantAccountRolledItems.Item.DynamicAttribute
	139, // 51: deadlock.CMsgGCToGCGrantAccountRolledItems.Item.additional_audit_entries:type_name -> deadlock.CMsgGCToGCGrantAccountRolledItems.Item.AdditionalAuditEntry
	1,   // 52: deadlock.CMsgClientToGCGetGiftPermissionsResponse.FriendPermission.permission:type_name -> deadlock.EGCMsgInitiateTradeResponse
	11,  // 53: deadlock.CMsgClientToGCCreateStaticRecipeResponse.InputError.error:type_name -> deadlock.CMsgClientToGCCreateStaticRecipeResponse.EResponse
