...
type CMsgProtoBufHeader struct {
	...
	GcMsgSrc         *GCProtoBufMsgSrc      `protobuf:"varint,200,opt,name=gc_msg_src,json=gcMsgSrc,enum=deadlock.GCProtoBufMsgSrc,def=0" json:"gc_msg_src,omitempty"`
...
var file_steammessages_proto_extTypes = []protoimpl.ExtensionInfo{
	...
	},
	{
		...
		Field:         60000,
		Name:          "deadlock.msgpool_soft_limit",
	...
	},
	{
		...
		ExtensionType: (*int32)(nil),
		Field:         60001,
		Name:          "deadlock.msgpool_hard_limit",
...
const file_steammessages_proto_rawDesc = "" +
	"\n" +
	"\x13steammessages.proto\x12\bdeadlock\x1a google/protobuf/descriptor.proto\"\x83\x04\n" +
	...
	"\n" +
	"gc_msg_src\x18\xc8\x01 \x01(\x0e2\x1a.deadlock.GCProtoBufMsgSrc:\x1cGCProtoBufMsgSrc_UnspecifiedR\bgcMsgSrc\x122\n" +
	...
	"\x05infos\x18\x01 \x03(\v2\x19.deadlock.CIPLocationInfoR\x05infos*\x9d\x01\n" +
	...
	"\x12msgpool_hard_limit\x12\x1f.google.protobuf.MessageOptions\x18\xe1\xd4\x03 \x01(\x05:\x03384R\x10msgpoolHardLimitB4Z2github.com/RyPort/paradox-parser/deadlock;deadlock"
...
var file_steammessages_proto_goTypes = []any{
	(EGCPlatform)(0),                                // 0: deadlock.EGCPlatform
	(GCProtoBufMsgSrc)(0),                           // 1: deadlock.GCProtoBufMsgSrc
	(*CMsgProtoBufHeader)(nil),                      // 2: deadlock.CMsgProtoBufHeader
	(*CGCSystemMsg_GetAccountDetails)(nil),          // 3: deadlock.CGCSystemMsg_GetAccountDetails
	(*CGCSystemMsg_GetAccountDetails_Response)(nil), // 4: deadlock.CGCSystemMsg_GetAccountDetails_Response
	(*CIPLocationInfo)(nil),                         // 5: deadlock.CIPLocationInfo
	(*CGCMsgGetIPLocationResponse)(nil),             // 6: deadlock.CGCMsgGetIPLocationResponse
...
var file_steammessages_proto_depIdxs = []int32{
	1, // 0: deadlock.CMsgProtoBufHeader.gc_msg_src:type_name -> deadlock.GCProtoBufMsgSrc
	5, // 1: deadlock.CGCMsgGetIPLocationResponse.infos:type_name -> deadlock.CIPLocationInfo
	7, // 2: deadlock.key_field:extendee -> google.protobuf.FieldOptions
	8, // 3: deadlock.msgpool_soft_limit:extendee -> google.protobuf.MessageOptions
	8, // 4: deadlock.msgpool_hard_limit:extendee -> google.protobuf.MessageOptions
