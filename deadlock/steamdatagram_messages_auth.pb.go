...
const file_steamdatagram_messages_auth_proto_rawDesc = "" +
	"\n" +
	"!steamdatagram_messages_auth.proto\x12\bdeadlock\x1a+steamnetworkingsockets_messages_certs.proto\"\xa3\a\n" +
	...
	"\fvirtual_port\x18\n" +
	" \x01(\rR\vvirtualPort\x12X\n" +
	"\fextra_fields\x18\b \x03(\v25.deadlock.CMsgSteamDatagramRelayAuthTicket.ExtraFieldR\vextraFields\x12;\n" +
	...
	"int64Value\x12#\n" +
	"\rfixed64_value\x18\x05 \x01(\x06R\ffixed64Value\"\xe8\x01\n" +
	...
	"\x06key_id\x18\x02 \x01(\x06R\x05keyId\x12B\n" +
	"\x05certs\x18\x05 \x03(\v2,.deadlock.CMsgSteamDatagramCertificateSignedR\x05certs\"\x84\x01\n" +
	...
	"\x0edummy_steam_id\x18c \x01(\x06R\fdummySteamId\"\xa9\x01\n" +
	"1CMsgSteamDatagramSignedGameCoordinatorServerLogin\x12@\n" +
	"\x04cert\x18\x01 \x01(\v2,.deadlock.CMsgSteamDatagramCertificateSignedR\x04cert\x12\x14\n" +
	...
	"\x10protocol_version\x18\x05 \x01(\rR\x0fprotocolVersionB9H\x01Z2github.com/RyPort/paradox-parser/deadlock;deadlock\x80\x01\x00"
...
var file_steamdatagram_messages_auth_proto_goTypes = []any{
	(*CMsgSteamDatagramRelayAuthTicket)(nil),                  // 0: deadlock.CMsgSteamDatagramRelayAuthTicket
	(*CMsgSteamDatagramSignedRelayAuthTicket)(nil),            // 1: deadlock.CMsgSteamDatagramSignedRelayAuthTicket
	(*CMsgSteamDatagramCachedCredentialsForApp)(nil),          // 2: deadlock.CMsgSteamDatagramCachedCredentialsForApp
	(*CMsgSteamDatagramGameCoordinatorServerLogin)(nil),       // 3: deadlock.CMsgSteamDatagramGameCoordinatorServerLogin
	(*CMsgSteamDatagramSignedGameCoordinatorServerLogin)(nil), // 4: deadlock.CMsgSteamDatagramSignedGameCoordinatorServerLogin
	(*CMsgSteamDatagramHostedServerAddressPlaintext)(nil),     // 5: deadlock.CMsgSteamDatagramHostedServerAddressPlaintext
	(*CMsgSteamDatagramRelayAuthTicket_ExtraField)(nil),       // 6: deadlock.CMsgSteamDatagramRelayAuthTicket.ExtraField
	(*CMsgSteamDatagramCertificateSigned)(nil),                // 7: deadlock.CMsgSteamDatagramCertificateSigned
}
var file_steamdatagram_messages_auth_proto_depIdxs = []int32{
	6, // 0: deadlock.CMsgSteamDatagramRelayAuthTicket.extra_fields:type_name -> deadlock.CMsgSteamDatagramRelayAuthTicket.ExtraField
	7, // 1: deadlock.CMsgSteamDatagramSignedRelayAuthTicket.certs:type_name -> deadlock.CMsgSteamDatagramCertificateSigned
	7, // 2: deadlock.CMsgSteamDatagramSignedGameCoordinatorServerLogin.cert:type_name -> deadlock.CMsgSteamDatagramCertificateSigned
