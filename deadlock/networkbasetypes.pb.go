...
type CNETMsg_SignonState struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	SignonState       *SignonStateT          `protobuf:"varint,1,opt,name=signon_state,json=signonState,enum=deadlock.SignonStateT,def=0" json:"signon_state,omitempty"`
...
const file_networkbasetypes_proto_rawDesc = "" +
	"\n" +
	"\x16networkbasetypes.proto\x12\bdeadlock\x1a\x18network_connection.proto\"D\n" +
	"\n" +
	"CMsgVector\x12\f\n" +
	...
	"\rCMsgTransform\x120\n" +
	"\bposition\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\bposition\x12\x14\n" +
	"\x05scale\x18\x02 \x01(\x02R\x05scale\x12:\n" +
	"\vorientation\x18\x03 \x01(\v2\x18.deadlock.CMsgQuaternionR\vorientation\"B\n" +
	"\bCMsgRGBA\x12\f\n" +
	...
	"\n" +
	"CMsg_CVars\x12/\n" +
	"\x05cvars\x18\x01 \x03(\v2\x19.deadlock.CMsg_CVars.CVarR\x05cvars\x1a0\n" +
	"\x04CVar\x12\x12\n" +
	...
	"\x0fprediction_sync\x18\x02 \x01(\rR\x0epredictionSync\"C\n" +
	"\x11CNETMsg_SetConVar\x12.\n" +
	"\aconvars\x18\x01 \x01(\v2\x14.deadlock.CMsg_CVarsR\aconvars\"\x94\x02\n" +
	"\x13CNETMsg_SignonState\x12L\n" +
	"\fsignon_state\x18\x01 \x01(\x0e2\x17.deadlock.SignonState_t:\x10SIGNONSTATE_NONER\vsignonState\x12\x1f\n" +
	...
	"\x04keys\x18\x03 \x03(\v2!.deadlock.CSVCMsg_GameEvent.key_tR\x04keys\x1a\xe4\x01\n" +
	"\x05key_t\x12\x12\n" +
	...
	"\x06events\x18\x01 \x03(\v2(.deadlock.CSVCMsgList_GameEvents.event_tR\x06events\x1aP\n" +
	"\aevent_t\x12\x12\n" +
	"\x04tick\x18\x01 \x01(\x05R\x04tick\x121\n" +
	"\x05event\x18\x02 \x01(\v2\x1b.deadlock.CSVCMsg_GameEventR\x05event\"\x91\a\n" +
	...
	"\x10world_offset_pos\x18\x06 \x01(\v2\x14.deadlock.CMsgVectorR\x0eworldOffsetPos\x12B\n" +
	"\x12world_offset_angle\x18\a \x01(\v2\x14.deadlock.CMsgQAngleR\x10worldOffsetAngle\x12.\n" +
	...
	"\avectors\x18\x02 \x03(\v2\x14.deadlock.CMsgVectorR\avectors\x12*\n" +
	"\x06colors\x18\x03 \x03(\v2\x12.deadlock.CMsgRGBAR\x06colors\x12\x1e\n" +
	"\n" +
	...
	"\"SPAWN_GROUP_CREATE_NEW_SCENE_WORLD\x10\x80\x02B4Z2github.com/RyPort/paradox-parser/deadlock;deadlock"
...
var file_networkbasetypes_proto_goTypes = []any{
	(SignonStateT)(0),                          // 0: deadlock.SignonState_t
	(NET_Messages)(0),                          // 1: deadlock.NET_Messages
	(SpawnGroupFlagsT)(0),                      // 2: deadlock.SpawnGroupFlags_t
	(*CMsgVector)(nil),                         // 3: deadlock.CMsgVector
	(*CMsgVector2D)(nil),                       // 4: deadlock.CMsgVector2D
	(*CMsgQAngle)(nil),                         // 5: deadlock.CMsgQAngle
	(*CMsgQuaternion)(nil),                     // 6: deadlock.CMsgQuaternion
	(*CMsgTransform)(nil),                      // 7: deadlock.CMsgTransform
	(*CMsgRGBA)(nil),                           // 8: deadlock.CMsgRGBA
	(*CMsgPlayerInfo)(nil),                     // 9: deadlock.CMsgPlayerInfo
	(*CEntityMsg)(nil),                         // 10: deadlock.CEntityMsg
	(*CMsg_CVars)(nil),                         // 11: deadlock.CMsg_CVars
	(*CNETMsg_NOP)(nil),                        // 12: deadlock.CNETMsg_NOP
	(*CNETMsg_SplitScreenUser)(nil),            // 13: deadlock.CNETMsg_SplitScreenUser
	(*CNETMsg_Tick)(nil),                       // 14: deadlock.CNETMsg_Tick
	(*CNETMsg_StringCmd)(nil),                  // 15: deadlock.CNETMsg_StringCmd
	(*CNETMsg_SetConVar)(nil),                  // 16: deadlock.CNETMsg_SetConVar
	(*CNETMsg_SignonState)(nil),                // 17: deadlock.CNETMsg_SignonState
	(*CSVCMsg_GameEvent)(nil),                  // 18: deadlock.CSVCMsg_GameEvent
	(*CSVCMsgList_GameEvents)(nil),             // 19: deadlock.CSVCMsgList_GameEvents
	(*CNETMsg_SpawnGroup_Load)(nil),            // 20: deadlock.CNETMsg_SpawnGroup_Load
	(*CNETMsg_SpawnGroup_ManifestUpdate)(nil),  // 21: deadlock.CNETMsg_SpawnGroup_ManifestUpdate
	(*CNETMsg_SpawnGroup_SetCreationTick)(nil), // 22: deadlock.CNETMsg_SpawnGroup_SetCreationTick
	(*CNETMsg_SpawnGroup_Unload)(nil),          // 23: deadlock.CNETMsg_SpawnGroup_Unload
	(*CNETMsg_SpawnGroup_LoadCompleted)(nil),   // 24: deadlock.CNETMsg_SpawnGroup_LoadCompleted
	(*CSVCMsg_GameSessionConfiguration)(nil),   // 25: deadlock.CSVCMsg_GameSessionConfiguration
	(*CNETMsg_DebugOverlay)(nil),               // 26: deadlock.CNETMsg_DebugOverlay
	(*CMsg_CVars_CVar)(nil),                    // 27: deadlock.CMsg_CVars.CVar
	(*CSVCMsg_GameEventKeyT)(nil),              // 28: deadlock.CSVCMsg_GameEvent.key_t
	(*CSVCMsgList_GameEventsEventT)(nil),       // 29: deadlock.CSVCMsgList_GameEvents.event_t
}
var file_networkbasetypes_proto_depIdxs = []int32{
	3,  // 0: deadlock.CMsgTransform.position:type_name -> deadlock.CMsgVector
	6,  // 1: deadlock.CMsgTransform.orientation:type_name -> deadlock.CMsgQuaternion
	27, // 2: deadlock.CMsg_CVars.cvars:type_name -> deadlock.CMsg_CVars.CVar
	11, // 3: deadlock.CNETMsg_SetConVar.convars:type_name -> deadlock.CMsg_CVars
	0,  // 4: deadlock.CNETMsg_SignonState.signon_state:type_name -> deadlock.SignonState_t
	28, // 5: deadlock.CSVCMsg_GameEvent.keys:type_name -> deadlock.CSVCMsg_GameEvent.key_t
	29, // 6: deadlock.CSVCMsgList_GameEvents.events:type_name -> deadlock.CSVCMsgList_GameEvents.event_t
	3,  // 7: deadlock.CNETMsg_SpawnGroup_Load.world_offset_pos:type_name -> deadlock.CMsgVector
	5,  // 8: deadlock.CNETMsg_SpawnGroup_Load.world_offset_angle:type_name -> deadlock.CMsgQAngle
	3,  // 9: deadlock.CNETMsg_DebugOverlay.vectors:type_name -> deadlock.CMsgVector
	8,  // 10: deadlock.CNETMsg_DebugOverlay.colors:type_name -> deadlock.CMsgRGBA
	18, // 11: deadlock.CSVCMsgList_GameEvents.event_t.event:type_name -> deadlock.CSVCMsg_GameEvent
