...
var file_network_connection_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Field:         50500,
		Name:          "deadlock.network_connection_token",
	...
	},
	{
		...
		ExtensionType: (*string)(nil),
		Field:         50501,
		Name:          "deadlock.network_connection_detail_token",
	...
	},
	{
		...
		Field:         50502,
		Name:          "deadlock.allowed_from_client",
...
const file_network_connection_proto_rawDesc = "" +
	"\n" +
	"\x18network_connection.proto\x12\bdeadlock\x1a google/protobuf/descriptor.proto*\xb0M\n" +
	...
	"\x13allowed_from_client\x12!.google.protobuf.EnumValueOptions\x18Ɗ\x03 \x01(\b:\x04trueR\x11allowedFromClientB4Z2github.com/RyPort/paradox-parser/deadlock;deadlock"
...
var file_network_connection_proto_goTypes = []any{
	(ENetworkDisconnectionReason)(0),    // 0: deadlock.ENetworkDisconnectionReason
	(*descriptor.EnumValueOptions)(nil), // 1: google.protobuf.EnumValueOptions
}
var file_network_connection_proto_depIdxs = []int32{
	1, // 0: deadlock.network_connection_token:extendee -> google.protobuf.EnumValueOptions
	1, // 1: deadlock.network_connection_detail_token:extendee -> google.protobuf.EnumValueOptions
	1, // 2: deadlock.allowed_from_client:extendee -> google.protobuf.EnumValueOptions
