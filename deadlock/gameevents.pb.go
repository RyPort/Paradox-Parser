...
const file_gameevents_proto_rawDesc = "" +
	"\n" +
	"\x10gameevents.proto\x12\bdeadlock\x1a\x16networkbasetypes.proto\"`\n" +
	"\x1cCMsgVDebugGameSessionIDEvent\x12\x1a\n" +
	"\bclientid\x18\x01 \x01(\x05R\bclientid\x12$\n" +
	"\rgamesessionid\x18\x02 \x01(\tR\rgamesessionid\"\xcf\x03\n" +
	"\x13CMsgPlaceDecalEvent\x120\n" +
	"\bposition\x18\x01 \x01(\v2\x14.deadlock.CMsgVectorR\bposition\x12,\n" +
	"\x06normal\x18\x02 \x01(\v2\x14.deadlock.CMsgVectorR\x06normal\x12*\n" +
	"\x05saxis\x18\x03 \x01(\v2\x14.deadlock.CMsgVectorR\x05saxis\x12\x1c\n" +
	"\tboneindex\x18\x04 \x01(\x05R\tboneindex\x12\x14\n" +
	...
	"\fentityhandle\x18\x02 \x01(\r:\b16777215R\fentityhandle\"\xad\x02\n" +
	"\x1eCMsgSource1LegacyGameEventList\x12W\n" +
	"\vdescriptors\x18\x01 \x03(\v25.deadlock.CMsgSource1LegacyGameEventList.descriptor_tR\vdescriptors\x1a/\n" +
	"\x05key_t\x12\x12\n" +
	...
	"\x04keys\x18\x03 \x03(\v2..deadlock.CMsgSource1LegacyGameEventList.key_tR\x04keys\"g\n" +
	"\x1dCMsgSource1LegacyListenEvents\x12\x1e\n" +
	"\n" +
	"playerslot\x18\x01 \x01(\x05R\n" +
	"playerslot\x12&\n" +
	"\x0eeventarraybits\x18\x02 \x03(\rR\x0eeventarraybits\"\xbf\x03\n" +
	"\x1aCMsgSource1LegacyGameEvent\x12\x1d\n" +
	"\n" +
	"event_name\x18\x01 \x01(\tR\teventName\x12\x18\n" +
	"\aeventid\x18\x02 \x01(\x05R\aeventid\x12>\n" +
	"\x04keys\x18\x03 \x03(\v2*.deadlock.CMsgSource1LegacyGameEvent.key_tR\x04keys\x12\x1f\n" +
	...
	"\x18GE_SosStopSoundEventHash\x10\xd4\x01B4Z2github.com/RyPort/paradox-parser/deadlock;deadlock"
...
var file_gameevents_proto_goTypes = []any{
	(EBaseGameEvents)(0),                              // 0: deadlock.EBaseGameEvents
	(*CMsgVDebugGameSessionIDEvent)(nil),              // 1: deadlock.CMsgVDebugGameSessionIDEvent
	(*CMsgPlaceDecalEvent)(nil),                       // 2: deadlock.CMsgPlaceDecalEvent
	(*CMsgClearWorldDecalsEvent)(nil),                 // 3: deadlock.CMsgClearWorldDecalsEvent
	(*CMsgClearEntityDecalsEvent)(nil),                // 4: deadlock.CMsgClearEntityDecalsEvent
	(*CMsgClearDecalsForEntityEvent)(nil),             // 5: deadlock.CMsgClearDecalsForEntityEvent
	(*CMsgSource1LegacyGameEventList)(nil),            // 6: deadlock.CMsgSource1LegacyGameEventList
	(*CMsgSource1LegacyListenEvents)(nil),             // 7: deadlock.CMsgSource1LegacyListenEvents
	(*CMsgSource1LegacyGameEvent)(nil),                // 8: deadlock.CMsgSource1LegacyGameEvent
	(*CMsgSosStartSoundEvent)(nil),                    // 9: deadlock.CMsgSosStartSoundEvent
	(*CMsgSosStopSoundEvent)(nil),                     // 10: deadlock.CMsgSosStopSoundEvent
	(*CMsgSosStopSoundEventHash)(nil),                 // 11: deadlock.CMsgSosStopSoundEventHash
	(*CMsgSosSetSoundEventParams)(nil),                // 12: deadlock.CMsgSosSetSoundEventParams
	(*CMsgSosSetLibraryStackFields)(nil),              // 13: deadlock.CMsgSosSetLibraryStackFields
	(*CMsgSource1LegacyGameEventListKeyT)(nil),        // 14: deadlock.CMsgSource1LegacyGameEventList.key_t
	(*CMsgSource1LegacyGameEventListDescriptorT)(nil), // 15: deadlock.CMsgSource1LegacyGameEventList.descriptor_t
	(*CMsgSource1LegacyGameEventKeyT)(nil),            // 16: deadlock.CMsgSource1LegacyGameEvent.key_t
	(*CMsgVector)(nil),                                // 17: deadlock.CMsgVector
}
var file_gameevents_proto_depIdxs = []int32{
	17, // 0: deadlock.CMsgPlaceDecalEvent.position:type_name -> deadlock.CMsgVector
	17, // 1: deadlock.CMsgPlaceDecalEvent.normal:type_name -> deadlock.CMsgVector
	17, // 2: deadlock.CMsgPlaceDecalEvent.saxis:type_name -> deadlock.CMsgVector
	15, // 3: deadlock.CMsgSource1LegacyGameEventList.descriptors:type_name -> deadlock.CMsgSource1LegacyGameEventList.descriptor_t
	16, // 4: deadlock.CMsgSource1LegacyGameEvent.keys:type_name -> deadlock.CMsgSource1LegacyGameEvent.key_t
	14, // 5: deadlock.CMsgSource1LegacyGameEventList.descriptor_t.keys:type_name -> deadlock.CMsgSource1LegacyGameEventList.key_t
