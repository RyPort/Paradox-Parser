...
type CClientMsg_ClientUIEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Event         *EClientUIEvent        `protobuf:"varint,1,opt,name=event,enum=deadlock.EClientUIEvent,def=0" json:"event,omitempty"`
...
const file_clientmessages_proto_rawDesc = "" +
	"\n" +
	"\x14clientmessages.proto\x12\bdeadlock\"O\n" +
	...
	"playerSlot\"\xd6\x01\n" +
	"\x18CClientMsg_ClientUIEvent\x12F\n" +
	"\x05event\x18\x01 \x01(\x0e2\x18.deadlock.EClientUIEvent:\x16EClientUIEvent_InvalidR\x05event\x12\x1f\n" +
	...
	"\x05angle\x18\x01 \x01(\x02R\x05angle\"H\n" +
	"!CClientMsg_ListenForResponseFound\x12#\n" +
	...
	"\x19EClientUIEvent_FireOutput\x10\x02B4Z2github.com/RyPort/paradox-parser/deadlock;deadlock"
...
var file_clientmessages_proto_goTypes = []any{
	(EBaseClientMessages)(0),                                 // 0: deadlock.EBaseClientMessages
	(EClientUIEvent)(0),                                      // 1: deadlock.EClientUIEvent
	(*CClientMsg_CustomGameEvent)(nil),                       // 2: deadlock.CClientMsg_CustomGameEvent
	(*CClientMsg_CustomGameEventBounce)(nil),                 // 3: deadlock.CClientMsg_CustomGameEventBounce
	(*CClientMsg_ClientUIEvent)(nil),                         // 4: deadlock.CClientMsg_ClientUIEvent
	(*CClientMsg_DevPaletteVisibilityChangedEvent)(nil),      // 5: deadlock.CClientMsg_DevPaletteVisibilityChangedEvent
	(*CClientMsg_WorldUIControllerHasPanelChangedEvent)(nil), // 6: deadlock.CClientMsg_WorldUIControllerHasPanelChangedEvent
	(*CClientMsg_RotateAnchor)(nil),                          // 7: deadlock.CClientMsg_RotateAnchor
	(*CClientMsg_ListenForResponseFound)(nil),                // 8: deadlock.CClientMsg_ListenForResponseFound
}
var file_clientmessages_proto_depIdxs = []int32{
	1, // 0: deadlock.CClientMsg_ClientUIEvent.event:type_name -> deadlock.EClientUIEvent
