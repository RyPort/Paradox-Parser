...
const file_enums_clientserver_proto_rawDesc = "" +
	"\n" +
	"\x18enums_clientserver.proto\x12\bdeadlock*\xf6\x9d\x03\n" +
	"\x04EMsg\x12\x11\n" +
	...
	"\x18k_ESteamReviewScore_None\x10\x00B9H\x01Z2github.com/RyPort/paradox-parser/deadlock;deadlock\x80\x01\x00"
...
var file_enums_clientserver_proto_goTypes = []any{
	(EMsg)(0),                    // 0: deadlock.EMsg
	(EClientPersonaStateFlag)(0), // 1: deadlock.EClientPersonaStateFlag
	(EMsgClanAccountFlags)(0),    // 2: deadlock.EMsgClanAccountFlags
	(ESteamReviewScore)(0),       // 3: deadlock.ESteamReviewScore
}
