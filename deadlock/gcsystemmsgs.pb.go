...
const file_gcsystemmsgs_proto_rawDesc = "" +
	"\n" +
	"\x12gcsystemmsgs.proto\x12\bdeadlock*\xf0\x01\n" +
	"\x06ESOMsg\x12\x13\n" +
	...
	"\x1ek_EMsgGCServerConnectionStatus\x10\xaa\x1fB4Z2github.com/RyPort/paradox-parser/deadlock;deadlock"
...
var file_gcsystemmsgs_proto_goTypes = []any{
	(ESOMsg)(0),           // 0: deadlock.ESOMsg
	(EGCBaseClientMsg)(0), // 1: deadlock.EGCBaseClientMsg
}
