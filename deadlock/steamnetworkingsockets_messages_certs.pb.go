...
type CMsgSteamDatagramCertificate struct {
	state                   protoimpl.MessageState                   `protogen:"open.v1"`
	KeyType                 *CMsgSteamDatagramCertificate_EKeyType   `protobuf:"varint,1,opt,name=key_type,json=keyType,enum=deadlock.CMsgSteamDatagramCertificate_EKeyType,def=0" json:"key_type,omitempty"`
...
const file_steamnetworkingsockets_messages_certs_proto_rawDesc = "" +
	"\n" +
	"+steamnetworkingsockets_messages_certs.proto\x12\bdeadlock\"\xb4\x01\n" +
	...
	"\ripv6_and_port\x18\x04 \x01(\fR\vipv6AndPort\"\xaa\x04\n" +
	"\x1cCMsgSteamDatagramCertificate\x12S\n" +
	"\bkey_type\x18\x01 \x01(\x0e2/.deadlock.CMsgSteamDatagramCertificate.EKeyType:\aINVALIDR\akeyType\x12\x19\n" +
	"\bkey_data\x18\x02 \x01(\fR\akeyData\x12&\n" +
	"\x0flegacy_steam_id\x18\x04 \x01(\x06R\rlegacySteamId\x12g\n" +
	"\x16legacy_identity_binary\x18\v \x01(\v21.deadlock.CMsgSteamNetworkingIdentityLegacyBinaryR\x14legacyIdentityBinary\x12'\n" +
	...
	"\x10private_key_data\x18\x01 \x01(\fR\x0eprivateKeyData\"a\n" +
	"#CMsgSteamDatagramCertificateRequest\x12:\n" +
	"\x04cert\x18\x01 \x01(\v2&.deadlock.CMsgSteamDatagramCertificateR\x04certB9H\x01Z2github.com/RyPort/paradox-parser/deadlock;deadlock\x80\x01\x00"
...
var file_steamnetworkingsockets_messages_certs_proto_goTypes = []any{
	(CMsgSteamDatagramCertificate_EKeyType)(0),      // 0: deadlock.CMsgSteamDatagramCertificate.EKeyType
	(*CMsgSteamNetworkingIdentityLegacyBinary)(nil), // 1: deadlock.CMsgSteamNetworkingIdentityLegacyBinary
	(*CMsgSteamDatagramCertificate)(nil),            // 2: deadlock.CMsgSteamDatagramCertificate
	(*CMsgSteamDatagramCertificateSigned)(nil),      // 3: deadlock.CMsgSteamDatagramCertificateSigned
	(*CMsgSteamDatagramCertificateRequest)(nil),     // 4: deadlock.CMsgSteamDatagramCertificateRequest
}
var file_steamnetworkingsockets_messages_certs_proto_depIdxs = []int32{
	0, // 0: deadlock.CMsgSteamDatagramCertificate.key_type:type_name -> deadlock.CMsgSteamDatagramCertificate.EKeyType
	1, // 1: deadlock.CMsgSteamDatagramCertificate.legacy_identity_binary:type_name -> deadlock.CMsgSteamNetworkingIdentityLegacyBinary
	2, // 2: deadlock.CMsgSteamDatagramCertificateRequest.cert:type_name -> deadlock.CMsgSteamDatagramCertificate
