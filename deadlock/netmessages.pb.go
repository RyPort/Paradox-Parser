...
type CMsgVoiceAudio struct {
	state                    protoimpl.MessageState `protogen:"open.v1"`
	Format                   *VoiceDataFormatT      `protobuf:"varint,1,opt,name=format,enum=deadlock.VoiceDataFormatT,def=0" json:"format,omitempty"`
...
type CCLCMsg_RequestPause struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PauseType     *RequestPauseT         `protobuf:"varint,1,opt,name=pause_type,json=pauseType,enum=deadlock.RequestPauseT,def=0" json:"pause_type,omitempty"`
...
type CSVCMsg_Prefetch struct {
	...
	ResourceType  *PrefetchType          `protobuf:"varint,2,opt,name=resource_type,json=resourceType,enum=deadlock.PrefetchType,def=0" json:"resource_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CSVCMsg_SplitScreen struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	Type          *ESplitScreenMessageType `protobuf:"varint,1,opt,name=type,enum=deadlock.ESplitScreenMessageType,def=0" json:"type,omitempty"`
...
const file_netmessages_proto_rawDesc = "" +
	"\n" +
	"\x11netmessages.proto\x12\bdeadlock\x1a\x16networkbasetypes.proto\"\xb8\x01\n" +
	...
	"\x13last_command_number\x18\x04 \x01(\rR\x11lastCommandNumber\"\x96\x03\n" +
	"\x0eCMsgVoiceAudio\x12K\n" +
	"\x06format\x18\x01 \x01(\x0e2\x1b.deadlock.VoiceDataFormat_t:\x16VOICEDATA_FORMAT_STEAMR\x06format\x12\x1d\n" +
	"\n" +
	...
	"\x05audio\x18\x01 \x01(\v2\x18.deadlock.CMsgVoiceAudioR\x05audio\x12\x12\n" +
	...
	"simplified\"z\n" +
	"\x14CCLCMsg_RequestPause\x12A\n" +
	"\n" +
	"pause_type\x18\x01 \x01(\x0e2\x18.deadlock.RequestPause_t:\bRP_PAUSER\tpauseType\x12\x1f\n" +
	...
	"\x14usec_1secmax_p99_all\x18, \x01(\rR\x11usec1secmaxP99All\"\xc7\x01\n" +
	"\x1aCMsgSource2VProfLiteReport\x12>\n" +
	"\x05total\x18\x01 \x01(\v2(.deadlock.CMsgSource2VProfLiteReportItemR\x05total\x12>\n" +
	"\x05items\x18\x02 \x03(\v2(.deadlock.CMsgSource2VProfLiteReportItemR\x05items\x12)\n" +
	...
	"\x0erecvmargin_p95\x18B \x01(\x11R\rrecvmarginP95\"\xc2\x02\n" +
	"\x12CCLCMsg_Diagnostic\x12C\n" +
	"\fsystem_specs\x18\x01 \x01(\v2 .deadlock.CMsgSource2SystemSpecsR\vsystemSpecs\x12G\n" +
	"\fvprof_report\x18\x02 \x01(\v2$.deadlock.CMsgSource2VProfLiteReportR\vvprofReport\x12P\n" +
	"\x0fdownstream_flow\x18\x03 \x01(\v2'.deadlock.CMsgSource2NetworkFlowQualityR\x0edownstreamFlow\x12L\n" +
	"\rupstream_flow\x18\x04 \x01(\v2'.deadlock.CMsgSource2NetworkFlowQualityR\fupstreamFlow\"\xcb\x05\n" +
	...
	"\fserver_popid\x18\x04 \x01(\aR\vserverPopid\x12K\n" +
	"\x0eserver_profile\x18\n" +
	" \x01(\v2$.deadlock.CMsgSource2VProfLiteReportR\rserverProfile\x12X\n" +
	"\aclients\x18\v \x03(\v2>.deadlock.CSource2Metrics_MatchPerfSummary_Notification.ClientR\aclients\x12\x10\n" +
	"\x03map\x18\x14 \x01(\tR\x03map\x1a\xe2\x02\n" +
	"\x06Client\x12C\n" +
	"\fsystem_specs\x18\x01 \x01(\v2 .deadlock.CMsgSource2SystemSpecsR\vsystemSpecs\x12>\n" +
	"\aprofile\x18\x02 \x01(\v2$.deadlock.CMsgSource2VProfLiteReportR\aprofile\x12\x19\n" +
	"\bbuild_id\x18\x03 \x01(\rR\abuildId\x12P\n" +
	"\x0fdownstream_flow\x18\x04 \x01(\v2'.deadlock.CMsgSource2NetworkFlowQualityR\x0edownstreamFlow\x12L\n" +
	"\rupstream_flow\x18\x05 \x01(\v2'.deadlock.CMsgSource2NetworkFlowQualityR\fupstreamFlow\x12\x18\n" +
	"\asteamid\x18\n" +
	" \x01(\x06R\asteamid\"\xcb\x04\n" +
	...
	"\n" +
	"addon_name\x18\x12 \x01(\tR\taddonName\x12Z\n" +
	"\x13game_session_config\x18\x13 \x01(\v2*.deadlock.CSVCMsg_GameSessionConfigurationR\x11gameSessionConfig\x122\n" +
	"\x15game_session_manifest\x18\x14 \x01(\fR\x13gameSessionManifest\"\xc1\x01\n" +
	"\x11CSVCMsg_ClassInfo\x12(\n" +
	"\x10create_on_client\x18\x01 \x01(\bR\x0ecreateOnClient\x12=\n" +
	"\aclasses\x18\x02 \x03(\v2#.deadlock.CSVCMsg_ClassInfo.class_tR\aclasses\x1aC\n" +
	"\aclass_t\x12\x19\n" +
	...
	"\x04text\x18\x01 \x01(\tR\x04text\"\xd5\x05\n" +
	"\x0eCSVCMsg_Sounds\x12%\n" +
	"\x0ereliable_sound\x18\x01 \x01(\bR\rreliableSound\x12<\n" +
	"\x06sounds\x18\x02 \x03(\v2$.deadlock.CSVCMsg_Sounds.sounddata_tR\x06sounds\x1a\xdd\x04\n" +
	...
	"\x11sound_resource_id\x18\x13 \x01(\x06R\x0fsoundResourceId\"{\n" +
	"\x10CSVCMsg_Prefetch\x12\x1f\n" +
	"\vsound_index\x18\x01 \x01(\x05R\n" +
	"soundIndex\x12F\n" +
	"\rresource_type\x18\x02 \x01(\x0e2\x16.deadlock.PrefetchType:\tPFT_SOUNDR\fresourceType\"P\n" +
	"\x0fCSVCMsg_SetView\x12%\n" +
	"\fentity_index\x18\x01 \x01(\x05:\x02-1R\ventityIndex\x12\x16\n" +
	"\x04slot\x18\x02 \x01(\x05:\x02-1R\x04slot\"Z\n" +
	"\x10CSVCMsg_FixAngle\x12\x1a\n" +
	"\brelative\x18\x01 \x01(\bR\brelative\x12*\n" +
	"\x05angle\x18\x02 \x01(\v2\x14.deadlock.CMsgQAngleR\x05angle\"D\n" +
	"\x16CSVCMsg_CrosshairAngle\x12*\n" +
	"\x05angle\x18\x01 \x01(\v2\x14.deadlock.CMsgQAngleR\x05angle\"\xd5\x01\n" +
	...
	"modelIndex\x12!\n" +
	"\flow_priority\x18\x05 \x01(\bR\vlowPriority\"\xa0\x01\n" +
	"\x13CSVCMsg_SplitScreen\x12N\n" +
	"\x04type\x18\x01 \x01(\x0e2!.deadlock.ESplitScreenMessageType:\x17MSG_SPLITSCREEN_ADDUSERR\x04type\x12\x12\n" +
	...
	"\vpassthrough\x18\x03 \x01(\x05R\vpassthrough\"\xb6\x03\n" +
	...
	"\x05props\x18\x04 \x03(\v2&.deadlock.CSVCMsg_SendTable.sendprop_tR\x05props\x1a\x80\x02\n" +
	"\n" +
	"sendprop_t\x12\x12\n" +
	...
	"\bnum_bits\x18\t \x01(\x05R\anumBits\"\x91\x02\n" +
	"\x15CSVCMsg_GameEventList\x12N\n" +
	"\vdescriptors\x18\x01 \x03(\v2,.deadlock.CSVCMsg_GameEventList.descriptor_tR\vdescriptors\x1a/\n" +
	"\x05key_t\x12\x12\n" +
	...
	"\x04keys\x18\x03 \x03(\v2%.deadlock.CSVCMsg_GameEventList.key_tR\x04keys\"\xd9\v\n" +
	...
	"serverTick\x12/\n" +
	"\x13serialized_entities\x18\r \x01(\fR\x12serializedEntities\x12f\n" +
	"\x13alternate_baselines\x18\x0f \x03(\v25.deadlock.CSVCMsg_PacketEntities.alternate_baseline_tR\x12alternateBaselines\x12<\n" +
	"\x1bhas_pvs_vis_bits_deprecated\x18\x10 \x01(\rR\x17hasPvsVisBitsDeprecated\x12*\n" +
	"\x0fcmd_recv_status\x18\x16 \x03(\x11B\x02\x10\x01R\rcmdRecvStatus\x12u\n" +
	"\x18non_transmitted_entities\x18\x13 \x01(\v2;.deadlock.CSVCMsg_PacketEntities.non_transmitted_entities_tR\x16nonTransmittedEntities\x127\n" +
	"\x18cq_starved_command_ticks\x18\x14 \x01(\rR\x15cqStarvedCommandTicks\x12;\n" +
	"\x1acq_discarded_command_ticks\x18\x15 \x01(\rR\x17cqDiscardedCommandTicks\x12r\n" +
	"\x17outofpvs_entity_updates\x18\x17 \x01(\v2:.deadlock.CSVCMsg_PacketEntities.outofpvs_entity_updates_tR\x15outofpvsEntityUpdates\x12 \n" +
	...
	"\x05audio\x18\x01 \x01(\v2\x18.deadlock.CMsgVoiceAudioR\x05audio\x12\x1a\n" +
	...
	"\n" +
	"process_id\x18\x02 \x01(\rR\tprocessId\"\xf5\x01\n" +
	"\x0eCMsgServerPeer\x12#\n" +
	"\vplayer_slot\x18\x01 \x01(\x05:\x02-1R\n" +
	"playerSlot\x12\x18\n" +
	"\asteamid\x18\x02 \x01(\x06R\asteamid\x12*\n" +
	"\x03ipc\x18\x03 \x01(\v2\x18.deadlock.CMsgIPCAddressR\x03ipc\x12\"\n" +
	...
	"\x04peer\x18\x01 \x03(\v2\x18.deadlock.CMsgServerPeerR\x04peer\"l\n" +
	"\x1cCSVCMsg_ClearAllStringTables\x12\x18\n" +
	"\amapname\x18\x01 \x01(\tR\amapname\x122\n" +
	"\x15create_tables_skipped\x18\x03 \x01(\bR\x13createTablesSkipped\"\xf7\x05\n" +
	...
	" \x01(\x05R\rvarEncoderSym\x12j\n" +
	"\x11polymorphic_types\x18\v \x03(\v2=.deadlock.ProtoFlattenedSerializerField_t.polymorphic_field_tR\x10polymorphicTypes\x12,\n" +
	...
	"\ffields_index\x18\x03 \x03(\x05R\vfieldsIndex\"\xc2\x01\n" +
	"\x1bCSVCMsg_FlattenedSerializer\x12F\n" +
	"\vserializers\x18\x01 \x03(\v2$.deadlock.ProtoFlattenedSerializer_tR\vserializers\x12\x18\n" +
	"\asymbols\x18\x02 \x03(\tR\asymbols\x12A\n" +
	"\x06fields\x18\x03 \x03(\v2).deadlock.ProtoFlattenedSerializerField_tR\x06fields\"'\n" +
	...
	"\x05ports\x18\x11 \x03(\v2%.deadlock.CMsgServerNetworkStats.PortR\x05ports\x12\x1e\n" +
	...
	"\x11total_packets_out\x18\x1d \x01(\x04R\x0ftotalPacketsOut\x12A\n" +
	"\aplayers\x18\x1e \x03(\v2'.deadlock.CMsgServerNetworkStats.PlayerR\aplayers\x1a.\n" +
	"\x04Port\x12\x12\n" +
	...
	"\x03cmd\x18\x01 \x01(\tR\x03cmd\"\xed\x02\n" +
	"\x1dCCLCMsg_HltvFixupOperatorTick\x12\x12\n" +
	"\x04tick\x18\x01 \x01(\x05R\x04tick\x12\x1d\n" +
	"\n" +
	"props_data\x18\x02 \x01(\fR\tpropsData\x12,\n" +
	"\x06origin\x18\x03 \x01(\v2\x14.deadlock.CMsgVectorR\x06origin\x123\n" +
	"\n" +
	"eye_angles\x18\x04 \x01(\v2\x14.deadlock.CMsgQAngleR\teyeAngles\x12#\n" +
	"\robserver_mode\x18\x05 \x01(\x05R\fobserverMode\x121\n" +
	"\x14cameraman_scoreboard\x18\x06 \x01(\bR\x13cameramanScoreboard\x12'\n" +
	"\x0fobserver_target\x18\a \x01(\x05R\x0eobserverTarget\x125\n" +
	"\vview_offset\x18\b \x01(\v2\x14.deadlock.CMsgVectorR\n" +
	"viewOffset\"k\n" +
	...
	"clientTick\"O\n" +
	"\x14CSVCMsg_UserCommands\x127\n" +
	"\bcommands\x18\x01 \x03(\v2\x1b.deadlock.CMsgServerUserCmdR\bcommands*\xe1\x02\n" +
	...
	"\x14REPLAY_EVENT_VICTORY\x10\x04B4Z2github.com/RyPort/paradox-parser/deadlock;deadlock"
...
var file_netmessages_proto_goTypes = []any{
	(CLC_Messages)(0),                                            // 0: deadlock.CLC_Messages
	(SVC_Messages)(0),                                            // 1: deadlock.SVC_Messages
	(VoiceDataFormatT)(0),                                        // 2: deadlock.VoiceDataFormat_t
	(RequestPauseT)(0),                                           // 3: deadlock.RequestPause_t
	(PrefetchType)(0),                                            // 4: deadlock.PrefetchType
	(ESplitScreenMessageType)(0),                                 // 5: deadlock.ESplitScreenMessageType
	(EQueryCvarValueStatus)(0),                                   // 6: deadlock.EQueryCvarValueStatus
	(DIALOG_TYPE)(0),                                             // 7: deadlock.DIALOG_TYPE
	(SVC_Messages_LowFrequency)(0),                               // 8: deadlock.SVC_Messages_LowFrequency
	(Bidirectional_Messages)(0),                                  // 9: deadlock.Bidirectional_Messages
	(Bidirectional_Messages_LowFrequency)(0),                     // 10: deadlock.Bidirectional_Messages_LowFrequency
	(ReplayEventTypeT)(0),                                        // 11: deadlock.ReplayEventType_t
	(CBidirMsg_PredictionEvent_ESyncType)(0),                     // 12: deadlock.CBidirMsg_PredictionEvent.ESyncType
	(*CCLCMsg_ClientInfo)(nil),                                   // 13: deadlock.CCLCMsg_ClientInfo
	(*CCLCMsg_Move)(nil),                                         // 14: deadlock.CCLCMsg_Move
	(*CMsgVoiceAudio)(nil),                                       // 15: deadlock.CMsgVoiceAudio
	(*CCLCMsg_VoiceData)(nil),                                    // 16: deadlock.CCLCMsg_VoiceData
	(*CCLCMsg_BaselineAck)(nil),                                  // 17: deadlock.CCLCMsg_BaselineAck
	(*CCLCMsg_ListenEvents)(nil),                                 // 18: deadlock.CCLCMsg_ListenEvents
	(*CCLCMsg_RespondCvarValue)(nil),                             // 19: deadlock.CCLCMsg_RespondCvarValue
	(*CCLCMsg_FileCRCCheck)(nil),                                 // 20: deadlock.CCLCMsg_FileCRCCheck
	(*CCLCMsg_LoadingProgress)(nil),                              // 21: deadlock.CCLCMsg_LoadingProgress
	(*CCLCMsg_SplitPlayerConnect)(nil),                           // 22: deadlock.CCLCMsg_SplitPlayerConnect
	(*CCLCMsg_SplitPlayerDisconnect)(nil),                        // 23: deadlock.CCLCMsg_SplitPlayerDisconnect
	(*CCLCMsg_ServerStatus)(nil),                                 // 24: deadlock.CCLCMsg_ServerStatus
	(*CCLCMsg_RequestPause)(nil),                                 // 25: deadlock.CCLCMsg_RequestPause
	(*CCLCMsg_CmdKeyValues)(nil),                                 // 26: deadlock.CCLCMsg_CmdKeyValues
	(*CCLCMsg_RconServerDetails)(nil),                            // 27: deadlock.CCLCMsg_RconServerDetails
	(*CMsgSource2SystemSpecs)(nil),                               // 28: deadlock.CMsgSource2SystemSpecs
	(*CMsgSource2VProfLiteReportItem)(nil),                       // 29: deadlock.CMsgSource2VProfLiteReportItem
	(*CMsgSource2VProfLiteReport)(nil),                           // 30: deadlock.CMsgSource2VProfLiteReport
	(*CMsgSource2NetworkFlowQuality)(nil),                        // 31: deadlock.CMsgSource2NetworkFlowQuality
	(*CCLCMsg_Diagnostic)(nil),                                   // 32: deadlock.CCLCMsg_Diagnostic
	(*CSource2Metrics_MatchPerfSummary_Notification)(nil),        // 33: deadlock.CSource2Metrics_MatchPerfSummary_Notification
	(*CSVCMsg_ServerInfo)(nil),                                   // 34: deadlock.CSVCMsg_ServerInfo
	(*CSVCMsg_ClassInfo)(nil),                                    // 35: deadlock.CSVCMsg_ClassInfo
	(*CSVCMsg_SetPause)(nil),                                     // 36: deadlock.CSVCMsg_SetPause
	(*CSVCMsg_VoiceInit)(nil),                                    // 37: deadlock.CSVCMsg_VoiceInit
	(*CSVCMsg_Print)(nil),                                        // 38: deadlock.CSVCMsg_Print
	(*CSVCMsg_Sounds)(nil),                                       // 39: deadlock.CSVCMsg_Sounds
	(*CSVCMsg_Prefetch)(nil),                                     // 40: deadlock.CSVCMsg_Prefetch
	(*CSVCMsg_SetView)(nil),                                      // 41: deadlock.CSVCMsg_SetView
	(*CSVCMsg_FixAngle)(nil),                                     // 42: deadlock.CSVCMsg_FixAngle
	(*CSVCMsg_CrosshairAngle)(nil),                               // 43: deadlock.CSVCMsg_CrosshairAngle
	(*CSVCMsg_BSPDecal)(nil),                                     // 44: deadlock.CSVCMsg_BSPDecal
	(*CSVCMsg_SplitScreen)(nil),                                  // 45: deadlock.CSVCMsg_SplitScreen
	(*CSVCMsg_GetCvarValue)(nil),                                 // 46: deadlock.CSVCMsg_GetCvarValue
	(*CSVCMsg_Menu)(nil),                                         // 47: deadlock.CSVCMsg_Menu
	(*CSVCMsg_UserMessage)(nil),                                  // 48: deadlock.CSVCMsg_UserMessage
	(*CSVCMsg_SendTable)(nil),                                    // 49: deadlock.CSVCMsg_SendTable
	(*CSVCMsg_GameEventList)(nil),                                // 50: deadlock.CSVCMsg_GameEventList
	(*CSVCMsg_PacketEntities)(nil),                               // 51: deadlock.CSVCMsg_PacketEntities
	(*CSVCMsg_TempEntities)(nil),                                 // 52: deadlock.CSVCMsg_TempEntities
	(*CSVCMsg_CreateStringTable)(nil),                            // 53: deadlock.CSVCMsg_CreateStringTable
	(*CSVCMsg_UpdateStringTable)(nil),                            // 54: deadlock.CSVCMsg_UpdateStringTable
	(*CSVCMsg_VoiceData)(nil),                                    // 55: deadlock.CSVCMsg_VoiceData
	(*CSVCMsg_PacketReliable)(nil),                               // 56: deadlock.CSVCMsg_PacketReliable
	(*CSVCMsg_FullFrameSplit)(nil),                               // 57: deadlock.CSVCMsg_FullFrameSplit
	(*CSVCMsg_HLTVStatus)(nil),                                   // 58: deadlock.CSVCMsg_HLTVStatus
	(*CSVCMsg_ServerSteamID)(nil),                                // 59: deadlock.CSVCMsg_ServerSteamID
	(*CSVCMsg_CmdKeyValues)(nil),                                 // 60: deadlock.CSVCMsg_CmdKeyValues
	(*CSVCMsg_RconServerDetails)(nil),                            // 61: deadlock.CSVCMsg_RconServerDetails
	(*CMsgIPCAddress)(nil),                                       // 62: deadlock.CMsgIPCAddress
	(*CMsgServerPeer)(nil),                                       // 63: deadlock.CMsgServerPeer
	(*CSVCMsg_PeerList)(nil),                                     // 64: deadlock.CSVCMsg_PeerList
	(*CSVCMsg_ClearAllStringTables)(nil),                         // 65: deadlock.CSVCMsg_ClearAllStringTables
	(*ProtoFlattenedSerializerFieldT)(nil),                       // 66: deadlock.ProtoFlattenedSerializerField_t
	(*ProtoFlattenedSerializerT)(nil),                            // 67: deadlock.ProtoFlattenedSerializer_t
	(*CSVCMsg_FlattenedSerializer)(nil),                          // 68: deadlock.CSVCMsg_FlattenedSerializer
	(*CSVCMsg_StopSound)(nil),                                    // 69: deadlock.CSVCMsg_StopSound
	(*CBidirMsg_RebroadcastGameEvent)(nil),                       // 70: deadlock.CBidirMsg_RebroadcastGameEvent
	(*CBidirMsg_RebroadcastSource)(nil),                          // 71: deadlock.CBidirMsg_RebroadcastSource
	(*CBidirMsg_PredictionEvent)(nil),                            // 72: deadlock.CBidirMsg_PredictionEvent
	(*CMsgServerNetworkStats)(nil),                               // 73: deadlock.CMsgServerNetworkStats
	(*CSVCMsg_HltvReplay)(nil),                                   // 74: deadlock.CSVCMsg_HltvReplay
	(*CCLCMsg_HltvReplay)(nil),                                   // 75: deadlock.CCLCMsg_HltvReplay
	(*CSVCMsg_Broadcast_Command)(nil),                            // 76: deadlock.CSVCMsg_Broadcast_Command
	(*CCLCMsg_HltvFixupOperatorTick)(nil),                        // 77: deadlock.CCLCMsg_HltvFixupOperatorTick
	(*CSVCMsg_HltvFixupOperatorStatus)(nil),                      // 78: deadlock.CSVCMsg_HltvFixupOperatorStatus
	(*CMsgServerUserCmd)(nil),                                    // 79: deadlock.CMsgServerUserCmd
	(*CSVCMsg_UserCommands)(nil),                                 // 80: deadlock.CSVCMsg_UserCommands
	(*CSource2Metrics_MatchPerfSummary_Notification_Client)(nil), // 81: deadlock.CSource2Metrics_MatchPerfSummary_Notification.Client
	(*CSVCMsg_ClassInfoClassT)(nil),                              // 82: deadlock.CSVCMsg_ClassInfo.class_t
	(*CSVCMsg_SoundsSounddataT)(nil),                             // 83: deadlock.CSVCMsg_Sounds.sounddata_t
	(*CSVCMsg_SendTableSendpropT)(nil),                           // 84: deadlock.CSVCMsg_SendTable.sendprop_t
	(*CSVCMsg_GameEventListKeyT)(nil),                            // 85: deadlock.CSVCMsg_GameEventList.key_t
	(*CSVCMsg_GameEventListDescriptorT)(nil),                     // 86: deadlock.CSVCMsg_GameEventList.descriptor_t
	(*CSVCMsg_PacketEntitiesAlternateBaselineT)(nil),             // 87: deadlock.CSVCMsg_PacketEntities.alternate_baseline_t
	(*CSVCMsg_PacketEntitiesNonTransmittedEntitiesT)(nil),        // 88: deadlock.CSVCMsg_PacketEntities.non_transmitted_entities_t
	(*CSVCMsg_PacketEntitiesOutofpvsEntityUpdatesT)(nil),         // 89: deadlock.CSVCMsg_PacketEntities.outofpvs_entity_updates_t
	(*ProtoFlattenedSerializerFieldTPolymorphicFieldT)(nil),      // 90: deadlock.ProtoFlattenedSerializerField_t.polymorphic_field_t
	(*CMsgServerNetworkStats_Port)(nil),                          // 91: deadlock.CMsgServerNetworkStats.Port
	(*CMsgServerNetworkStats_Player)(nil),                        // 92: deadlock.CMsgServerNetworkStats.Player
	(*CSVCMsg_GameSessionConfiguration)(nil),                     // 93: deadlock.CSVCMsg_GameSessionConfiguration
	(*CMsgQAngle)(nil),                                           // 94: deadlock.CMsgQAngle
	(*CMsgVector)(nil),                                           // 95: deadlock.CMsgVector
}
var file_netmessages_proto_depIdxs = []int32{
	2,  // 0: deadlock.CMsgVoiceAudio.format:type_name -> deadlock.VoiceDataFormat_t
	15, // 1: deadlock.CCLCMsg_VoiceData.audio:type_name -> deadlock.CMsgVoiceAudio
	3,  // 2: deadlock.CCLCMsg_RequestPause.pause_type:type_name -> deadlock.RequestPause_t
	29, // 3: deadlock.CMsgSource2VProfLiteReport.total:type_name -> deadlock.CMsgSource2VProfLiteReportItem
	29, // 4: deadlock.CMsgSource2VProfLiteReport.items:type_name -> deadlock.CMsgSource2VProfLiteReportItem
	28, // 5: deadlock.CCLCMsg_Diagnostic.system_specs:type_name -> deadlock.CMsgSource2SystemSpecs
	30, // 6: deadlock.CCLCMsg_Diagnostic.vprof_report:type_name -> deadlock.CMsgSource2VProfLiteReport
	31, // 7: deadlock.CCLCMsg_Diagnostic.downstream_flow:type_name -> deadlock.CMsgSource2NetworkFlowQuality
	31, // 8: deadlock.CCLCMsg_Diagnostic.upstream_flow:type_name -> deadlock.CMsgSource2NetworkFlowQuality
	30, // 9: deadlock.CSource2Metrics_MatchPerfSummary_Notification.server_profile:type_name -> deadlock.CMsgSource2VProfLiteReport
	81, // 10: deadlock.CSource2Metrics_MatchPerfSummary_Notification.clients:type_name -> deadlock.CSource2Metrics_MatchPerfSummary_Notification.Client
	93, // 11: deadlock.CSVCMsg_ServerInfo.game_session_config:type_name -> deadlock.CSVCMsg_GameSessionConfiguration
	82, // 12: deadlock.CSVCMsg_ClassInfo.classes:type_name -> deadlock.CSVCMsg_ClassInfo.class_t
	83, // 13: deadlock.CSVCMsg_Sounds.sounds:type_name -> deadlock.CSVCMsg_Sounds.sounddata_t
	4,  // 14: deadlock.CSVCMsg_Prefetch.resource_type:type_name -> deadlock.PrefetchType
	94, // 15: deadlock.CSVCMsg_FixAngle.angle:type_name -> deadlock.CMsgQAngle
	94, // 16: deadlock.CSVCMsg_CrosshairAngle.angle:type_name -> deadlock.CMsgQAngle
	95, // 17: deadlock.CSVCMsg_BSPDecal.pos:type_name -> deadlock.CMsgVector
	5,  // 18: deadlock.CSVCMsg_SplitScreen.type:type_name -> deadlock.ESplitScreenMessageType
	84, // 19: deadlock.CSVCMsg_SendTable.props:type_name -> deadlock.CSVCMsg_SendTable.sendprop_t
	86, // 20: deadlock.CSVCMsg_GameEventList.descriptors:type_name -> deadlock.CSVCMsg_GameEventList.descriptor_t
	87, // 21: deadlock.CSVCMsg_PacketEntities.alternate_baselines:type_name -> deadlock.CSVCMsg_PacketEntities.alternate_baseline_t
	88, // 22: deadlock.CSVCMsg_PacketEntities.non_transmitted_entities:type_name -> deadlock.CSVCMsg_PacketEntities.non_transmitted_entities_t
	89, // 23: deadlock.CSVCMsg_PacketEntities.outofpvs_entity_updates:type_name -> deadlock.CSVCMsg_PacketEntities.outofpvs_entity_updates_t
	15, // 24: deadlock.CSVCMsg_VoiceData.audio:type_name -> deadlock.CMsgVoiceAudio
	62, // 25: deadlock.CMsgServerPeer.ipc:type_name -> deadlock.CMsgIPCAddress
	63, // 26: deadlock.CSVCMsg_PeerList.peer:type_name -> deadlock.CMsgServerPeer
	90, // 27: deadlock.ProtoFlattenedSerializerField_t.polymorphic_types:type_name -> deadlock.ProtoFlattenedSerializerField_t.polymorphic_field_t
	67, // 28: deadlock.CSVCMsg_FlattenedSerializer.serializers:type_name -> deadlock.ProtoFlattenedSerializer_t
	66, // 29: deadlock.CSVCMsg_FlattenedSerializer.fields:type_name -> deadlock.ProtoFlattenedSerializerField_t
	91, // 30: deadlock.CMsgServerNetworkStats.ports:type_name -> deadlock.CMsgServerNetworkStats.Port
	92, // 31: deadlock.CMsgServerNetworkStats.players:type_name -> deadlock.CMsgServerNetworkStats.Player
	95, // 32: deadlock.CCLCMsg_HltvFixupOperatorTick.origin:type_name -> deadlock.CMsgVector
	94, // 33: deadlock.CCLCMsg_HltvFixupOperatorTick.eye_angles:type_name -> deadlock.CMsgQAngle
	95, // 34: deadlock.CCLCMsg_HltvFixupOperatorTick.view_offset:type_name -> deadlock.CMsgVector
	79, // 35: deadlock.CSVCMsg_UserCommands.commands:type_name -> deadlock.CMsgServerUserCmd
	28, // 36: deadlock.CSource2Metrics_MatchPerfSummary_Notification.Client.system_specs:type_name -> deadlock.CMsgSource2SystemSpecs
	30, // 37: deadlock.CSource2Metrics_MatchPerfSummary_Notification.Client.profile:type_name -> deadlock.CMsgSource2VProfLiteReport
	31, // 38: deadlock.CSource2Metrics_MatchPerfSummary_Notification.Client.downstream_flow:type_name -> deadlock.CMsgSource2NetworkFlowQuality
	31, // 39: deadlock.CSource2Metrics_MatchPerfSummary_Notification.Client.upstream_flow:type_name -> deadlock.CMsgSource2NetworkFlowQuality
	85, // 40: deadlock.CSVCMsg_GameEventList.descriptor_t.keys:type_name -> deadlock.CSVCMsg_GameEventList.key_t
