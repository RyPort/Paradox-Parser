...
type CMsgSteamLearnDataSourceDescElement struct {
	...
	DataType      *ESteamLearnDataType                `protobuf:"varint,2,opt,name=data_type,json=dataType,enum=deadlock.ESteamLearnDataType,def=0" json:"data_type,omitempty"`
...
type CMsgSteamLearn_RegisterDataSource_Response struct {
	state         protoimpl.MessageState                `protogen:"open.v1"`
	Result        *ESteammLearnRegisterDataSourceResult `protobuf:"varint,1,opt,name=result,enum=deadlock.ESteammLearnRegisterDataSourceResult,def=0" json:"result,omitempty"`
...
type CMsgSteamLearn_CacheData_Response struct {
	state           protoimpl.MessageState      `protogen:"open.v1"`
	CacheDataResult *ESteamLearnCacheDataResult `protobuf:"varint,1,opt,name=cache_data_result,json=cacheDataResult,enum=deadlock.ESteamLearnCacheDataResult,def=0" json:"cache_data_result,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type CMsgSteamLearn_SnapshotProject_Response struct {
	state          protoimpl.MessageState            `protogen:"open.v1"`
	SnapshotResult *ESteamLearnSnapshotProjectResult `protobuf:"varint,1,opt,name=snapshot_result,json=snapshotResult,enum=deadlock.ESteamLearnSnapshotProjectResult,def=0" json:"snapshot_result,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type CMsgSteamLearn_GetAccessTokens_Response struct {
	state         protoimpl.MessageState            `protogen:"open.v1"`
	Result        *ESteamLearnGetAccessTokensResult `protobuf:"varint,1,opt,name=result,enum=deadlock.ESteamLearnGetAccessTokensResult,def=0" json:"result,omitempty"`
...
type CMsgSteamLearn_InferenceMetadata_Response struct {
	state                   protoimpl.MessageState                                       `protogen:"open.v1"`
	InferenceMetadataResult *ESteamLearnInferenceMetadataResult                          `protobuf:"varint,1,opt,name=inference_metadata_result,json=inferenceMetadataResult,enum=deadlock.ESteamLearnInferenceMetadataResult,def=0" json:"inference_metadata_result,omitempty"`
...
type CMsgSteamLearn_Inference_Response struct {
	state           protoimpl.MessageState                    `protogen:"open.v1"`
	InferenceResult *ESteamLearnInferenceResult               `protobuf:"varint,1,opt,name=inference_result,json=inferenceResult,enum=deadlock.ESteamLearnInferenceResult,def=0" json:"inference_result,omitempty"`
...
const file_steammessages_steamlearn_steamworkssdk_proto_rawDesc = "" +
	"\n" +
	",steammessages_steamlearn.steamworkssdk.proto\x12\bdeadlock\x1a.steammessages_unified_base.steamworkssdk.proto\"o\n" +
	"\"CMsgSteamLearnDataSourceDescObject\x12I\n" +
	"\belements\x18\x01 \x03(\v2-.deadlock.CMsgSteamLearnDataSourceDescElementR\belements\"\xee\x01\n" +
	"#CMsgSteamLearnDataSourceDescElement\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12W\n" +
	"\tdata_type\x18\x02 \x01(\x0e2\x1d.deadlock.ESteamLearnDataType:\x1bSTEAMLEARN_DATATYPE_INVALIDR\bdataType\x12D\n" +
	"\x06object\x18\x03 \x01(\v2,.deadlock.CMsgSteamLearnDataSourceDescObjectR\x06object\x12\x14\n" +
	...
	"\tstructure\x18\x05 \x01(\v2,.deadlock.CMsgSteamLearnDataSourceDescObjectR\tstructure\x12#\n" +
	...
	"\belements\x18\x01 \x03(\v2#.deadlock.CMsgSteamLearnDataElementR\belements\"\xfa\x01\n" +
	...
	"\fdata_objects\x18\x18 \x03(\v2\".deadlock.CMsgSteamLearnDataObjectR\vdataObjects\"\x93\x01\n" +
	"\x12CMsgSteamLearnData\x12$\n" +
	"\x0edata_source_id\x18\x01 \x01(\rR\fdataSourceId\x12\x12\n" +
	"\x04keys\x18\x02 \x03(\x04R\x04keys\x12C\n" +
	"\vdata_object\x18\x03 \x01(\v2\".deadlock.CMsgSteamLearnDataObjectR\n" +
	"dataObject\"J\n" +
	"\x16CMsgSteamLearnDataList\x120\n" +
	"\x04data\x18\x01 \x03(\v2\x1c.deadlock.CMsgSteamLearnDataR\x04data\"\x93\x01\n" +
	")CMsgSteamLearn_RegisterDataSource_Request\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12C\n" +
	"\vdata_source\x18\x03 \x01(\v2\".deadlock.CMsgSteamLearnDataSourceR\n" +
	"dataSource\"\xe7\x01\n" +
	"*CMsgSteamLearn_RegisterDataSource_Response\x12t\n" +
	"\x06result\x18\x01 \x01(\x0e2..deadlock.ESteammLearnRegisterDataSourceResult:,STEAMLEARN_REGISTER_DATA_SOURCE_RESULT_ERRORR\x06result\x12C\n" +
	"\vdata_source\x18\x02 \x01(\v2\".deadlock.CMsgSteamLearnDataSourceR\n" +
	"dataSource\"w\n" +
	" CMsgSteamLearn_CacheData_Request\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x120\n" +
	"\x04data\x18\x03 \x01(\v2\x1c.deadlock.CMsgSteamLearnDataR\x04data\"\x92\x01\n" +
	"!CMsgSteamLearn_CacheData_Response\x12m\n" +
	"\x11cache_data_result\x18\x01 \x01(\x0e2$.deadlock.ESteamLearnCacheDataResult:\x1bSTEAMLEARN_CACHE_DATA_ERRORR\x0fcacheDataResult\"\x9a\x02\n" +
	...
	"\x04data\x18\x05 \x03(\v2\x1c.deadlock.CMsgSteamLearnDataR\x04data\x12;\n" +
	...
	"\x0fsnapshot_result\x18\x01 \x01(\x0e2*.deadlock.ESteamLearnSnapshotProjectResult:!STEAMLEARN_SNAPSHOT_PROJECT_ERRORR\x0esnapshotResult\"\xbd\x02\n" +
	"%CMsgSteamLearn_BatchOperation_Request\x12Z\n" +
	"\x13cache_data_requests\x18\x01 \x03(\v2*.deadlock.CMsgSteamLearn_CacheData_RequestR\x11cacheDataRequests\x12]\n" +
	"\x11snapshot_requests\x18\x02 \x03(\v20.deadlock.CMsgSteamLearn_SnapshotProject_RequestR\x10snapshotRequests\x12Y\n" +
	"\x12inference_requests\x18\x03 \x03(\v2*.deadlock.CMsgSteamLearn_Inference_RequestR\x11inferenceRequests\"\xc7\x02\n" +
	"&CMsgSteamLearn_BatchOperation_Response\x12]\n" +
	"\x14cache_data_responses\x18\x01 \x03(\v2+.deadlock.CMsgSteamLearn_CacheData_ResponseR\x12cacheDataResponses\x12`\n" +
	"\x12snapshot_responses\x18\x02 \x03(\v21.deadlock.CMsgSteamLearn_SnapshotProject_ResponseR\x11snapshotResponses\x12\\\n" +
	"\x13inference_responses\x18\x03 \x03(\v2+.deadlock.CMsgSteamLearn_Inference_ResponseR\x12inferenceResponses\"\xef\x05\n" +
	"\x1aCMsgSteamLearnAccessTokens\x12H\n" +
	"!register_data_source_access_token\x18\x01 \x01(\tR\x1dregisterDataSourceAccessToken\x12r\n" +
	"\x18cache_data_access_tokens\x18\x02 \x03(\v29.deadlock.CMsgSteamLearnAccessTokens.CacheDataAccessTokenR\x15cacheDataAccessTokens\x12\x84\x01\n" +
	"\x1esnapshot_project_access_tokens\x18\x03 \x03(\v2?.deadlock.CMsgSteamLearnAccessTokens.SnapshotProjectAccessTokenR\x1bsnapshotProjectAccessTokens\x12q\n" +
	"\x17inference_access_tokens\x18\x04 \x03(\v29.deadlock.CMsgSteamLearnAccessTokens.InferenceAccessTokenR\x15inferenceAccessTokens\x1a_\n" +
	...
	"\x06result\x18\x01 \x01(\x0e2*.deadlock.ESteamLearnGetAccessTokensResult:\"STEAMLEARN_GET_ACCESS_TOKENS_ERRORR\x06result\x12I\n" +
	"\raccess_tokens\x18\x02 \x01(\v2$.deadlock.CMsgSteamLearnAccessTokensR\faccessTokens\"\xdb\x03\n" +
	...
	"\fitem_scalars\x18\x05 \x03(\v29.deadlock.CMsgInferenceIterateBeamSearch.CustomItemScalarR\vitemScalars\x12*\n" +
	...
	"\x04data\x18\x06 \x01(\v2 .deadlock.CMsgSteamLearnDataListR\x04data\x12'\n" +
	...
	"\x13iterate_beam_search\x18\r \x01(\v2(.deadlock.CMsgInferenceIterateBeamSearchR\x11iterateBeamSearch\x12\x1d\n" +
	"\n" +
	...
	"\x19inference_metadata_result\x18\x01 \x01(\x0e2,.deadlock.ESteamLearnInferenceMetadataResult:#STEAMLEARN_INFERENCE_METADATA_ERRORR\x17inferenceMetadataResult\x12Y\n" +
	"\trow_range\x18\x02 \x01(\v2<.deadlock.CMsgSteamLearn_InferenceMetadata_Response.RowRangeR\browRange\x12Q\n" +
	"\x06ranges\x18\x03 \x03(\v29.deadlock.CMsgSteamLearn_InferenceMetadata_Response.RangeR\x06ranges\x12U\n" +
	"\bstd_devs\x18\x04 \x03(\v2:.deadlock.CMsgSteamLearn_InferenceMetadata_Response.StdDevR\astdDevs\x12g\n" +
	"\x0ecompact_tables\x18\x05 \x03(\v2@.deadlock.CMsgSteamLearn_InferenceMetadata_Response.CompactTableR\rcompactTables\x12j\n" +
	"\x0fsequence_tables\x18\t \x03(\v2A.deadlock.CMsgSteamLearn_InferenceMetadata_Response.SequenceTableR\x0esequenceTables\x12R\n" +
	"\x06kmeans\x18\x06 \x03(\v2:.deadlock.CMsgSteamLearn_InferenceMetadata_Response.KMeansR\x06kmeans\x12[\n" +
	"\bapp_info\x18\b \x03(\v2@.deadlock.CMsgSteamLearn_InferenceMetadata_Response.AppInfoEntryR\aappInfo\x12t\n" +
	"\x12snapshot_histogram\x18\a \x01(\v2E.deadlock.CMsgSteamLearn_InferenceMetadata_Response.SnapshotHistogramR\x11snapshotHistogram\x1a<\n" +
	"\bRowRange\x12\x17\n" +
	...
	"\n" +
	"map_values\x18\x02 \x03(\v2O.deadlock.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.MapValuesEntryR\tmapValues\x12t\n" +
	"\fmap_mappings\x18\x03 \x03(\v2Q.deadlock.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.MapMappingsEntryR\vmapMappings\x1aM\n" +
	"\x05Entry\x12\x14\n" +
	...
	"\x05value\x18\x02 \x01(\v2F.deadlock.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.EntryR\x05value\x1a\x82\x01\n" +
	"\x10MapMappingsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\rR\x03key\x12\\\n" +
	"\x05value\x18\x02 \x01(\v2F.deadlock.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.EntryR\x05value\x1a\xff\x04\n" +
	"\rSequenceTable\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12o\n" +
	"\n" +
	"map_values\x18\x02 \x03(\v2P.deadlock.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.MapValuesEntryR\tmapValues\x12u\n" +
	"\fmap_mappings\x18\x03 \x03(\v2R.deadlock.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.MapMappingsEntryR\vmapMappings\x12\x1f\n" +
	...
	"\x0eMapValuesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\rR\x03key\x12]\n" +
	"\x05value\x18\x02 \x01(\v2G.deadlock.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.EntryR\x05value\x1a\x83\x01\n" +
	"\x10MapMappingsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12]\n" +
	"\x05value\x18\x02 \x01(\v2G.deadlock.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.EntryR\x05value\x1a\xa5\x02\n" +
	"\x06KMeans\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12^\n" +
	"\bclusters\x18\x02 \x03(\v2B.deadlock.CMsgSteamLearn_InferenceMetadata_Response.KMeans.ClusterR\bclusters\x1a\xa6\x01\n" +
	"\aCluster\x12\f\n" +
	...
	"\x05value\x18\x02 \x01(\v2;.deadlock.CMsgSteamLearn_InferenceMetadata_Response.AppInfoR\x05value\"\xaa\n" +
	"\n" +
	"(CMsgSteamLearn_InferenceBackend_Response\x12S\n" +
	"\aoutputs\x18\x01 \x03(\v29.deadlock.CMsgSteamLearn_InferenceBackend_Response.OutputR\aoutputs\x1a \n" +
	"\bSequence\x12\x14\n" +
	...
	"\x0evalue_sequence\x18\x03 \x03(\v2;.deadlock.CMsgSteamLearn_InferenceBackend_Response.SequenceR\rvalueSequence\x1a\xb1\x01\n" +
	"\x1dCategoricalCrossEntropyOutput\x12\x16\n" +
	"\x06weight\x18\x01 \x03(\x02R\x06weight\x12\x14\n" +
	"\x05value\x18\x02 \x03(\x02R\x05value\x12b\n" +
	"\x0evalue_sequence\x18\x03 \x03(\v2;.deadlock.CMsgSteamLearn_InferenceBackend_Response.SequenceR\rvalueSequence\x1a\x94\x05\n" +
	"\x06Output\x12~\n" +
	"\x13binary_crossentropy\x18\x01 \x01(\v2K.deadlock.CMsgSteamLearn_InferenceBackend_Response.BinaryCrossEntropyOutputH\x00R\x12binaryCrossentropy\x12\x8d\x01\n" +
	"\x18categorical_crossentropy\x18\x02 \x01(\v2P.deadlock.CMsgSteamLearn_InferenceBackend_Response.CategoricalCrossEntropyOutputH\x00R\x17categoricalCrossentropy\x12\x8e\x01\n" +
	"\x19multi_binary_crossentropy\x18\x03 \x01(\v2P.deadlock.CMsgSteamLearn_InferenceBackend_Response.MutliBinaryCrossEntropyOutputH\x00R\x17multiBinaryCrossentropy\x12e\n" +
	"\n" +
	"regression\x18\x04 \x01(\v2C.deadlock.CMsgSteamLearn_InferenceBackend_Response.RegressionOutputH\x00R\n" +
	"regression\x12r\n" +
	"\x0fnamed_inference\x18\x05 \x01(\v2G.deadlock.CMsgSteamLearn_InferenceBackend_Response.NamedInferenceOutputH\x00R\x0enamedInferenceB\x0e\n" +
	"\fResponseType\"\x83\x02\n" +
	"!CMsgSteamLearn_Inference_Response\x12k\n" +
	"\x10inference_result\x18\x01 \x01(\x0e2$.deadlock.ESteamLearnInferenceResult:\x1aSTEAMLEARN_INFERENCE_ERRORR\x0finferenceResult\x12]\n" +
	"\x10backend_response\x18\x02 \x01(\v22.deadlock.CMsgSteamLearn_InferenceBackend_ResponseR\x0fbackendResponse\x12\x12\n" +
	...
	"\x12RegisterDataSource\x123.deadlock.CMsgSteamLearn_RegisterDataSource_Request\x1a4.deadlock.CMsgSteamLearn_RegisterDataSource_Response\"L\x82\xb5\x18HRegisters a data desc (or finds a data desc if it's already registered).\x12\x86\x01\n" +
	"\tCacheData\x12*.deadlock.CMsgSteamLearn_CacheData_Request\x1a+.deadlock.CMsgSteamLearn_CacheData_Response\" \x82\xb5\x18\x1cUpdates a cached data entry.\x12\xa5\x01\n" +
	"\x0fSnapshotProject\x120.deadlock.CMsgSteamLearn_SnapshotProject_Request\x1a1.deadlock.CMsgSteamLearn_SnapshotProject_Response\"-\x82\xb5\x18)Snapshots the current data for a project.\x12\xcc\x01\n" +
	"\x0eBatchOperation\x12/.deadlock.CMsgSteamLearn_BatchOperation_Request\x1a0.deadlock.CMsgSteamLearn_BatchOperation_Response\"W\x82\xb5\x18SBatches multiple data updates, snapshots, and inference requests into a single call\x12\xea\x01\n" +
	"\x0fGetAccessTokens\x120.deadlock.CMsgSteamLearn_GetAccessTokens_Request\x1a1.deadlock.CMsgSteamLearn_GetAccessTokens_Response\"r\x82\xb5\x18nGets the access tokens needed for registering data sources, submitting data to them, and snapshotting projects\x12\xb4\x01\n" +
	"\tInference\x12*.deadlock.CMsgSteamLearn_Inference_Request\x1a+.deadlock.CMsgSteamLearn_Inference_Response\"N\x82\xb5\x18JInferences using supplied data, or data associated with the specified key.\x12\xc2\x01\n" +
	"\x11InferenceMetadata\x122.deadlock.CMsgSteamLearn_InferenceMetadata_Request\x1a3.deadlock.CMsgSteamLearn_InferenceMetadata_Response\"D\x82\xb5\x18@Requests the metadata that was generated from a specified fetch.\x1aK\x82\xb5\x18GService for submitting data, training, and inferencing with SteamLearn.B4Z2github.com/RyPort/paradox-parser/deadlock;deadlock"
...
var file_steammessages_steamlearn_steamworkssdk_proto_goTypes = []any{
	(ESteamLearnDataType)(0),                                                         // 0: deadlock.ESteamLearnDataType
	(ESteammLearnRegisterDataSourceResult)(0),                                        // 1: deadlock.ESteammLearnRegisterDataSourceResult
	(ESteamLearnCacheDataResult)(0),                                                  // 2: deadlock.ESteamLearnCacheDataResult
	(ESteamLearnSnapshotProjectResult)(0),                                            // 3: deadlock.ESteamLearnSnapshotProjectResult
	(ESteamLearnGetAccessTokensResult)(0),                                            // 4: deadlock.ESteamLearnGetAccessTokensResult
	(ESteamLearnInferenceResult)(0),                                                  // 5: deadlock.ESteamLearnInferenceResult
	(ESteamLearnInferenceMetadataResult)(0),                                          // 6: deadlock.ESteamLearnInferenceMetadataResult
	(*CMsgSteamLearnDataSourceDescObject)(nil),                                       // 7: deadlock.CMsgSteamLearnDataSourceDescObject
	(*CMsgSteamLearnDataSourceDescElement)(nil),                                      // 8: deadlock.CMsgSteamLearnDataSourceDescElement
	(*CMsgSteamLearnDataSource)(nil),                                                 // 9: deadlock.CMsgSteamLearnDataSource
	(*CMsgSteamLearnDataObject)(nil),                                                 // 10: deadlock.CMsgSteamLearnDataObject
	(*CMsgSteamLearnDataElement)(nil),                                                // 11: deadlock.CMsgSteamLearnDataElement
	(*CMsgSteamLearnData)(nil),                                                       // 12: deadlock.CMsgSteamLearnData
	(*CMsgSteamLearnDataList)(nil),                                                   // 13: deadlock.CMsgSteamLearnDataList
	(*CMsgSteamLearn_RegisterDataSource_Request)(nil),                                // 14: deadlock.CMsgSteamLearn_RegisterDataSource_Request
	(*CMsgSteamLearn_RegisterDataSource_Response)(nil),                               // 15: deadlock.CMsgSteamLearn_RegisterDataSource_Response
	(*CMsgSteamLearn_CacheData_Request)(nil),                                         // 16: deadlock.CMsgSteamLearn_CacheData_Request
	(*CMsgSteamLearn_CacheData_Response)(nil),                                        // 17: deadlock.CMsgSteamLearn_CacheData_Response
	(*CMsgSteamLearn_SnapshotProject_Request)(nil),                                   // 18: deadlock.CMsgSteamLearn_SnapshotProject_Request
	(*CMsgSteamLearn_SnapshotProject_Response)(nil),                                  // 19: deadlock.CMsgSteamLearn_SnapshotProject_Response
	(*CMsgSteamLearn_BatchOperation_Request)(nil),                                    // 20: deadlock.CMsgSteamLearn_BatchOperation_Request
	(*CMsgSteamLearn_BatchOperation_Response)(nil),                                   // 21: deadlock.CMsgSteamLearn_BatchOperation_Response
	(*CMsgSteamLearnAccessTokens)(nil),                                               // 22: deadlock.CMsgSteamLearnAccessTokens
	(*CMsgSteamLearn_GetAccessTokens_Request)(nil),                                   // 23: deadlock.CMsgSteamLearn_GetAccessTokens_Request
	(*CMsgSteamLearn_GetAccessTokens_Response)(nil),                                  // 24: deadlock.CMsgSteamLearn_GetAccessTokens_Response
	(*CMsgInferenceIterateBeamSearch)(nil),                                           // 25: deadlock.CMsgInferenceIterateBeamSearch
	(*CMsgSteamLearn_Inference_Request)(nil),                                         // 26: deadlock.CMsgSteamLearn_Inference_Request
	(*CMsgSteamLearn_InferenceMetadata_Request)(nil),                                 // 27: deadlock.CMsgSteamLearn_InferenceMetadata_Request
	(*CMsgSteamLearn_InferenceMetadataBackend_Request)(nil),                          // 28: deadlock.CMsgSteamLearn_InferenceMetadataBackend_Request
	(*CMsgSteamLearn_InferenceMetadata_Response)(nil),                                // 29: deadlock.CMsgSteamLearn_InferenceMetadata_Response
	(*CMsgSteamLearn_InferenceBackend_Response)(nil),                                 // 30: deadlock.CMsgSteamLearn_InferenceBackend_Response
	(*CMsgSteamLearn_Inference_Response)(nil),                                        // 31: deadlock.CMsgSteamLearn_Inference_Response
	(*CMsgSteamLearnAccessTokens_CacheDataAccessToken)(nil),                          // 32: deadlock.CMsgSteamLearnAccessTokens.CacheDataAccessToken
	(*CMsgSteamLearnAccessTokens_SnapshotProjectAccessToken)(nil),                    // 33: deadlock.CMsgSteamLearnAccessTokens.SnapshotProjectAccessToken
	(*CMsgSteamLearnAccessTokens_InferenceAccessToken)(nil),                          // 34: deadlock.CMsgSteamLearnAccessTokens.InferenceAccessToken
	(*CMsgInferenceIterateBeamSearch_CustomItemScalar)(nil),                          // 35: deadlock.CMsgInferenceIterateBeamSearch.CustomItemScalar
	(*CMsgSteamLearn_InferenceMetadata_Response_RowRange)(nil),                       // 36: deadlock.CMsgSteamLearn_InferenceMetadata_Response.RowRange
	(*CMsgSteamLearn_InferenceMetadata_Response_Range)(nil),                          // 37: deadlock.CMsgSteamLearn_InferenceMetadata_Response.Range
	(*CMsgSteamLearn_InferenceMetadata_Response_StdDev)(nil),                         // 38: deadlock.CMsgSteamLearn_InferenceMetadata_Response.StdDev
	(*CMsgSteamLearn_InferenceMetadata_Response_CompactTable)(nil),                   // 39: deadlock.CMsgSteamLearn_InferenceMetadata_Response.CompactTable
	(*CMsgSteamLearn_InferenceMetadata_Response_SequenceTable)(nil),                  // 40: deadlock.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable
	(*CMsgSteamLearn_InferenceMetadata_Response_KMeans)(nil),                         // 41: deadlock.CMsgSteamLearn_InferenceMetadata_Response.KMeans
	(*CMsgSteamLearn_InferenceMetadata_Response_SnapshotHistogram)(nil),              // 42: deadlock.CMsgSteamLearn_InferenceMetadata_Response.SnapshotHistogram
	(*CMsgSteamLearn_InferenceMetadata_Response_AppInfo)(nil),                        // 43: deadlock.CMsgSteamLearn_InferenceMetadata_Response.AppInfo
	(*CMsgSteamLearn_InferenceMetadata_Response_AppInfoEntry)(nil),                   // 44: deadlock.CMsgSteamLearn_InferenceMetadata_Response.AppInfoEntry
	(*CMsgSteamLearn_InferenceMetadata_Response_CompactTable_Entry)(nil),             // 45: deadlock.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.Entry
	(*CMsgSteamLearn_InferenceMetadata_Response_CompactTable_MapValuesEntry)(nil),    // 46: deadlock.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.MapValuesEntry
	(*CMsgSteamLearn_InferenceMetadata_Response_CompactTable_MapMappingsEntry)(nil),  // 47: deadlock.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.MapMappingsEntry
	(*CMsgSteamLearn_InferenceMetadata_Response_SequenceTable_Entry)(nil),            // 48: deadlock.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.Entry
	(*CMsgSteamLearn_InferenceMetadata_Response_SequenceTable_MapValuesEntry)(nil),   // 49: deadlock.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.MapValuesEntry
	(*CMsgSteamLearn_InferenceMetadata_Response_SequenceTable_MapMappingsEntry)(nil), // 50: deadlock.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.MapMappingsEntry
	(*CMsgSteamLearn_InferenceMetadata_Response_KMeans_Cluster)(nil),                 // 51: deadlock.CMsgSteamLearn_InferenceMetadata_Response.KMeans.Cluster
	(*CMsgSteamLearn_InferenceBackend_Response_Sequence)(nil),                        // 52: deadlock.CMsgSteamLearn_InferenceBackend_Response.Sequence
	(*CMsgSteamLearn_InferenceBackend_Response_RegressionOutput)(nil),                // 53: deadlock.CMsgSteamLearn_InferenceBackend_Response.RegressionOutput
	(*CMsgSteamLearn_InferenceBackend_Response_NamedInferenceOutput)(nil),            // 54: deadlock.CMsgSteamLearn_InferenceBackend_Response.NamedInferenceOutput
	(*CMsgSteamLearn_InferenceBackend_Response_BinaryCrossEntropyOutput)(nil),        // 55: deadlock.CMsgSteamLearn_InferenceBackend_Response.BinaryCrossEntropyOutput
	(*CMsgSteamLearn_InferenceBackend_Response_MutliBinaryCrossEntropyOutput)(nil),   // 56: deadlock.CMsgSteamLearn_InferenceBackend_Response.MutliBinaryCrossEntropyOutput
	(*CMsgSteamLearn_InferenceBackend_Response_CategoricalCrossEntropyOutput)(nil),   // 57: deadlock.CMsgSteamLearn_InferenceBackend_Response.CategoricalCrossEntropyOutput
	(*CMsgSteamLearn_InferenceBackend_Response_Output)(nil),                          // 58: deadlock.CMsgSteamLearn_InferenceBackend_Response.Output
}
var file_steammessages_steamlearn_steamworkssdk_proto_depIdxs = []int32{
	8,  // 0: deadlock.CMsgSteamLearnDataSourceDescObject.elements:type_name -> deadlock.CMsgSteamLearnDataSourceDescElement
	0,  // 1: deadlock.CMsgSteamLearnDataSourceDescElement.data_type:type_name -> deadlock.ESteamLearnDataType
	7,  // 2: deadlock.CMsgSteamLearnDataSourceDescElement.object:type_name -> deadlock.CMsgSteamLearnDataSourceDescObject
	7,  // 3: deadlock.CMsgSteamLearnDataSource.structure:type_name -> deadlock.CMsgSteamLearnDataSourceDescObject
	11, // 4: deadlock.CMsgSteamLearnDataObject.elements:type_name -> deadlock.CMsgSteamLearnDataElement
	10, // 5: deadlock.CMsgSteamLearnDataElement.data_objects:type_name -> deadlock.CMsgSteamLearnDataObject
	10, // 6: deadlock.CMsgSteamLearnData.data_object:type_name -> deadlock.CMsgSteamLearnDataObject
	12, // 7: deadlock.CMsgSteamLearnDataList.data:type_name -> deadlock.CMsgSteamLearnData
	9,  // 8: deadlock.CMsgSteamLearn_RegisterDataSource_Request.data_source:type_name -> deadlock.CMsgSteamLearnDataSource
	1,  // 9: deadlock.CMsgSteamLearn_RegisterDataSource_Response.result:type_name -> deadlock.ESteammLearnRegisterDataSourceResult
	9,  // 10: deadlock.CMsgSteamLearn_RegisterDataSource_Response.data_source:type_name -> deadlock.CMsgSteamLearnDataSource
	12, // 11: deadlock.CMsgSteamLearn_CacheData_Request.data:type_name -> deadlock.CMsgSteamLearnData
	2,  // 12: deadlock.CMsgSteamLearn_CacheData_Response.cache_data_result:type_name -> deadlock.ESteamLearnCacheDataResult
	12, // 13: deadlock.CMsgSteamLearn_SnapshotProject_Request.data:type_name -> deadlock.CMsgSteamLearnData
	3,  // 14: deadlock.CMsgSteamLearn_SnapshotProject_Response.snapshot_result:type_name -> deadlock.ESteamLearnSnapshotProjectResult
	16, // 15: deadlock.CMsgSteamLearn_BatchOperation_Request.cache_data_requests:type_name -> deadlock.CMsgSteamLearn_CacheData_Request
	18, // 16: deadlock.CMsgSteamLearn_BatchOperation_Request.snapshot_requests:type_name -> deadlock.CMsgSteamLearn_SnapshotProject_Request
	26, // 17: deadlock.CMsgSteamLearn_BatchOperation_Request.inference_requests:type_name -> deadlock.CMsgSteamLearn_Inference_Request
	17, // 18: deadlock.CMsgSteamLearn_BatchOperation_Response.cache_data_responses:type_name -> deadlock.CMsgSteamLearn_CacheData_Response
	19, // 19: deadlock.CMsgSteamLearn_BatchOperation_Response.snapshot_responses:type_name -> deadlock.CMsgSteamLearn_SnapshotProject_Response
	31, // 20: deadlock.CMsgSteamLearn_BatchOperation_Response.inference_responses:type_name -> deadlock.CMsgSteamLearn_Inference_Response
	32, // 21: deadlock.CMsgSteamLearnAccessTokens.cache_data_access_tokens:type_name -> deadlock.CMsgSteamLearnAccessTokens.CacheDataAccessToken
	33, // 22: deadlock.CMsgSteamLearnAccessTokens.snapshot_project_access_tokens:type_name -> deadlock.CMsgSteamLearnAccessTokens.SnapshotProjectAccessToken
	34, // 23: deadlock.CMsgSteamLearnAccessTokens.inference_access_tokens:type_name -> deadlock.CMsgSteamLearnAccessTokens.InferenceAccessToken
	4,  // 24: deadlock.CMsgSteamLearn_GetAccessTokens_Response.result:type_name -> deadlock.ESteamLearnGetAccessTokensResult
	22, // 25: deadlock.CMsgSteamLearn_GetAccessTokens_Response.access_tokens:type_name -> deadlock.CMsgSteamLearnAccessTokens
	35, // 26: deadlock.CMsgInferenceIterateBeamSearch.item_scalars:type_name -> deadlock.CMsgInferenceIterateBeamSearch.CustomItemScalar
	13, // 27: deadlock.CMsgSteamLearn_Inference_Request.data:type_name -> deadlock.CMsgSteamLearnDataList
	25, // 28: deadlock.CMsgSteamLearn_Inference_Request.iterate_beam_search:type_name -> deadlock.CMsgInferenceIterateBeamSearch
	6,  // 29: deadlock.CMsgSteamLearn_InferenceMetadata_Response.inference_metadata_result:type_name -> deadlock.ESteamLearnInferenceMetadataResult
	36, // 30: deadlock.CMsgSteamLearn_InferenceMetadata_Response.row_range:type_name -> deadlock.CMsgSteamLearn_InferenceMetadata_Response.RowRange
	37, // 31: deadlock.CMsgSteamLearn_InferenceMetadata_Response.ranges:type_name -> deadlock.CMsgSteamLearn_InferenceMetadata_Response.Range
	38, // 32: deadlock.CMsgSteamLearn_InferenceMetadata_Response.std_devs:type_name -> deadlock.CMsgSteamLearn_InferenceMetadata_Response.StdDev
	39, // 33: deadlock.CMsgSteamLearn_InferenceMetadata_Response.compact_tables:type_name -> deadlock.CMsgSteamLearn_InferenceMetadata_Response.CompactTable
	40, // 34: deadlock.CMsgSteamLearn_InferenceMetadata_Response.sequence_tables:type_name -> deadlock.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable
	41, // 35: deadlock.CMsgSteamLearn_InferenceMetadata_Response.kmeans:type_name -> deadlock.CMsgSteamLearn_InferenceMetadata_Response.KMeans
	44, // 36: deadlock.CMsgSteamLearn_InferenceMetadata_Response.app_info:type_name -> deadlock.CMsgSteamLearn_InferenceMetadata_Response.AppInfoEntry
	42, // 37: deadlock.CMsgSteamLearn_InferenceMetadata_Response.snapshot_histogram:type_name -> deadlock.CMsgSteamLearn_InferenceMetadata_Response.SnapshotHistogram
	58, // 38: deadlock.CMsgSteamLearn_InferenceBackend_Response.outputs:type_name -> deadlock.CMsgSteamLearn_InferenceBackend_Response.Output
	5,  // 39: deadlock.CMsgSteamLearn_Inference_Response.inference_result:type_name -> deadlock.ESteamLearnInferenceResult
	30, // 40: deadlock.CMsgSteamLearn_Inference_Response.backend_response:type_name -> deadlock.CMsgSteamLearn_InferenceBackend_Response
	46, // 41: deadlock.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.map_values:type_name -> deadlock.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.MapValuesEntry
	47, // 42: deadlock.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.map_mappings:type_name -> deadlock.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.MapMappingsEntry
	49, // 43: deadlock.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.map_values:type_name -> deadlock.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.MapValuesEntry
	50, // 44: deadlock.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.map_mappings:type_name -> deadlock.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.MapMappingsEntry
	51, // 45: deadlock.CMsgSteamLearn_InferenceMetadata_Response.KMeans.clusters:type_name -> deadlock.CMsgSteamLearn_InferenceMetadata_Response.KMeans.Cluster
	43, // 46: deadlock.CMsgSteamLearn_InferenceMetadata_Response.AppInfoEntry.value:type_name -> deadlock.CMsgSteamLearn_InferenceMetadata_Response.AppInfo
	45, // 47: deadlock.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.MapValuesEntry.value:type_name -> deadlock.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.Entry
	45, // 48: deadlock.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.MapMappingsEntry.value:type_name -> deadlock.CMsgSteamLearn_InferenceMetadata_Response.CompactTable.Entry
	48, // 49: deadlock.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.MapValuesEntry.value:type_name -> deadlock.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.Entry
	48, // 50: deadlock.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.MapMappingsEntry.value:type_name -> deadlock.CMsgSteamLearn_InferenceMetadata_Response.SequenceTable.Entry
	52, // 51: deadlock.CMsgSteamLearn_InferenceBackend_Response.MutliBinaryCrossEntropyOutput.value_sequence:type_name -> deadlock.CMsgSteamLearn_InferenceBackend_Response.Sequence
	52, // 52: deadlock.CMsgSteamLearn_InferenceBackend_Response.CategoricalCrossEntropyOutput.value_sequence:type_name -> deadlock.CMsgSteamLearn_InferenceBackend_Response.Sequence
	55, // 53: deadlock.CMsgSteamLearn_InferenceBackend_Response.Output.binary_crossentropy:type_name -> deadlock.CMsgSteamLearn_InferenceBackend_Response.BinaryCrossEntropyOutput
	57, // 54: deadlock.CMsgSteamLearn_InferenceBackend_Response.Output.categorical_crossentropy:type_name -> deadlock.CMsgSteamLearn_InferenceBackend_Response.CategoricalCrossEntropyOutput
	56, // 55: deadlock.CMsgSteamLearn_InferenceBackend_Response.Output.multi_binary_crossentropy:type_name -> deadlock.CMsgSteamLearn_InferenceBackend_Response.MutliBinaryCrossEntropyOutput
	53, // 56: deadlock.CMsgSteamLearn_InferenceBackend_Response.Output.regression:type_name -> deadlock.CMsgSteamLearn_InferenceBackend_Response.RegressionOutput
	54, // 57: deadlock.CMsgSteamLearn_InferenceBackend_Response.Output.named_inference:type_name -> deadlock.CMsgSteamLearn_InferenceBackend_Response.NamedInferenceOutput
	14, // 58: deadlock.SteamLearn.RegisterDataSource:input_type -> deadlock.CMsgSteamLearn_RegisterDataSource_Request
	16, // 59: deadlock.SteamLearn.CacheData:input_type -> deadlock.CMsgSteamLearn_CacheData_Request
	18, // 60: deadlock.SteamLearn.SnapshotProject:input_type -> deadlock.CMsgSteamLearn_SnapshotProject_Request
	20, // 61: deadlock.SteamLearn.BatchOperation:input_type -> deadlock.CMsgSteamLearn_BatchOperation_Request
	23, // 62: deadlock.SteamLearn.GetAccessTokens:input_type -> deadlock.CMsgSteamLearn_GetAccessTokens_Request
	26, // 63: deadlock.SteamLearn.Inference:input_type -> deadlock.CMsgSteamLearn_Inference_Request
	27, // 64: deadlock.SteamLearn.InferenceMetadata:input_type -> deadlock.CMsgSteamLearn_InferenceMetadata_Request
	15, // 65: deadlock.SteamLearn.RegisterDataSource:output_type -> deadlock.CMsgSteamLearn_RegisterDataSource_Response
	17, // 66: deadlock.SteamLearn.CacheData:output_type -> deadlock.CMsgSteamLearn_CacheData_Response
	19, // 67: deadlock.SteamLearn.SnapshotProject:output_type -> deadlock.CMsgSteamLearn_SnapshotProject_Response
	21, // 68: deadlock.SteamLearn.BatchOperation:output_type -> deadlock.CMsgSteamLearn_BatchOperation_Response
	24, // 69: deadlock.SteamLearn.GetAccessTokens:output_type -> deadlock.CMsgSteamLearn_GetAccessTokens_Response
	31, // 70: deadlock.SteamLearn.Inference:output_type -> deadlock.CMsgSteamLearn_Inference_Response
	29, // 71: deadlock.SteamLearn.InferenceMetadata:output_type -> deadlock.CMsgSteamLearn_InferenceMetadata_Response
