...
var file_valveextensions_proto_extTypes = []protoimpl.ExtensionInfo{
	...
	},
	{
		...
		Field:         61002,
		Name:          "deadlock.diff_encode_field",
	...
	},
	{
		...
		Field:         61004,
		Name:          "deadlock.steamml_max_entries",
	...
	},
	{
		...
		ExtensionType: (*bool)(nil),
		Field:         61005,
		Name:          "deadlock.steamml_is_timestamp",
	...
	},
	{
		...
		ExtensionType: (*uint32)(nil),
		Field:         61006,
		Name:          "deadlock.steamlearn_count",
	...
	},
	{
		...
		Field:         61007,
		Name:          "deadlock.debugprint_visibility",
		Tag:           "varint,61007,opt,name=debugprint_visibility,enum=deadlock.EProtoDebugVisiblity,def=0",
		Filename:      "valveextensions.proto",
	},
	{
		...
		Field:         1000,
		Name:          "deadlock.schema_friendly_name",
	...
	},
	{
		...
		ExtensionType: (*string)(nil),
		Field:         1001,
		Name:          "deadlock.schema_description",
	...
	},
	{
		...
		ExtensionType: (*bool)(nil),
		Field:         1002,
		Name:          "deadlock.schema_suppress_enumerator",
...
var (
	...
	// optional deadlock.EProtoDebugVisiblity debugprint_visibility = 61007;
...
const file_valveextensions_proto_rawDesc = "" +
	"\n" +
	"\x15valveextensions.proto\x12\bdeadlock\x1a google/protobuf/descriptor.proto*\xca\x01\n" +
	...
	"\x15debugprint_visibility\x12\x1d.google.protobuf.FieldOptions\x18\xcf\xdc\x03 \x01(\x0e2\x1e.deadlock.EProtoDebugVisiblity:\x1ek_EProtoDebugVisibility_AlwaysR\x14debugprintVisibility:T\n" +
	...
	"\x1aschema_suppress_enumerator\x12!.google.protobuf.EnumValueOptions\x18\xea\a \x01(\bR\x18schemaSuppressEnumeratorB4Z2github.com/RyPort/paradox-parser/deadlock;deadlock"
...
var file_valveextensions_proto_goTypes = []any{
	(EProtoDebugVisiblity)(0),           // 0: deadlock.EProtoDebugVisiblity
...
var file_valveextensions_proto_depIdxs = []int32{
	1,  // 0: deadlock.valve_map_field:extendee -> google.protobuf.FieldOptions
	1,  // 1: deadlock.valve_map_key:extendee -> google.protobuf.FieldOptions
	1,  // 2: deadlock.diff_encode_field:extendee -> google.protobuf.FieldOptions
	1,  // 3: deadlock.delta_ignore:extendee -> google.protobuf.FieldOptions
	1,  // 4: deadlock.steamml_max_entries:extendee -> google.protobuf.FieldOptions
	1,  // 5: deadlock.steamml_is_timestamp:extendee -> google.protobuf.FieldOptions
	1,  // 6: deadlock.steamlearn_count:extendee -> google.protobuf.FieldOptions
	1,  // 7: deadlock.debugprint_visibility:extendee -> google.protobuf.FieldOptions
	2,  // 8: deadlock.schema_friendly_name:extendee -> google.protobuf.EnumValueOptions
	2,  // 9: deadlock.schema_description:extendee -> google.protobuf.EnumValueOptions
	2,  // 10: deadlock.schema_suppress_enumerator:extendee -> google.protobuf.EnumValueOptions
	0,  // 11: deadlock.debugprint_visibility:type_name -> deadlock.EProtoDebugVisiblity
