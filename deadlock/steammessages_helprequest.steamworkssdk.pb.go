...
const file_steammessages_helprequest_steamworkssdk_proto_rawDesc = "" +
	"\n" +
	"-steammessages_helprequest.steamworkssdk.proto\x12\bdeadlock\x1a.steammessages_unified_base.steamworkssdk.proto\"\xae\x01\n" +
	...
	"\x02id\x18\x01 \x01(\x04R\x02id2\x80\x02\n" +
	"\x0fHelpRequestLogs\x12\xba\x01\n" +
	"\x18UploadUserApplicationLog\x12;.deadlock.CHelpRequestLogs_UploadUserApplicationLog_Request\x1a<.deadlock.CHelpRequestLogs_UploadUserApplicationLog_Response\"#\x82\xb5\x18\x1fUser uploading application logs\x1a0\x82\xb5\x18,Service for dealing with user-submitted logsB7Z2github.com/RyPort/paradox-parser/deadlock;deadlock\x80\x01\x01"
...
var file_steammessages_helprequest_steamworkssdk_proto_goTypes = []any{
	(*CHelpRequestLogs_UploadUserApplicationLog_Request)(nil),  // 0: deadlock.CHelpRequestLogs_UploadUserApplicationLog_Request
	(*CHelpRequestLogs_UploadUserApplicationLog_Response)(nil), // 1: deadlock.CHelpRequestLogs_UploadUserApplicationLog_Response
}
var file_steammessages_helprequest_steamworkssdk_proto_depIdxs = []int32{
	0, // 0: deadlock.HelpRequestLogs.UploadUserApplicationLog:input_type -> deadlock.CHelpRequestLogs_UploadUserApplicationLog_Request
	1, // 1: deadlock.HelpRequestLogs.UploadUserApplicationLog:output_type -> deadlock.CHelpRequestLogs_UploadUserApplicationLog_Response
