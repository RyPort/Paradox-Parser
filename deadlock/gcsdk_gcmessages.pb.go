...
type CMsgClientHello struct {
	...
	ClientLauncher      *PartnerAccountType       `protobuf:"varint,4,opt,name=client_launcher,json=clientLauncher,enum=deadlock.PartnerAccountType,def=0" json:"client_launcher,omitempty"`
	...
	Engine              *ESourceEngine            `protobuf:"varint,7,opt,name=engine,enum=deadlock.ESourceEngine,def=0" json:"engine,omitempty"`
...
type CMsgConnectionStatus struct {
	state                         protoimpl.MessageState `protogen:"open.v1"`
	Status                        *GCConnectionStatus    `protobuf:"varint,1,opt,name=status,enum=deadlock.GCConnectionStatus,def=0" json:"status,omitempty"`
...
const file_gcsdk_gcmessages_proto_rawDesc = "" +
	"\n" +
	"\x16gcsdk_gcmessages.proto\x12\bdeadlock\x1a\x15valveextensions.proto\x1a\x13steammessages.proto\x1a,steammessages_steamlearn.steamworkssdk.proto\"\x8b\x01\n" +
	...
	"\raccess_tokens\x18\x04 \x01(\v2$.deadlock.CMsgSteamLearnAccessTokensR\faccessTokens\x12S\n" +
	"\rproject_infos\x18\x05 \x03(\v2..deadlock.CMsgSteamLearnServerInfo.ProjectInfoR\fprojectInfos\x1a\x86\x02\n" +
	...
	"\brequests\x18\x02 \x03(\v2\x1f.deadlock.CMsgSDOAssert.RequestR\brequests\x1aB\n" +
	"\aRequest\x12\x10\n" +
	...
	"\n" +
	"owner_soid\x18\x05 \x01(\v2\x17.deadlock.CMsgSOIDOwnerR\townerSoid\x12\x1d\n" +
	"\n" +
	"service_id\x18\x06 \x01(\rR\tserviceId\"\xe1\x03\n" +
	"\x15CMsgSOMultipleObjects\x12W\n" +
	"\x10objects_modified\x18\x02 \x03(\v2,.deadlock.CMsgSOMultipleObjects.SingleObjectR\x0fobjectsModified\x12\x18\n" +
	"\aversion\x18\x03 \x01(\x06R\aversion\x12Q\n" +
	"\robjects_added\x18\x04 \x03(\v2,.deadlock.CMsgSOMultipleObjects.SingleObjectR\fobjectsAdded\x12U\n" +
	"\x0fobjects_removed\x18\x05 \x03(\v2,.deadlock.CMsgSOMultipleObjects.SingleObjectR\x0eobjectsRemoved\x126\n" +
	"\n" +
	"owner_soid\x18\x06 \x01(\v2\x17.deadlock.CMsgSOIDOwnerR\townerSoid\x12\x1d\n" +
	"\n" +
	...
	"\aobjects\x18\x02 \x03(\v2..deadlock.CMsgSOCacheSubscribed.SubscribedTypeR\aobjects\x12\x18\n" +
	"\aversion\x18\x03 \x01(\x06R\aversion\x126\n" +
	"\n" +
	"owner_soid\x18\x04 \x01(\v2\x17.deadlock.CMsgSOIDOwnerR\townerSoid\x12\x1d\n" +
	"\n" +
	...
	"\n" +
	"owner_soid\x18\x02 \x01(\v2\x17.deadlock.CMsgSOIDOwnerR\townerSoid\x12\x1d\n" +
	"\n" +
	...
	"\n" +
	"owner_soid\x18\x02 \x01(\v2\x17.deadlock.CMsgSOIDOwnerR\townerSoid\"\xd5\x01\n" +
	"\x1cCMsgSOCacheSubscriptionCheck\x12\x18\n" +
	"\aversion\x18\x02 \x01(\x06R\aversion\x126\n" +
	"\n" +
	"owner_soid\x18\x03 \x01(\v2\x17.deadlock.CMsgSOIDOwnerR\townerSoid\x12\x1d\n" +
	"\n" +
	...
	"\n" +
	"owner_soid\x18\x02 \x01(\v2\x17.deadlock.CMsgSOIDOwnerR\townerSoid\".\n" +
	...
	"\tdirectory\x18\x06 \x03(\v2%.deadlock.CGCToGCMsgMasterAck.ProcessR\tdirectory\x1aQ\n" +
	"\aProcess\x12\x1f\n" +
	"\tdir_index\x18\x01 \x01(\x05:\x02-1R\bdirIndex\x12%\n" +
	...
	"\agc_info\x18\x01 \x03(\v20.deadlock.CGCToGCMsgMasterStartupComplete.GCInfoR\x06gcInfo\x1aL\n" +
	"\x06GCInfo\x12\x1f\n" +
	"\tdir_index\x18\x01 \x01(\x05:\x02-1R\bdirIndex\x12!\n" +
	...
	"\aupdates\x18\x01 \x03(\v21.deadlock.CMsgGCUpdateSubGCSessionInfo.CMsgUpdateR\aupdates\x1aP\n" +
	"\n" +
	"CMsgUpdate\x12\x18\n" +
	...
	"\x04soid\x18\x01 \x01(\v2\x17.deadlock.CMsgSOIDOwnerR\x04soid\x12\x18\n" +
	...
	"\x15socache_have_versions\x18\x02 \x03(\v2 .deadlock.CMsgSOCacheHaveVersionR\x13socacheHaveVersions\x12.\n" +
	"\x13client_session_need\x18\x03 \x01(\rR\x11clientSessionNeed\x12S\n" +
	"\x0fclient_launcher\x18\x04 \x01(\x0e2\x1c.deadlock.PartnerAccountType:\fPARTNER_NONER\x0eclientLauncher\x12\x1d\n" +
	"\n" +
	"secret_key\x18\x05 \x01(\tR\tsecretKey\x12'\n" +
	"\x0fclient_language\x18\x06 \x01(\rR\x0eclientLanguage\x12>\n" +
	"\x06engine\x18\a \x01(\x0e2\x17.deadlock.ESourceEngine:\rk_ESE_Source1R\x06engine\x12/\n" +
	...
	"\x1boutofdate_subscribed_caches\x18\x03 \x03(\v2\x1f.deadlock.CMsgSOCacheSubscribedR\x19outofdateSubscribedCaches\x12d\n" +
	"\x1auptodate_subscribed_caches\x18\x04 \x03(\v2&.deadlock.CMsgSOCacheSubscriptionCheckR\x18uptodateSubscribedCaches\x12@\n" +
	"\blocation\x18\x05 \x01(\v2$.deadlock.CMsgClientWelcome.LocationR\blocation\x125\n" +
	...
	"\x17additional_welcome_msgs\x18\x12 \x01(\v2\x18.deadlock.CExtraMsgBlockR\x15additionalWelcomeMsgs\x12Y\n" +
	"\x17steam_learn_server_info\x18\x14 \x01(\v2\".deadlock.CMsgSteamLearnServerInfoR\x14steamLearnServerInfo\x1a^\n" +
	"\bLocation\x12\x1a\n" +
	...
	"\x06status\x18\x01 \x01(\x0e2\x1c.deadlock.GCConnectionStatus:\x1fGCConnectionStatus_HAVE_SESSIONR\x06status\x12.\n" +
	...
	"\rhave_versions\x18\x04 \x03(\v25.deadlock.CMsgGCToGCSOCacheSubscribe.CMsgHaveVersionsR\fhaveVersions\x12*\n" +
	...
	"\x0faccount_details\x18\x02 \x01(\v21.deadlock.CGCSystemMsg_GetAccountDetails_ResponseR\x0eaccountDetails\x12\x1f\n" +
	"\vage_seconds\x18\x03 \x01(\rR\n" +
	"ageSeconds\"\xa0\x01\n" +
	"\x1cCMsgGCToGCLoadSessionSOCache\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12a\n" +
	"\x17forward_account_details\x18\x02 \x01(\v2).deadlock.CMsgGCToGCForwardAccountDetailsR\x15forwardAccountDetails\"&\n" +
	...
	"\tlanguages\x18\x02 \x03(\v2R.deadlock.CWorkshop_PopulateItemDescriptions_Request.ItemDescriptionsLanguageBlockR\tlanguages\x1ab\n" +
	...
	"\fdescriptions\x18\x02 \x03(\v2J.deadlock.CWorkshop_PopulateItemDescriptions_Request.SingleItemDescriptionR\fdescriptions\"Y\n" +
	...
	"\x19associated_workshop_files\x18\x03 \x03(\v2G.deadlock.CWorkshop_SetItemPaymentRules_Request.WorkshopItemPaymentRuleR\x17associatedWorkshopFiles\x12q\n" +
	"\x10partner_accounts\x18\x04 \x03(\v2F.deadlock.CWorkshop_SetItemPaymentRules_Request.PartnerItemPaymentRuleR\x0fpartnerAccounts\x12#\n" +
	...
	",associated_workshop_file_for_direct_payments\x18\a \x01(\v2I.deadlock.CWorkshop_SetItemPaymentRules_Request.WorkshopDirectPaymentRuleR'associatedWorkshopFileForDirectPayments\x1a\xbd\x01\n" +
	...
	"\rannouncements\x18\x03 \x03(\v2).deadlock.CCommunity_ClanAnnouncementInfoR\rannouncements\"\x98\x01\n" +
	...
	"\x06caches\x18\x02 \x03(\v2%.deadlock.CMsgSerializedSOCache.CacheR\x06caches\x125\n" +
	...
	"\bversions\x18\x03 \x03(\v2-.deadlock.CMsgSerializedSOCache.Cache.VersionR\bversions\x12J\n" +
	"\vtype_caches\x18\x04 \x03(\v2).deadlock.CMsgSerializedSOCache.TypeCacheR\n" +
	"typeCaches\x1a=\n" +
	"\aVersion\x12\x18\n" +
	...
	"\rsubscribe_msg\x18\x01 \x01(\v2*.deadlock.CMsgGCToGCMasterSubscribeToCacheR\fsubscribeMsg\"\x9a\x01\n" +
	...
	"#GCConnectionStatus_STEAM_GOING_DOWN\x10\x06B4Z2github.com/RyPort/paradox-parser/deadlock;deadlock"
...
var file_gcsdk_gcmessages_proto_goTypes = []any{
	(ESourceEngine)(0),                                                               // 0: deadlock.ESourceEngine
	(PartnerAccountType)(0),                                                          // 1: deadlock.PartnerAccountType
	(GCConnectionStatus)(0),                                                          // 2: deadlock.GCConnectionStatus
	(*CExtraMsgBlock)(nil),                                                           // 3: deadlock.CExtraMsgBlock
	(*CMsgSteamLearnServerInfo)(nil),                                                 // 4: deadlock.CMsgSteamLearnServerInfo
	(*CMsgGCAssertJobData)(nil),                                                      // 5: deadlock.CMsgGCAssertJobData
	(*CMsgGCConCommand)(nil),                                                         // 6: deadlock.CMsgGCConCommand
	(*CMsgSDOAssert)(nil),                                                            // 7: deadlock.CMsgSDOAssert
	(*CMsgSOIDOwner)(nil),                                                            // 8: deadlock.CMsgSOIDOwner
	(*CMsgSOSingleObject)(nil),                                                       // 9: deadlock.CMsgSOSingleObject
	(*CMsgSOMultipleObjects)(nil),                                                    // 10: deadlock.CMsgSOMultipleObjects
	(*CMsgSOCacheSubscribed)(nil),                                                    // 11: deadlock.CMsgSOCacheSubscribed
	(*CMsgSOCacheSubscribedUpToDate)(nil),                                            // 12: deadlock.CMsgSOCacheSubscribedUpToDate
	(*CMsgSOCacheUnsubscribed)(nil),                                                  // 13: deadlock.CMsgSOCacheUnsubscribed
	(*CMsgSOCacheSubscriptionCheck)(nil),                                             // 14: deadlock.CMsgSOCacheSubscriptionCheck
	(*CMsgSOCacheSubscriptionRefresh)(nil),                                           // 15: deadlock.CMsgSOCacheSubscriptionRefresh
	(*CMsgSOCacheVersion)(nil),                                                       // 16: deadlock.CMsgSOCacheVersion
	(*CMsgGCMultiplexMessage)(nil),                                                   // 17: deadlock.CMsgGCMultiplexMessage
	(*CMsgGCToGCSubGCStarting)(nil),                                                  // 18: deadlock.CMsgGCToGCSubGCStarting
	(*CGCToGCMsgMasterAck)(nil),                                                      // 19: deadlock.CGCToGCMsgMasterAck
	(*CGCToGCMsgMasterAck_Response)(nil),                                             // 20: deadlock.CGCToGCMsgMasterAck_Response
	(*CMsgGCToGCUniverseStartup)(nil),                                                // 21: deadlock.CMsgGCToGCUniverseStartup
	(*CMsgGCToGCUniverseStartupResponse)(nil),                                        // 22: deadlock.CMsgGCToGCUniverseStartupResponse
	(*CGCToGCMsgMasterStartupComplete)(nil),                                          // 23: deadlock.CGCToGCMsgMasterStartupComplete
	(*CGCToGCMsgRouted)(nil),                                                         // 24: deadlock.CGCToGCMsgRouted
	(*CGCToGCMsgRoutedReply)(nil),                                                    // 25: deadlock.CGCToGCMsgRoutedReply
	(*CMsgGCUpdateSubGCSessionInfo)(nil),                                             // 26: deadlock.CMsgGCUpdateSubGCSessionInfo
	(*CMsgGCRequestSubGCSessionInfo)(nil),                                            // 27: deadlock.CMsgGCRequestSubGCSessionInfo
	(*CMsgGCRequestSubGCSessionInfoResponse)(nil),                                    // 28: deadlock.CMsgGCRequestSubGCSessionInfoResponse
	(*CMsgSOCacheHaveVersion)(nil),                                                   // 29: deadlock.CMsgSOCacheHaveVersion
	(*CMsgClientHello)(nil),                                                          // 30: deadlock.CMsgClientHello
	(*CMsgClientWelcome)(nil),                                                        // 31: deadlock.CMsgClientWelcome
	(*CMsgConnectionStatus)(nil),                                                     // 32: deadlock.CMsgConnectionStatus
	(*CMsgGCToGCSOCacheSubscribe)(nil),                                               // 33: deadlock.CMsgGCToGCSOCacheSubscribe
	(*CMsgGCToGCSOCacheUnsubscribe)(nil),                                             // 34: deadlock.CMsgGCToGCSOCacheUnsubscribe
	(*CMsgGCClientPing)(nil),                                                         // 35: deadlock.CMsgGCClientPing
	(*CMsgGCToGCForwardAccountDetails)(nil),                                          // 36: deadlock.CMsgGCToGCForwardAccountDetails
	(*CMsgGCToGCLoadSessionSOCache)(nil),                                             // 37: deadlock.CMsgGCToGCLoadSessionSOCache
	(*CMsgGCToGCLoadSessionSOCacheResponse)(nil),                                     // 38: deadlock.CMsgGCToGCLoadSessionSOCacheResponse
	(*CMsgGCToGCUpdateSessionStats)(nil),                                             // 39: deadlock.CMsgGCToGCUpdateSessionStats
	(*CMsgGCToClientRequestDropped)(nil),                                             // 40: deadlock.CMsgGCToClientRequestDropped
	(*CWorkshop_PopulateItemDescriptions_Request)(nil),                               // 41: deadlock.CWorkshop_PopulateItemDescriptions_Request
	(*CWorkshop_GetContributors_Request)(nil),                                        // 42: deadlock.CWorkshop_GetContributors_Request
	(*CWorkshop_GetContributors_Response)(nil),                                       // 43: deadlock.CWorkshop_GetContributors_Response
	(*CWorkshop_SetItemPaymentRules_Request)(nil),                                    // 44: deadlock.CWorkshop_SetItemPaymentRules_Request
	(*CWorkshop_SetItemPaymentRules_Response)(nil),                                   // 45: deadlock.CWorkshop_SetItemPaymentRules_Response
	(*CCommunity_ClanAnnouncementInfo)(nil),                                          // 46: deadlock.CCommunity_ClanAnnouncementInfo
	(*CCommunity_GetClanAnnouncements_Request)(nil),                                  // 47: deadlock.CCommunity_GetClanAnnouncements_Request
	(*CCommunity_GetClanAnnouncements_Response)(nil),                                 // 48: deadlock.CCommunity_GetClanAnnouncements_Response
	(*CBroadcast_PostGameDataFrame_Request)(nil),                                     // 49: deadlock.CBroadcast_PostGameDataFrame_Request
	(*CMsgSerializedSOCache)(nil),                                                    // 50: deadlock.CMsgSerializedSOCache
	(*CMsgGCToClientPollConvarRequest)(nil),                                          // 51: deadlock.CMsgGCToClientPollConvarRequest
	(*CMsgGCToClientPollConvarResponse)(nil),                                         // 52: deadlock.CMsgGCToClientPollConvarResponse
	(*CGCMsgCompressedMsgToClient)(nil),                                              // 53: deadlock.CGCMsgCompressedMsgToClient
	(*CMsgGCToGCMasterBroadcastMessage)(nil),                                         // 54: deadlock.CMsgGCToGCMasterBroadcastMessage
	(*CMsgGCToGCMasterSubscribeToCache)(nil),                                         // 55: deadlock.CMsgGCToGCMasterSubscribeToCache
	(*CMsgGCToGCMasterSubscribeToCacheResponse)(nil),                                 // 56: deadlock.CMsgGCToGCMasterSubscribeToCacheResponse
	(*CMsgGCToGCMasterSubscribeToCacheAsync)(nil),                                    // 57: deadlock.CMsgGCToGCMasterSubscribeToCacheAsync
	(*CMsgGCToGCMasterUnsubscribeFromCache)(nil),                                     // 58: deadlock.CMsgGCToGCMasterUnsubscribeFromCache
	(*CMsgGCToGCMasterDestroyCache)(nil),                                             // 59: deadlock.CMsgGCToGCMasterDestroyCache
	(*CMsgSteamLearnServerInfo_ProjectInfo)(nil),                                     // 60: deadlock.CMsgSteamLearnServerInfo.ProjectInfo
	(*CMsgSDOAssert_Request)(nil),                                                    // 61: deadlock.CMsgSDOAssert.Request
	(*CMsgSOMultipleObjects_SingleObject)(nil),                                       // 62: deadlock.CMsgSOMultipleObjects.SingleObject
	(*CMsgSOCacheSubscribed_SubscribedType)(nil),                                     // 63: deadlock.CMsgSOCacheSubscribed.SubscribedType
	(*CGCToGCMsgMasterAck_Process)(nil),                                              // 64: deadlock.CGCToGCMsgMasterAck.Process
	(*CGCToGCMsgMasterStartupComplete_GCInfo)(nil),                                   // 65: deadlock.CGCToGCMsgMasterStartupComplete.GCInfo
	(*CMsgGCUpdateSubGCSessionInfo_CMsgUpdate)(nil),                                  // 66: deadlock.CMsgGCUpdateSubGCSessionInfo.CMsgUpdate
	(*CMsgClientWelcome_Location)(nil),                                               // 67: deadlock.CMsgClientWelcome.Location
	(*CMsgGCToGCSOCacheSubscribe_CMsgHaveVersions)(nil),                              // 68: deadlock.CMsgGCToGCSOCacheSubscribe.CMsgHaveVersions
	(*CWorkshop_PopulateItemDescriptions_Request_SingleItemDescription)(nil),         // 69: deadlock.CWorkshop_PopulateItemDescriptions_Request.SingleItemDescription
	(*CWorkshop_PopulateItemDescriptions_Request_ItemDescriptionsLanguageBlock)(nil), // 70: deadlock.CWorkshop_PopulateItemDescriptions_Request.ItemDescriptionsLanguageBlock
	(*CWorkshop_SetItemPaymentRules_Request_WorkshopItemPaymentRule)(nil),            // 71: deadlock.CWorkshop_SetItemPaymentRules_Request.WorkshopItemPaymentRule
	(*CWorkshop_SetItemPaymentRules_Request_WorkshopDirectPaymentRule)(nil),          // 72: deadlock.CWorkshop_SetItemPaymentRules_Request.WorkshopDirectPaymentRule
	(*CWorkshop_SetItemPaymentRules_Request_PartnerItemPaymentRule)(nil),             // 73: deadlock.CWorkshop_SetItemPaymentRules_Request.PartnerItemPaymentRule
	(*CMsgSerializedSOCache_TypeCache)(nil),                                          // 74: deadlock.CMsgSerializedSOCache.TypeCache
	(*CMsgSerializedSOCache_Cache)(nil),                                              // 75: deadlock.CMsgSerializedSOCache.Cache
	(*CMsgSerializedSOCache_Cache_Version)(nil),                                      // 76: deadlock.CMsgSerializedSOCache.Cache.Version
	(*CMsgSteamLearnAccessTokens)(nil),                                               // 77: deadlock.CMsgSteamLearnAccessTokens
	(*CGCSystemMsg_GetAccountDetails_Response)(nil),                                  // 78: deadlock.CGCSystemMsg_GetAccountDetails_Response
}
var file_gcsdk_gcmessages_proto_depIdxs = []int32{
	77, // 0: deadlock.CMsgSteamLearnServerInfo.access_tokens:type_name -> deadlock.CMsgSteamLearnAccessTokens
	60, // 1: deadlock.CMsgSteamLearnServerInfo.project_infos:type_name -> deadlock.CMsgSteamLearnServerInfo.ProjectInfo
	61, // 2: deadlock.CMsgSDOAssert.requests:type_name -> deadlock.CMsgSDOAssert.Request
	8,  // 3: deadlock.CMsgSOSingleObject.owner_soid:type_name -> deadlock.CMsgSOIDOwner
	62, // 4: deadlock.CMsgSOMultipleObjects.objects_modified:type_name -> deadlock.CMsgSOMultipleObjects.SingleObject
	62, // 5: deadlock.CMsgSOMultipleObjects.objects_added:type_name -> deadlock.CMsgSOMultipleObjects.SingleObject
	62, // 6: deadlock.CMsgSOMultipleObjects.objects_removed:type_name -> deadlock.CMsgSOMultipleObjects.SingleObject
	8,  // 7: deadlock.CMsgSOMultipleObjects.owner_soid:type_name -> deadlock.CMsgSOIDOwner
	63, // 8: deadlock.CMsgSOCacheSubscribed.objects:type_name -> deadlock.CMsgSOCacheSubscribed.SubscribedType
	8,  // 9: deadlock.CMsgSOCacheSubscribed.owner_soid:type_name -> deadlock.CMsgSOIDOwner
	8,  // 10: deadlock.CMsgSOCacheSubscribedUpToDate.owner_soid:type_name -> deadlock.CMsgSOIDOwner
	8,  // 11: deadlock.CMsgSOCacheUnsubscribed.owner_soid:type_name -> deadlock.CMsgSOIDOwner
	8,  // 12: deadlock.CMsgSOCacheSubscriptionCheck.owner_soid:type_name -> deadlock.CMsgSOIDOwner
	8,  // 13: deadlock.CMsgSOCacheSubscriptionRefresh.owner_soid:type_name -> deadlock.CMsgSOIDOwner
	64, // 14: deadlock.CGCToGCMsgMasterAck.directory:type_name -> deadlock.CGCToGCMsgMasterAck.Process
	65, // 15: deadlock.CGCToGCMsgMasterStartupComplete.gc_info:type_name -> deadlock.CGCToGCMsgMasterStartupComplete.GCInfo
	66, // 16: deadlock.CMsgGCUpdateSubGCSessionInfo.updates:type_name -> deadlock.CMsgGCUpdateSubGCSessionInfo.CMsgUpdate
	8,  // 17: deadlock.CMsgSOCacheHaveVersion.soid:type_name -> deadlock.CMsgSOIDOwner
	29, // 18: deadlock.CMsgClientHello.socache_have_versions:type_name -> deadlock.CMsgSOCacheHaveVersion
	1,  // 19: deadlock.CMsgClientHello.client_launcher:type_name -> deadlock.PartnerAccountType
	0,  // 20: deadlock.CMsgClientHello.engine:type_name -> deadlock.ESourceEngine
	11, // 21: deadlock.CMsgClientWelcome.outofdate_subscribed_caches:type_name -> deadlock.CMsgSOCacheSubscribed
	14, // 22: deadlock.CMsgClientWelcome.uptodate_subscribed_caches:type_name -> deadlock.CMsgSOCacheSubscriptionCheck
	67, // 23: deadlock.CMsgClientWelcome.location:type_name -> deadlock.CMsgClientWelcome.Location
	3,  // 24: deadlock.CMsgClientWelcome.additional_welcome_msgs:type_name -> deadlock.CExtraMsgBlock
	4,  // 25: deadlock.CMsgClientWelcome.steam_learn_server_info:type_name -> deadlock.CMsgSteamLearnServerInfo
	2,  // 26: deadlock.CMsgConnectionStatus.status:type_name -> deadlock.GCConnectionStatus
	68, // 27: deadlock.CMsgGCToGCSOCacheSubscribe.have_versions:type_name -> deadlock.CMsgGCToGCSOCacheSubscribe.CMsgHaveVersions
	78, // 28: deadlock.CMsgGCToGCForwardAccountDetails.account_details:type_name -> deadlock.CGCSystemMsg_GetAccountDetails_Response
	36, // 29: deadlock.CMsgGCToGCLoadSessionSOCache.forward_account_details:type_name -> deadlock.CMsgGCToGCForwardAccountDetails
	70, // 30: deadlock.CWorkshop_PopulateItemDescriptions_Request.languages:type_name -> deadlock.CWorkshop_PopulateItemDescriptions_Request.ItemDescriptionsLanguageBlock
	71, // 31: deadlock.CWorkshop_SetItemPaymentRules_Request.associated_workshop_files:type_name -> deadlock.CWorkshop_SetItemPaymentRules_Request.WorkshopItemPaymentRule
	73, // 32: deadlock.CWorkshop_SetItemPaymentRules_Request.partner_accounts:type_name -> deadlock.CWorkshop_SetItemPaymentRules_Request.PartnerItemPaymentRule
	72, // 33: deadlock.CWorkshop_SetItemPaymentRules_Request.associated_workshop_file_for_direct_payments:type_name -> deadlock.CWorkshop_SetItemPaymentRules_Request.WorkshopDirectPaymentRule
	46, // 34: deadlock.CCommunity_GetClanAnnouncements_Response.announcements:type_name -> deadlock.CCommunity_ClanAnnouncementInfo
	75, // 35: deadlock.CMsgSerializedSOCache.caches:type_name -> deadlock.CMsgSerializedSOCache.Cache
	55, // 36: deadlock.CMsgGCToGCMasterSubscribeToCacheAsync.subscribe_msg:type_name -> deadlock.CMsgGCToGCMasterSubscribeToCache
	69, // 37: deadlock.CWorkshop_PopulateItemDescriptions_Request.ItemDescriptionsLanguageBlock.descriptions:type_name -> deadlock.CWorkshop_PopulateItemDescriptions_Request.SingleItemDescription
	76, // 38: deadlock.CMsgSerializedSOCache.Cache.versions:type_name -> deadlock.CMsgSerializedSOCache.Cache.Version
	74, // 39: deadlock.CMsgSerializedSOCache.Cache.type_caches:type_name -> deadlock.CMsgSerializedSOCache.TypeCache
