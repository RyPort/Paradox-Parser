...
const file_uifontfile_format_proto_rawDesc = "" +
	"\n" +
	"\x17uifontfile_format.proto\x12\bdeadlock\"c\n" +
	"\rCUIFontFilePB\x12$\n" +
	"\x0efont_file_name\x18\x01 \x01(\tR\ffontFileName\x12,\n" +
	"\x12opentype_font_data\x18\x02 \x01(\fR\x10opentypeFontData\"\xf1\x01\n" +
	"\x14CUIFontFilePackagePB\x12'\n" +
	"\x0fpackage_version\x18\x01 \x02(\rR\x0epackageVersion\x12g\n" +
	"\x14encrypted_font_files\x18\x02 \x03(\v25.deadlock.CUIFontFilePackagePB.CUIEncryptedFontFilePBR\x12encryptedFontFiles\x1aG\n" +
	"\x16CUIEncryptedFontFilePB\x12-\n" +
	"\x12encrypted_contents\x18\x01 \x01(\fR\x11encryptedContentsB4Z2github.com/RyPort/paradox-parser/deadlock;deadlock"
...
var file_uifontfile_format_proto_goTypes = []any{
	(*CUIFontFilePB)(nil),                               // 0: deadlock.CUIFontFilePB
	(*CUIFontFilePackagePB)(nil),                        // 1: deadlock.CUIFontFilePackagePB
	(*CUIFontFilePackagePB_CUIEncryptedFontFilePB)(nil), // 2: deadlock.CUIFontFilePackagePB.CUIEncryptedFontFilePB
}
var file_uifontfile_format_proto_depIdxs = []int32{
	2, // 0: deadlock.CUIFontFilePackagePB.encrypted_font_files:type_name -> deadlock.CUIFontFilePackagePB.CUIEncryptedFontFilePB
