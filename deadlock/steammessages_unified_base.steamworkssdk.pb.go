...
var file_steammessages_unified_base_steamworkssdk_proto_extTypes = []protoimpl.ExtensionInfo{
	...
	},
	{
		...
		ExtensionType: (*string)(nil),
		Field:         50000,
		Name:          "deadlock.service_description",
	...
	},
	{
		...
		Field:         50008,
		Name:          "deadlock.service_execution_site",
		Tag:           "varint,50008,opt,name=service_execution_site,enum=deadlock.EProtoExecutionSite,def=0",
		Filename:      "steammessages_unified_base.steamworkssdk.proto",
	},
	{
		...
		ExtensionType: (*string)(nil),
		Field:         50000,
		Name:          "deadlock.method_description",
	...
	},
	{
		...
		ExtensionType: (*string)(nil),
		Field:         50000,
		Name:          "deadlock.enum_description",
	...
	},
	{
		...
		ExtensionType: (*string)(nil),
		Field:         50000,
		Name:          "deadlock.enum_value_description",
...
var (
	...
	// optional deadlock.EProtoExecutionSite service_execution_site = 50008;
...
const file_steammessages_unified_base_steamworkssdk_proto_rawDesc = "" +
	"\n" +
	".steammessages_unified_base.steamworkssdk.proto\x12\bdeadlock\x1a google/protobuf/descriptor.proto*]\n" +
	...
	"\x16service_execution_site\x12\x1f.google.protobuf.ServiceOptions\x18؆\x03 \x01(\x0e2\x1d.deadlock.EProtoExecutionSite:\x1ck_EProtoExecutionSiteUnknownR\x14serviceExecutionSite:O\n" +
	...
	"\x16enum_value_description\x12!.google.protobuf.EnumValueOptions\x18І\x03 \x01(\tR\x14enumValueDescriptionB9H\x01Z2github.com/RyPort/paradox-parser/deadlock;deadlock\x80\x01\x00"
...
var file_steammessages_unified_base_steamworkssdk_proto_goTypes = []any{
	(EProtoExecutionSite)(0),            // 0: deadlock.EProtoExecutionSite
...
var file_steammessages_unified_base_steamworkssdk_proto_depIdxs = []int32{
	1, // 0: deadlock.description:extendee -> google.protobuf.FieldOptions
	2, // 1: deadlock.service_description:extendee -> google.protobuf.ServiceOptions
	2, // 2: deadlock.service_execution_site:extendee -> google.protobuf.ServiceOptions
	3, // 3: deadlock.method_description:extendee -> google.protobuf.MethodOptions
	4, // 4: deadlock.enum_description:extendee -> google.protobuf.EnumOptions
	5, // 5: deadlock.enum_value_description:extendee -> google.protobuf.EnumValueOptions
	0, // 6: deadlock.service_execution_site:type_name -> deadlock.EProtoExecutionSite
