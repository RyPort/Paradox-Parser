...
type CMsgSteamDatagramConnectionClosed struct {
	...
	RelayMode                      *CMsgSteamDatagramConnectionClosed_ERelayMode `protobuf:"varint,4,opt,name=relay_mode,json=relayMode,enum=deadlock.CMsgSteamDatagramConnectionClosed_ERelayMode,def=0" json:"relay_mode,omitempty"`
...
type CMsgSteamDatagramRouterPingReply_AltAddress struct {
	...
	Penalty       *uint32                                               `protobuf:"varint,3,opt,name=penalty" json:"penalty,omitempty"`
	Protocol      *CMsgSteamDatagramRouterPingReply_AltAddress_Protocol `protobuf:"varint,4,opt,name=protocol,enum=deadlock.CMsgSteamDatagramRouterPingReply_AltAddress_Protocol,def=0" json:"protocol,omitempty"`
...
const file_steamdatagram_messages_sdr_proto_rawDesc = "" +
	"\n" +
	" steamdatagram_messages_sdr.proto\x12\bdeadlock\x1a+steamnetworkingsockets_messages_certs.proto\x1a%steamnetworkingsockets_messages.proto\">\n" +
	"\x1cCMsgSteamNetworkingIPAddress\x12\x0e\n" +
	"\x02v4\x18\x01 \x01(\aR\x02v4\x12\x0e\n" +
	"\x02v6\x18\x02 \x01(\fR\x02v6\"\xc6\x01\n" +
	"%CMsgSteamDatagramSignedMessageGeneric\x12@\n" +
	"\x04cert\x18\x01 \x01(\v2,.deadlock.CMsgSteamDatagramCertificateSignedR\x04cert\x12\x1f\n" +
	"\vsigned_data\x18\x02 \x01(\fR\n" +
	"signedData\x12\x1c\n" +
	"\tsignature\x18\x03 \x01(\fR\tsignature\x12\x1c\n" +
	"\tdummy_pad\x18\xff\a \x01(\fR\bdummyPad\"\xa0\v\n" +
	...
	"\x05flags\x18\f \x01(\rR\x05flags\x12d\n" +
	"\x10route_exceptions\x18\n" +
	" \x03(\v29.deadlock.CMsgSteamDatagramRouterPingReply.RouteExceptionR\x0frouteExceptions\x12Z\n" +
	"\ralt_addresses\x18\r \x03(\v25.deadlock.CMsgSteamDatagramRouterPingReply.AltAddressR\faltAddresses\x12\x1b\n" +
	...
	"\apenalty\x18\x03 \x01(\rR\apenalty\x1a\xec\x01\n" +
	"\n" +
	"AltAddress\x12\x12\n" +
	"\x04ipv4\x18\x01 \x01(\aR\x04ipv4\x12\x12\n" +
	"\x04port\x18\x02 \x01(\rR\x04port\x12\x18\n" +
	"\apenalty\x18\x03 \x01(\rR\apenalty\x12k\n" +
	"\bprotocol\x18\x04 \x01(\x0e2>.deadlock.CMsgSteamDatagramRouterPingReply.AltAddress.Protocol:\x0fDefaultProtocolR\bprotocol\x12\x0e\n" +
	"\x02id\x18\x05 \x01(\tR\x02id\"\x1f\n" +
	"\bProtocol\x12\x13\n" +
	"\x0fDefaultProtocol\x10\x00\"L\n" +
	"\x05Flags\x12 \n" +
	"\x1cFLAG_MAYBE_MORE_DATA_CENTERS\x10\x01\x12!\n" +
	"\x1dFLAG_MAYBE_MORE_ALT_ADDRESSES\x10\x02\"\xe7\x02\n" +
	"*CMsgSteamDatagramGameserverPingRequestBody\x12\x1f\n" +
	"\vrelay_popid\x18\x01 \x01(\aR\n" +
	"relayPopid\x12L\n" +
	"\x0eyour_public_ip\x18\x02 \x01(\v2&.deadlock.CMsgSteamNetworkingIPAddressR\fyourPublicIp\x12(\n" +
	"\x10your_public_port\x18\x03 \x01(\rR\x0eyourPublicPort\x12&\n" +
	"\x0frelay_unix_time\x18\x04 \x01(\x04R\rrelayUnixTime\x12%\n" +
	"\x0erouting_secret\x18\x05 \x01(\x06R\rroutingSecret\x12=\n" +
	"\x06my_ips\x18\x06 \x03(\v2&.deadlock.CMsgSteamNetworkingIPAddressR\x05myIps\x12\x12\n" +
	"\x04echo\x18\b \x01(\fR\x04echo\"\xd1\x03\n" +
	".CMsgSteamDatagramGameserverPingRequestEnvelope\x12@\n" +
	"\x04cert\x18\x06 \x01(\v2,.deadlock.CMsgSteamDatagramCertificateSignedR\x04cert\x12\x1f\n" +
	...
	"\rconnection_id\x18\x01 \x01(\aR\fconnectionId\"\xee\n" +
	"\n" +
	...
	"\x03tos\x18\x06 \x01(\v2\x1a.deadlock.CMsgTOSTreatmentR\x03tos\x12H\n" +
	"\x04pops\x18\x02 \x03(\v24.deadlock.CMsgSteamDatagramClientPingSampleReply.POPR\x04pops\x12q\n" +
	"\x13legacy_data_centers\x18\x03 \x03(\v2A.deadlock.CMsgSteamDatagramClientPingSampleReply.LegacyDataCenterR\x11legacyDataCenters\x1a\xe6\x06\n" +
	"\x03POP\x12\x15\n" +
	"\x06pop_id\x18\x01 \x01(\aR\x05popId\x121\n" +
	"\x15default_front_ping_ms\x18\x02 \x01(\rR\x12defaultFrontPingMs\x12'\n" +
	"\x0fcluster_penalty\x18\x04 \x01(\rR\x0eclusterPenalty\x12d\n" +
	"\ralt_addresses\x18\a \x03(\v2?.deadlock.CMsgSteamDatagramClientPingSampleReply.POP.AltAddressR\faltAddresses\x12-\n" +
	...
	"\x0fbest_dc_ping_ms\x18\x03 \x01(\rR\fbestDcPingMs\"\x93\a\n" +
	...
	"\x06gap_ms\x18\b \x01(\rR\x05gapMs\x12h\n" +
	"\x10from_quality_now\x18\t \x01(\v2>.deadlock.CMsgSteamDatagramClientSwitchedPrimary.RouterQualityR\x0efromQualityNow\x12d\n" +
	"\x0eto_quality_now\x18\n" +
	" \x01(\v2>.deadlock.CMsgSteamDatagramClientSwitchedPrimary.RouterQualityR\ftoQualityNow\x12j\n" +
	"\x11from_quality_then\x18\v \x01(\v2>.deadlock.CMsgSteamDatagramClientSwitchedPrimary.RouterQualityR\x0ffromQualityThen\x12f\n" +
	"\x0fto_quality_then\x18\f \x01(\v2>.deadlock.CMsgSteamDatagramClientSwitchedPrimary.RouterQualityR\rtoQualityThen\x1a\x8f\x01\n" +
	...
	"\x12seconds_until_down\x18\x04 \x01(\rR\x10secondsUntilDown\"\xd2\x03\n" +
	...
	"\x1bgameserver_relay_session_id\x18\x02 \x01(\rR\x18gameserverRelaySessionId\x12G\n" +
	"\x05crypt\x18\x06 \x01(\v21.deadlock.CMsgSteamDatagramSessionCryptInfoSignedR\x05crypt\x12@\n" +
	"\x04cert\x18\a \x01(\v2,.deadlock.CMsgSteamDatagramCertificateSignedR\x04cert\x12%\n" +
	"\x0erouting_secret\x18\n" +
	" \x01(\x06R\rroutingSecret\x123\n" +
	"\x16legacy_client_steam_id\x18\x03 \x01(\x06R\x13legacyClientSteamId\"\x99\x03\n" +
	...
	"\x1bgameserver_relay_session_id\x18\x02 \x01(\rR\x18gameserverRelaySessionId\x12G\n" +
	"\x05crypt\x18\x05 \x01(\v21.deadlock.CMsgSteamDatagramSessionCryptInfoSignedR\x05crypt\x12@\n" +
	"\x04cert\x18\x06 \x01(\v2,.deadlock.CMsgSteamDatagramCertificateSignedR\x04cert\"\xa0\x05\n" +
	...
	"\x10selected_seconds\x18\b \x01(\rR\x0fselectedSeconds\"\xab\x01\n" +
	"\"CMsgSteamDatagramP2PRoutingSummary\x12@\n" +
	"\x03ice\x18\x02 \x01(\v2..deadlock.CMsgSteamNetworkingICESessionSummaryR\x03ice\x12C\n" +
	"\x03sdr\x18\x03 \x01(\v21.deadlock.CMsgSteamNetworkingP2PSDRRoutingSummaryR\x03sdr\"\x8d\n" +
	"\n" +
	...
	"\x14from_identity_string\x18\x0f \x01(\tR\x12fromIdentityString\x12p\n" +
	"\x1blegacy_from_identity_binary\x18\r \x01(\v21.deadlock.CMsgSteamNetworkingIdentityLegacyBinaryR\x18legacyFromIdentityBinary\x12/\n" +
	...
	"\x17forward_target_revision\x18\f \x01(\rR\x15forwardTargetRevision\x12[\n" +
	"\n" +
	"relay_mode\x18\x04 \x01(\x0e26.deadlock.CMsgSteamDatagramConnectionClosed.ERelayMode:\x04NoneR\trelayMode\x12\x14\n" +
	...
	"\x15relay_override_active\x18\x16 \x01(\bR\x13relayOverrideActive\x12Q\n" +
	"\rquality_relay\x18\x11 \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\fqualityRelay\x12M\n" +
	"\vquality_e2e\x18\x12 \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\n" +
	"qualityE2e\x12\\\n" +
	"\x13p2p_routing_summary\x18\x15 \x01(\v2,.deadlock.CMsgSteamDatagramP2PRoutingSummaryR\x11p2pRoutingSummary\"6\n" +
	"\n" +
	"ERelayMode\x12\b\n" +
	"\x04None\x10\x00\x12\f\n" +
	"\bEndToEnd\x10\x01\x12\x10\n" +
	"\fClosedByPeer\x10\x02\"\x83\a\n" +
	...
	"\x15relay_override_active\x18\x11 \x01(\bR\x13relayOverrideActive\x12Q\n" +
	"\rquality_relay\x18\r \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\fqualityRelay\x12M\n" +
	"\vquality_e2e\x18\x0e \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\n" +
	"qualityE2e\x12\\\n" +
	"\x13p2p_routing_summary\x18\x10 \x01(\v2,.deadlock.CMsgSteamDatagramP2PRoutingSummaryR\x11p2pRoutingSummary\x12%\n" +
	"\x0erouting_secret\x18\v \x01(\x06R\rroutingSecret\x12\x1c\n" +
	"\tdummy_pad\x18\xff\a \x01(\aR\bdummyPad\"\x8d\x04\n" +
	...
	"\x05build\x18\n" +
	" \x01(\tR\x05build\x126\n" +
	"\x17dev_gameserver_identity\x18d \x01(\tR\x15devGameserverIdentity\x12T\n" +
	"\x0fdev_client_cert\x18e \x01(\v2,.deadlock.CMsgSteamDatagramCertificateSignedR\rdevClientCert\"\xe5\x02\n" +
	...
	"\x19legacy_gameserver_steamid\x18\x03 \x01(\x06R\x17legacyGameserverSteamid\"\xa2\x04\n" +
	".CMsgSteamDatagramConnectionStatsClientToRouter\x12Q\n" +
	"\rquality_relay\x18\x01 \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\fqualityRelay\x12M\n" +
	"\vquality_e2e\x18\x02 \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\n" +
	"qualityE2e\x12\x1b\n" +
	...
	"\x15CLIENT_RELAY_OVERRIDE\x10 \"\xc6\x05\n" +
	".CMsgSteamDatagramConnectionStatsRouterToClient\x12Q\n" +
	"\rquality_relay\x18\x01 \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\fqualityRelay\x12M\n" +
	"\vquality_e2e\x18\x02 \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\n" +
	"qualityE2e\x124\n" +
	...
	"\x11ACK_REQUEST_RELAY\x10\x01\x12\x13\n" +
	"\x0fACK_REQUEST_E2E\x10\x02\x12\x19\n" +
	"\x15ACK_REQUEST_IMMEDIATE\x10\x04\"\xdb\x05\n" +
	".CMsgSteamDatagramConnectionStatsRouterToServer\x12Q\n" +
	"\rquality_relay\x18\x01 \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\fqualityRelay\x12M\n" +
	"\vquality_e2e\x18\x02 \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\n" +
	"qualityE2e\x12\x1b\n" +
	"\tack_relay\x18\n" +
	...
	"\x11ACK_REQUEST_RELAY\x10\x01\x12\x13\n" +
	"\x0fACK_REQUEST_E2E\x10\x02\x12\x19\n" +
	"\x15ACK_REQUEST_IMMEDIATE\x10\x04\"\xc9\x04\n" +
	".CMsgSteamDatagramConnectionStatsServerToRouter\x12Q\n" +
	"\rquality_relay\x18\x01 \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\fqualityRelay\x12M\n" +
	"\vquality_e2e\x18\x02 \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\n" +
	"qualityE2e\x12\x1b\n" +
	...
	"\rEncryptedData\x120\n" +
	"\x14peer_identity_string\x18\x01 \x01(\tR\x12peerIdentityString\"\x98\x01\n" +
	"\"CMsgSteamDatagramP2PSessionRequest\x12@\n" +
	"\x04cert\x18\x01 \x01(\v2,.deadlock.CMsgSteamDatagramCertificateSignedR\x04cert\x12\x12\n" +
	...
	"\vseq_num_r2c\x18\x05 \x01(\rR\tseqNumR2c\"\xea\x06\n" +
	"1CMsgSteamDatagramConnectionStatsP2PClientToRouter\x12Q\n" +
	"\rquality_relay\x18\x01 \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\fqualityRelay\x12M\n" +
	"\vquality_e2e\x18\x02 \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\n" +
	"qualityE2e\x12\\\n" +
	"\x13p2p_routing_summary\x18\x0e \x01(\v2,.deadlock.CMsgSteamDatagramP2PRoutingSummaryR\x11p2pRoutingSummary\x12\x1b\n" +
	...
	"\x15CLIENT_RELAY_OVERRIDE\x10 \"\xeb\x06\n" +
	"1CMsgSteamDatagramConnectionStatsP2PRouterToClient\x12Q\n" +
	"\rquality_relay\x18\x01 \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\fqualityRelay\x12M\n" +
	"\vquality_e2e\x18\x02 \x01(\v2,.deadlock.CMsgSteamDatagramConnectionQualityR\n" +
	"qualityE2e\x124\n" +
	"\x16seconds_until_shutdown\x18\x03 \x01(\rR\x14secondsUntilShutdown\x12,\n" +
	...
	"\n" +
	"kludge_pad\x18c \x01(\x06R\tkludgePad\"\x8b\x04\n" +
	"\x1aCMsgSteamDatagramP2PRoutes\x12X\n" +
	"\x0erelay_clusters\x18\x01 \x03(\v21.deadlock.CMsgSteamDatagramP2PRoutes.RelayClusterR\rrelayClusters\x12B\n" +
	"\x06routes\x18\x02 \x03(\v2*.deadlock.CMsgSteamDatagramP2PRoutes.RouteR\x06routes\x12\x1a\n" +
	...
	")k_ESteamDatagramMsg_RelayToRelayPingReply\x10\"B9H\x01Z2github.com/RyPort/paradox-parser/deadlock;deadlock\x80\x01\x00"
...
var file_steamdatagram_messages_sdr_proto_goTypes = []any{
	(ESteamDatagramMsgID)(0),                                        // 0: deadlock.ESteamDatagramMsgID
	(CMsgSteamDatagramRouterPingReply_Flags)(0),                     // 1: deadlock.CMsgSteamDatagramRouterPingReply.Flags
	(CMsgSteamDatagramRouterPingReply_AltAddress_Protocol)(0),       // 2: deadlock.CMsgSteamDatagramRouterPingReply.AltAddress.Protocol
	(CMsgSteamDatagramConnectionClosed_ERelayMode)(0),               // 3: deadlock.CMsgSteamDatagramConnectionClosed.ERelayMode
	(CMsgSteamDatagramConnectionStatsClientToRouter_Flags)(0),       // 4: deadlock.CMsgSteamDatagramConnectionStatsClientToRouter.Flags
	(CMsgSteamDatagramConnectionStatsRouterToClient_Flags)(0),       // 5: deadlock.CMsgSteamDatagramConnectionStatsRouterToClient.Flags
	(CMsgSteamDatagramConnectionStatsRouterToServer_Flags)(0),       // 6: deadlock.CMsgSteamDatagramConnectionStatsRouterToServer.Flags
	(CMsgSteamDatagramConnectionStatsServerToRouter_Flags)(0),       // 7: deadlock.CMsgSteamDatagramConnectionStatsServerToRouter.Flags
	(CMsgSteamDatagramConnectionStatsP2PClientToRouter_Flags)(0),    // 8: deadlock.CMsgSteamDatagramConnectionStatsP2PClientToRouter.Flags
	(CMsgSteamDatagramConnectionStatsP2PRouterToClient_Flags)(0),    // 9: deadlock.CMsgSteamDatagramConnectionStatsP2PRouterToClient.Flags
	(*CMsgSteamNetworkingIPAddress)(nil),                            // 10: deadlock.CMsgSteamNetworkingIPAddress
	(*CMsgSteamDatagramSignedMessageGeneric)(nil),                   // 11: deadlock.CMsgSteamDatagramSignedMessageGeneric
	(*CMsgSteamDatagramRouterPingReply)(nil),                        // 12: deadlock.CMsgSteamDatagramRouterPingReply
	(*CMsgSteamDatagramGameserverPingRequestBody)(nil),              // 13: deadlock.CMsgSteamDatagramGameserverPingRequestBody
	(*CMsgSteamDatagramGameserverPingRequestEnvelope)(nil),          // 14: deadlock.CMsgSteamDatagramGameserverPingRequestEnvelope
	(*CMsgSteamDatagramGameserverPingReplyData)(nil),                // 15: deadlock.CMsgSteamDatagramGameserverPingReplyData
	(*CMsgSteamDatagramNoSessionRelayToClient)(nil),                 // 16: deadlock.CMsgSteamDatagramNoSessionRelayToClient
	(*CMsgSteamDatagramNoSessionRelayToPeer)(nil),                   // 17: deadlock.CMsgSteamDatagramNoSessionRelayToPeer
	(*CMsgTOSTreatment)(nil),                                        // 18: deadlock.CMsgTOSTreatment
	(*CMsgSteamDatagramClientPingSampleRequest)(nil),                // 19: deadlock.CMsgSteamDatagramClientPingSampleRequest
	(*CMsgSteamDatagramClientPingSampleReply)(nil),                  // 20: deadlock.CMsgSteamDatagramClientPingSampleReply
	(*CMsgSteamDatagramClientSwitchedPrimary)(nil),                  // 21: deadlock.CMsgSteamDatagramClientSwitchedPrimary
	(*CMsgSteamDatagramConnectRequest)(nil),                         // 22: deadlock.CMsgSteamDatagramConnectRequest
	(*CMsgSteamDatagramConnectOK)(nil),                              // 23: deadlock.CMsgSteamDatagramConnectOK
	(*CMsgSteamNetworkingP2PSDRRoutingSummary)(nil),                 // 24: deadlock.CMsgSteamNetworkingP2PSDRRoutingSummary
	(*CMsgSteamDatagramP2PRoutingSummary)(nil),                      // 25: deadlock.CMsgSteamDatagramP2PRoutingSummary
	(*CMsgSteamDatagramConnectionClosed)(nil),                       // 26: deadlock.CMsgSteamDatagramConnectionClosed
	(*CMsgSteamDatagramNoConnection)(nil),                           // 27: deadlock.CMsgSteamDatagramNoConnection
	(*CMsgSteamDatagramGameserverSessionRequest)(nil),               // 28: deadlock.CMsgSteamDatagramGameserverSessionRequest
	(*CMsgSteamDatagramGameserverSessionEstablished)(nil),           // 29: deadlock.CMsgSteamDatagramGameserverSessionEstablished
	(*CMsgSteamDatagramConnectionStatsClientToRouter)(nil),          // 30: deadlock.CMsgSteamDatagramConnectionStatsClientToRouter
	(*CMsgSteamDatagramConnectionStatsRouterToClient)(nil),          // 31: deadlock.CMsgSteamDatagramConnectionStatsRouterToClient
	(*CMsgSteamDatagramConnectionStatsRouterToServer)(nil),          // 32: deadlock.CMsgSteamDatagramConnectionStatsRouterToServer
	(*CMsgSteamDatagramConnectionStatsServerToRouter)(nil),          // 33: deadlock.CMsgSteamDatagramConnectionStatsServerToRouter
	(*CMsgSteamDatagramP2PSessionRequestBody)(nil),                  // 34: deadlock.CMsgSteamDatagramP2PSessionRequestBody
	(*CMsgSteamDatagramP2PSessionRequest)(nil),                      // 35: deadlock.CMsgSteamDatagramP2PSessionRequest
	(*CMsgSteamDatagramP2PSessionEstablished)(nil),                  // 36: deadlock.CMsgSteamDatagramP2PSessionEstablished
	(*CMsgSteamDatagramConnectionStatsP2PClientToRouter)(nil),       // 37: deadlock.CMsgSteamDatagramConnectionStatsP2PClientToRouter
	(*CMsgSteamDatagramConnectionStatsP2PRouterToClient)(nil),       // 38: deadlock.CMsgSteamDatagramConnectionStatsP2PRouterToClient
	(*CMsgSteamDatagramP2PBadRouteRouterToClient)(nil),              // 39: deadlock.CMsgSteamDatagramP2PBadRouteRouterToClient
	(*CMsgSteamDatagramP2PRoutes)(nil),                              // 40: deadlock.CMsgSteamDatagramP2PRoutes
	(*CMsgSteamDatagramSetSecondaryAddressRequest)(nil),             // 41: deadlock.CMsgSteamDatagramSetSecondaryAddressRequest
	(*CMsgSteamDatagramSetSecondaryAddressResult)(nil),              // 42: deadlock.CMsgSteamDatagramSetSecondaryAddressResult
	(*CMsgSteamDatagramRouterPingReply_RouteException)(nil),         // 43: deadlock.CMsgSteamDatagramRouterPingReply.RouteException
	(*CMsgSteamDatagramRouterPingReply_AltAddress)(nil),             // 44: deadlock.CMsgSteamDatagramRouterPingReply.AltAddress
	(*CMsgSteamDatagramClientPingSampleReply_POP)(nil),              // 45: deadlock.CMsgSteamDatagramClientPingSampleReply.POP
	(*CMsgSteamDatagramClientPingSampleReply_LegacyDataCenter)(nil), // 46: deadlock.CMsgSteamDatagramClientPingSampleReply.LegacyDataCenter
	(*CMsgSteamDatagramClientPingSampleReply_POP_AltAddress)(nil),   // 47: deadlock.CMsgSteamDatagramClientPingSampleReply.POP.AltAddress
	(*CMsgSteamDatagramClientSwitchedPrimary_RouterQuality)(nil),    // 48: deadlock.CMsgSteamDatagramClientSwitchedPrimary.RouterQuality
	(*CMsgSteamDatagramP2PSessionRequestBody_EncryptedData)(nil),    // 49: deadlock.CMsgSteamDatagramP2PSessionRequestBody.EncryptedData
	(*CMsgSteamDatagramP2PRoutes_RelayCluster)(nil),                 // 50: deadlock.CMsgSteamDatagramP2PRoutes.RelayCluster
	(*CMsgSteamDatagramP2PRoutes_Route)(nil),                        // 51: deadlock.CMsgSteamDatagramP2PRoutes.Route
	(*CMsgSteamDatagramCertificateSigned)(nil),                      // 52: deadlock.CMsgSteamDatagramCertificateSigned
	(*CMsgSteamDatagramSessionCryptInfoSigned)(nil),                 // 53: deadlock.CMsgSteamDatagramSessionCryptInfoSigned
	(*CMsgSteamNetworkingICESessionSummary)(nil),                    // 54: deadlock.CMsgSteamNetworkingICESessionSummary
	(*CMsgSteamNetworkingIdentityLegacyBinary)(nil),                 // 55: deadlock.CMsgSteamNetworkingIdentityLegacyBinary
	(*CMsgSteamDatagramConnectionQuality)(nil),                      // 56: deadlock.CMsgSteamDatagramConnectionQuality
}
var file_steamdatagram_messages_sdr_proto_depIdxs = []int32{
	52, // 0: deadlock.CMsgSteamDatagramSignedMessageGeneric.cert:type_name -> deadlock.CMsgSteamDatagramCertificateSigned
	43, // 1: deadlock.CMsgSteamDatagramRouterPingReply.route_exceptions:type_name -> deadlock.CMsgSteamDatagramRouterPingReply.RouteException
	44, // 2: deadlock.CMsgSteamDatagramRouterPingReply.alt_addresses:type_name -> deadlock.CMsgSteamDatagramRouterPingReply.AltAddress
	10, // 3: deadlock.CMsgSteamDatagramGameserverPingRequestBody.your_public_ip:type_name -> deadlock.CMsgSteamNetworkingIPAddress
	10, // 4: deadlock.CMsgSteamDatagramGameserverPingRequestBody.my_ips:type_name -> deadlock.CMsgSteamNetworkingIPAddress
	52, // 5: deadlock.CMsgSteamDatagramGameserverPingRequestEnvelope.cert:type_name -> deadlock.CMsgSteamDatagramCertificateSigned
	18, // 6: deadlock.CMsgSteamDatagramClientPingSampleReply.tos:type_name -> deadlock.CMsgTOSTreatment
	45, // 7: deadlock.CMsgSteamDatagramClientPingSampleReply.pops:type_name -> deadlock.CMsgSteamDatagramClientPingSampleReply.POP
	46, // 8: deadlock.CMsgSteamDatagramClientPingSampleReply.legacy_data_centers:type_name -> deadlock.CMsgSteamDatagramClientPingSampleReply.LegacyDataCenter
	48, // 9: deadlock.CMsgSteamDatagramClientSwitchedPrimary.from_quality_now:type_name -> deadlock.CMsgSteamDatagramClientSwitchedPrimary.RouterQuality
	48, // 10: deadlock.CMsgSteamDatagramClientSwitchedPrimary.to_quality_now:type_name -> deadlock.CMsgSteamDatagramClientSwitchedPrimary.RouterQuality
	48, // 11: deadlock.CMsgSteamDatagramClientSwitchedPrimary.from_quality_then:type_name -> deadlock.CMsgSteamDatagramClientSwitchedPrimary.RouterQuality
	48, // 12: deadlock.CMsgSteamDatagramClientSwitchedPrimary.to_quality_then:type_name -> deadlock.CMsgSteamDatagramClientSwitchedPrimary.RouterQuality
	53, // 13: deadlock.CMsgSteamDatagramConnectRequest.crypt:type_name -> deadlock.CMsgSteamDatagramSessionCryptInfoSigned
	52, // 14: deadlock.CMsgSteamDatagramConnectRequest.cert:type_name -> deadlock.CMsgSteamDatagramCertificateSigned
	53, // 15: deadlock.CMsgSteamDatagramConnectOK.crypt:type_name -> deadlock.CMsgSteamDatagramSessionCryptInfoSigned
	52, // 16: deadlock.CMsgSteamDatagramConnectOK.cert:type_name -> deadlock.CMsgSteamDatagramCertificateSigned
	54, // 17: deadlock.CMsgSteamDatagramP2PRoutingSummary.ice:type_name -> deadlock.CMsgSteamNetworkingICESessionSummary
	24, // 18: deadlock.CMsgSteamDatagramP2PRoutingSummary.sdr:type_name -> deadlock.CMsgSteamNetworkingP2PSDRRoutingSummary
	55, // 19: deadlock.CMsgSteamDatagramConnectionClosed.legacy_from_identity_binary:type_name -> deadlock.CMsgSteamNetworkingIdentityLegacyBinary
	3,  // 20: deadlock.CMsgSteamDatagramConnectionClosed.relay_mode:type_name -> deadlock.CMsgSteamDatagramConnectionClosed.ERelayMode
	56, // 21: deadlock.CMsgSteamDatagramConnectionClosed.quality_relay:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	56, // 22: deadlock.CMsgSteamDatagramConnectionClosed.quality_e2e:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	25, // 23: deadlock.CMsgSteamDatagramConnectionClosed.p2p_routing_summary:type_name -> deadlock.CMsgSteamDatagramP2PRoutingSummary
	56, // 24: deadlock.CMsgSteamDatagramNoConnection.quality_relay:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	56, // 25: deadlock.CMsgSteamDatagramNoConnection.quality_e2e:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	25, // 26: deadlock.CMsgSteamDatagramNoConnection.p2p_routing_summary:type_name -> deadlock.CMsgSteamDatagramP2PRoutingSummary
	52, // 27: deadlock.CMsgSteamDatagramGameserverSessionRequest.dev_client_cert:type_name -> deadlock.CMsgSteamDatagramCertificateSigned
	56, // 28: deadlock.CMsgSteamDatagramConnectionStatsClientToRouter.quality_relay:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	56, // 29: deadlock.CMsgSteamDatagramConnectionStatsClientToRouter.quality_e2e:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	56, // 30: deadlock.CMsgSteamDatagramConnectionStatsRouterToClient.quality_relay:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	56, // 31: deadlock.CMsgSteamDatagramConnectionStatsRouterToClient.quality_e2e:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	56, // 32: deadlock.CMsgSteamDatagramConnectionStatsRouterToServer.quality_relay:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	56, // 33: deadlock.CMsgSteamDatagramConnectionStatsRouterToServer.quality_e2e:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	56, // 34: deadlock.CMsgSteamDatagramConnectionStatsServerToRouter.quality_relay:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	56, // 35: deadlock.CMsgSteamDatagramConnectionStatsServerToRouter.quality_e2e:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	52, // 36: deadlock.CMsgSteamDatagramP2PSessionRequest.cert:type_name -> deadlock.CMsgSteamDatagramCertificateSigned
	56, // 37: deadlock.CMsgSteamDatagramConnectionStatsP2PClientToRouter.quality_relay:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	56, // 38: deadlock.CMsgSteamDatagramConnectionStatsP2PClientToRouter.quality_e2e:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	25, // 39: deadlock.CMsgSteamDatagramConnectionStatsP2PClientToRouter.p2p_routing_summary:type_name -> deadlock.CMsgSteamDatagramP2PRoutingSummary
	56, // 40: deadlock.CMsgSteamDatagramConnectionStatsP2PRouterToClient.quality_relay:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	56, // 41: deadlock.CMsgSteamDatagramConnectionStatsP2PRouterToClient.quality_e2e:type_name -> deadlock.CMsgSteamDatagramConnectionQuality
	50, // 42: deadlock.CMsgSteamDatagramP2PRoutes.relay_clusters:type_name -> deadlock.CMsgSteamDatagramP2PRoutes.RelayCluster
	51, // 43: deadlock.CMsgSteamDatagramP2PRoutes.routes:type_name -> deadlock.CMsgSteamDatagramP2PRoutes.Route
	2,  // 44: deadlock.CMsgSteamDatagramRouterPingReply.AltAddress.protocol:type_name -> deadlock.CMsgSteamDatagramRouterPingReply.AltAddress.Protocol
	47, // 45: deadlock.CMsgSteamDatagramClientPingSampleReply.POP.alt_addresses:type_name -> deadlock.CMsgSteamDatagramClientPingSampleReply.POP.AltAddress
